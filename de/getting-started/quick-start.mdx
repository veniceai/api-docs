---
title: "Schnellstart"
description: "Venice API-Schlüssel generieren, das OpenAI-kompatible SDK installieren und in Minuten die erste Chat-Completion-Anfrage an api.venice.ai senden."
