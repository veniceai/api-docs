---
title: API-Preise
"og:title": "Preise | Venice API Docs"
"og:description": "Lernen Sie die Preise der Venice-API kennen."
---

Preise pro 1M Tokens, sofern nicht anders angegeben. Alle Preise in USD. 1 Diem = $1/Tag Compute.
...
| Modell | ID | Input-Preis | Output-Preis | Cache Read | Cache Write | Context | Privacy |
|---|---|---|---|---|---|---|---|
...
| ↳ Context >200K | | $5.00 | $22.50 | $0.50 | $0.50 | | |
...
| ↳ Context >256K | | $2.50 | $7.50 | $0.06 | $0.78 | | |
...
| ↳ Context >256K | | $1.50 | $6.00 | $0.15 | $1.88 | | |
...
| Modell | ID | Input (pro 1M Tokens) | Output (pro 1M Tokens) | Privacy |
|---|---|---|---|---|
...
| Modell | ID | 2x-Upscale | 4x-Upscale |
|---|---|---|---|
| Image Upscaler | `upscaler` | $0.02 | $0.08 |

#### Bearbeitung

| Modell | ID | Pro Bearbeitung |
|---|---|---|
...
| Modell | ID | Pro 1M Zeichen | Privacy |
|---|---|---|---|
...
| Modell | ID | Pro Audiosekunde | Privacy |
|---|---|---|---|
...
#### Song-Generierung (dauerbasiert)

| Modell | ID | Dauerpreis | Privacy |
|---|---|---|---|
...
| Modell | ID | Pro Generierung | Privacy |
|---|---|---|---|
...
<Info>
Für genaue Preise vor der Generierung verwenden Sie die [Audio-Quote-API](/de/api-reference/endpoint/audio/quote). Dauerbasierte Modelle haben feste Preisstufen, während sekundenbasierte Modelle nach der Ausgabelänge abrechnen.
</Info>
...
Die Videopreise variieren je nach Auflösung und Dauer. Besuchen Sie die [Video-Modelle-Seite](/de/models/video) für genaue Angebote oder verwenden Sie die [Video-Quote-API](/de/api-reference/endpoint/video/quote).

| Modell | ID | Typ | Preis | Privacy |
|---|---|---|---|---|
...
| Feature | Konfiguration | Preis |
|---|---|---|
| Web-Suche | `enable_web_search: true` | $10,00 pro 1K Anfragen |
| Web-Scraping | `enable_web_scraping: true` | $10,00 pro 1K URLs |
| X-Suche (xAI) | `enable_x_search: true` | $10,00 pro 1K Ergebnisse |

</div>

<Info>
**Web-Scraping** erkennt automatisch bis zu 5 URLs pro Anfrage, scraped die Inhalte und wandelt sie in strukturiertes Markdown um — und fügt den extrahierten Text dem Modell-Kontext hinzu. Es werden nur erfolgreich gescrapte URLs abgerechnet.

**X-Suche** aktiviert die native Suche von xAI für unterstützte Grok-Modelle (z. B. `grok-4-20-beta`). Sie durchsucht sowohl das Web als auch X/Twitter nach Echtzeit-Informationen. Abrechnung pro vom Modell zurückgegebenem Suchergebnis (z. B. liefert das Modell 10 Suchergebnisse, werden Ihnen 10 Ergebnisse zu je $0,01 berechnet = $0,10).

Diese Gebühren fallen zusätzlich zu den Standard-Token-Preisen des Modells an.
</Info>
...
<CardGroup cols={3}>
  <Card title="USD" icon="credit-card" href="https://venice.ai/settings/api">
    API-Credits mit Kreditkarte kaufen. Credits verfallen nie.
  </Card>
  <Card title="Crypto" icon="bitcoin" href="https://venice.ai/settings/api">
    API-Credits mit Kryptowährung kaufen. Gleiche Tarife wie in USD.
  </Card>
  <Card title="DIEM staken" icon="coins" href="https://venice.ai/token">
    Jeder Diem = $1/Tag Credits, die täglich aufgefrischt werden.
  </Card>
</CardGroup>

### Pro-Nutzer

Pro-Abonnenten erhalten beim Upgrade auf Pro einmalig $10 API-Credit. Verwenden Sie ihn, um zu testen und kleine Apps zu bauen.
