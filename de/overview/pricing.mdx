---
title: API-Preise
description: "Venice API-Preise für Text-, Bild-, Video-, Audio- und Musikmodelle, einschließlich Tarife pro Token, pro Generierung und pro Sekunde in USD, VVV und DIEM."
...
*Preise pro 1M Tokens. [Alle Modelle ansehen →](/de/models/text)*

### Embeddings

<div id="pricing-embedding-placeholder">

| Model | ID | Input (pro 1M Tokens) | Output (pro 1M Tokens) | Privacy |
|---|---|---|---|---|
...
| Hunyuan Image 3.0 | `hunyuan-image-v3` | Pro Bild: $0.09 | Private |
...
| Krea v2 Large | `krea-v2-large` | Pro Bild: $0.07 | Anonymized |
...
| Krea v2 Medium | `krea-v2-medium` | Pro Bild: $0.04 | Anonymized |
...
| Muse Image | `muse-image` | Pro Bild: $0.02 | Anonymized |
...
<Info>
Für exakte Preise vor der Generierung verwenden Sie die [Audio Quote API](/de/api-reference/endpoint/audio/quote). Modelle mit Dauer-Preisen haben feste Preisstufen, während Pro-Sekunde-Modelle nach der Ausgabelänge abrechnen.
</Info>
...
Die Videopreise variieren je nach Auflösung und Dauer. Besuchen Sie die [Video-Models-Seite](/de/models/video) für genaue Angebote oder verwenden Sie die [Video Quote API](/de/api-reference/endpoint/video/quote).

| Model | ID | Typ | Preise | Privacy |
|---|---|---|---|---|
| Flux 3 | `flux-3-text-to-video` | Text to Video | Variabel | Anonymized |
| Flux 3 | `flux-3-image-to-video` | Image to Video | Variabel | Anonymized |
| Flux 3 First Last Frame | `flux-3-first-last-frame-to-video` | Text to Video | Variabel | Anonymized |
...
| Gemini Omni Flash 1.1 | `gemini-omni-flash-1-1-text-to-video` | Text to Video | Variabel | Anonymized |
| Gemini Omni Flash 1.1 | `gemini-omni-flash-1-1-image-to-video` | Image to Video | Variabel | Anonymized |
| Gemini Omni Flash 1.1 Edit | `gemini-omni-flash-1-1-video-to-video` | Text to Video | Variabel | Anonymized |
| Gemini Omni Flash 1.1 R2V | `gemini-omni-flash-1-1-reference-to-video` | Text to Video | Variabel | Anonymized |
| Gemini Omni Flash R2V | `gemini-omni-flash-reference-to-video` | Text to Video | Variabel | Anonymized |
| Grok Imagine | `grok-imagine-text-to-video-private` | Text to Video | Variabel | Private |
| Grok Imagine | `grok-imagine-image-to-video-private` | Image to Video | Variabel | Private |
| Grok Imagine | `grok-imagine-video-to-video-private` | Text to Video | Variabel | Private |
| Grok Imagine 1.5 | `grok-imagine-1-5-text-to-video-private` | Text to Video | Variabel | Private |
| Grok Imagine 1.5 | `grok-imagine-1-5-image-to-video-private` | Image to Video | Variabel | Private |
| Grok Imagine 1.5 R2V | `grok-imagine-1-5-reference-to-video-private` | Text to Video | Variabel | Private |
| Grok Imagine R2V | `grok-imagine-reference-to-video-private` | Text to Video | Variabel | Private |
...
| Kling O3 Pro R2V | `kling-o3-pro-reference-to-video` | Text to Video | Variabel | Anonymized |
...
| Kling O3 Standard R2V | `kling-o3-standard-reference-to-video` | Text to Video | Variabel | Anonymized |
...
| LTX Video 2.5 Fast | `ltx-2-5-fast-image-to-video` | Image to Video | Variabel | Anonymized |
| LTX Video 2.5 Fast | `ltx-2-5-fast-text-to-video` | Text to Video | Variabel | Anonymized |
| LTX Video 2.5 Pro | `ltx-2-5-pro-image-to-video` | Image to Video | Variabel | Anonymized |
| LTX Video 2.5 Pro | `ltx-2-5-pro-text-to-video` | Text to Video | Variabel | Anonymized |
| MiniMax H3 | `minimax-h3-text-to-video` | Text to Video | Variabel | Anonymized |
| MiniMax H3 | `minimax-h3-image-to-video` | Image to Video | Variabel | Anonymized |
| MiniMax H3 Enhanced | `minimax-h3-enhanced-text-to-video` | Text to Video | Variabel | Anonymized |
| MiniMax H3 Max | `minimax-h3-max-text-to-video` | Text to Video | Variabel | Private |
| MiniMax H3 Max | `minimax-h3-max-image-to-video` | Image to Video | Variabel | Private |
| MiniMax H3 Max Multi-Angle | `minimax-h3-max-multi-angle` | Text to Video | Variabel | Private |
| MiniMax H3 Max R2V | `minimax-h3-max-reference-to-video` | Text to Video | Variabel | Private |
| MiniMax H3 Max Turbo | `minimax-h3-max-turbo-text-to-video` | Text to Video | Variabel | Private |
| MiniMax H3 Max Turbo | `minimax-h3-max-turbo-image-to-video` | Image to Video | Variabel | Private |
| MiniMax H3 R2V | `minimax-h3-reference-to-video` | Text to Video | Variabel | Anonymized |
| MiniMax H3 R2V Enhanced | `minimax-h3-enhanced-reference-to-video` | Text to Video | Variabel | Anonymized |
...
| Seedance 1.5 Pro | `seedance-1-5-pro-text-to-video-basic` | Text to Video | Variabel | Anonymized |
| Seedance 1.5 Pro | `seedance-1-5-pro-image-to-video-basic` | Image to Video | Variabel | Anonymized |
| Seedance 2.0 | `seedance-2-0-text-to-video-basic` | Text to Video | Variabel | Anonymized |
| Seedance 2.0 | `seedance-2-0-image-to-video-basic` | Image to Video | Variabel | Anonymized |
| Seedance 2.0 Fast | `seedance-2-0-fast-text-to-video-basic` | Text to Video | Variabel | Anonymized |
| Seedance 2.0 Fast | `seedance-2-0-fast-image-to-video-basic` | Image to Video | Variabel | Anonymized |
| Seedance 2.0 Fast R2V | `seedance-2-0-fast-reference-to-video-basic` | Text to Video | Variabel | Anonymized |
| Seedance 2.0 Mini | `seedance-2-0-mini-text-to-video-basic` | Text to Video | Variabel | Anonymized |
| Seedance 2.0 Mini | `seedance-2-0-mini-image-to-video-basic` | Image to Video | Variabel | Anonymized |
| Seedance 2.0 Mini R2V | `seedance-2-0-mini-reference-to-video-basic` | Text to Video | Variabel | Anonymized |
| Seedance 2.0 R2V | `seedance-2-0-reference-to-video-basic` | Text to Video | Variabel | Anonymized |
| Seedance 2.5 | `seedance-2-5-text-to-video-basic` | Text to Video | Variabel | Anonymized |
| Seedance 2.5 | `seedance-2-5-image-to-video-basic` | Image to Video | Variabel | Anonymized |
| Seedance 2.5 R2V | `seedance-2-5-reference-to-video-basic` | Text to Video | Variabel | Anonymized |
...
| Wan 2.2 Enhanced | `wan-2-2-enhanced-image-to-video` | Image to Video | Variabel | Anonymized |
...
| Wan 2.7 Enhanced | `wan-2-7-enhanced-text-to-video` | Text to Video | Variabel | Anonymized |
| Wan 2.7 Reference | `wan-2-7-reference-to-video` | Text to Video | Variabel | Anonymized |
| Wan 3.0 | `wan-3-0-text-to-video` | Text to Video | Variabel | Anonymized |
| Wan 3.0 | `wan-3-0-image-to-video` | Image to Video | Variabel | Anonymized |
| Wan 3.0 Prime | `wan-3-0-prime-text-to-video` | Text to Video | Variabel | Anonymized |
| Wan 3.0 Prime | `wan-3-0-prime-image-to-video` | Image to Video | Variabel | Anonymized |
| Wan 3.0 Prime Pro | `wan-3-0-prime-pro-text-to-video` | Text to Video | Variabel | Anonymized |
| Wan 3.0 Prime Pro | `wan-3-0-prime-pro-image-to-video` | Image to Video | Variabel | Anonymized |
| Wan 3.0 Prime Pro Reference | `wan-3-0-prime-pro-reference-to-video` | Text to Video | Variabel | Anonymized |
| Wan 3.0 Prime Reference | `wan-3-0-prime-reference-to-video` | Text to Video | Variabel | Anonymized |
| Wan 3.0 Pro | `wan-3-0-pro-text-to-video` | Text to Video | Variabel | Anonymized |
| Wan 3.0 Pro | `wan-3-0-pro-image-to-video` | Image to Video | Variabel | Anonymized |
| Wan 3.0 Pro Reference | `wan-3-0-pro-reference-to-video` | Text to Video | Variabel | Anonymized |
| Wan 3.0 Reference | `wan-3-0-reference-to-video` | Text to Video | Variabel | Anonymized |
...
<CardGroup cols={3}>
  <Card title="USD" icon="credit-card" href="https://venice.ai/settings/api?utm_source=venice-api-documentation">
    Kaufen Sie Venice-Credits mit Kreditkarte. Credits verfallen nie.
  </Card>
  <Card title="Crypto" icon="bitcoin" href="https://venice.ai/settings/api?utm_source=venice-api-documentation">
    Kaufen Sie Venice-Credits mit Kryptowährungen. Gleiche Preise wie in USD.
  </Card>
  <Card title="DIEM staken" icon="coins" href="https://venice.ai/token?utm_source=venice-api-documentation">
    Jeder Diem = $1/Tag an Credits, die täglich erneuert werden. Erfordert ein Venice-Konto mit einem verbundenen Base-Wallet.
  </Card>
</CardGroup>

### Pro-Nutzer

Pro ist ein Abonnement für die Venice-Web- und Mobil-App. Es beinhaltet keine kostenlose oder unbegrenzte API-Nutzung. Alle API-Anfragen werden pro Token, pro Bild oder pro Generierung zu den in den obigen Tabellen angegebenen Sätzen abgerechnet, unabhängig von der Abonnementstufe.

Pro-Abonnenten erhalten beim Upgrade jedoch ein **einmaliges Venice-Guthaben von $10**. Dieses Guthaben wird als gebündeltes Guthaben auf die API-Nutzung angerechnet: API-Schlüssel belasten das verknüpfte Konto in der Reihenfolge **DIEM → gebündelte Credits → USD**, sodass die $10 erst dann in Anspruch genommen werden, wenn das gestakte DIEM-Kontingent für die aktuelle Epoche aufgebraucht ist. Siehe [VVV & DIEM](/overview/vvv-diem) für die vollständige Ausgabenreihenfolge und [Billing Balance](/api-reference/endpoint/billing/balance), um zu prüfen, welche Währung Ihr Schlüssel als Nächstes belasten wird.

### Kostenlose Stufe

Es gibt keine kostenlose API-Stufe und keinen kostenlosen Testschlüssel. Ein neu generierter Schlüssel authentifiziert sich zwar, doch kostenpflichtige Endpoints (Chat Completions, Bildgenerierung, Audio, Video, Embeddings) geben `402 INSUFFICIENT_BALANCE` zurück, bis das Konto über ein verfügbares Guthaben in DIEM, gebündelten Credits oder USD verfügt. Laden Sie das Konto mit USD oder Krypto unter [venice.ai/settings/api](https://venice.ai/settings/api?utm_source=venice-api-documentation) auf oder staken Sie DIEM für ein sich täglich erneuerndes Kontingent.
