...
description: "Bauen Sie einen Python-Security-Agenten auf Venice, der atomare Schwachstellen findet und sie per AST-Repo-Karte und Pydantic zu Exploit-Pfaden verkettet."
...
- Python 3.12+
- Ein Venice-API-Schlüssel von [venice.ai](https://venice.ai/?utm_source=venice-api-documentation)
