...
description: "Baue einen Python-Terminal-Agenten, der mit Venice Chat Completions und Function Calling denkt und über den Apify-MCP-Server Websites scrapt."
