---
title: "Textmodelle"
description: "Venice-Modelle für Chat, Reasoning und Code, darunter Claude, GLM und Qwen, mit Kontextlängen, Preisen pro Token, Privacy-Stufen und Traits."
...
Verwenden Sie den `id`-Wert als `model`-Parameter in API-Anfragen. Derzeit sind 123 Modelle verfügbar.
