---
title: "Textmodelle"
description: "Venice-Textmodelle für Chat, Reasoning und Code-Generierung — mit Kontextlängen, Preisen, Traits und OpenAI-kompatiblen /chat/completions-Nutzungsbeispielen."
...
Verwenden Sie den `id`-Wert als `model`-Parameter in API-Anfragen. Derzeit sind 115 Modelle verfügbar.
