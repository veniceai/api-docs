...
<Info>
Eine Übersicht der Datenschutzmodi und Hilfe bei der Wahl zwischen TEE und E2EE finden Sie unter [Datenschutz](/overview/privacy). Dieser Leitfaden behandelt Protokoll- und Implementierungsdetails.
</Info>
...
<CodeGroup>
```bash cURL
# Eine zufällige 32-Byte-Nonce erzeugen (verhindert Replay-Angriffe)
