...
description: "Gib einem Venice-Modell drei schreibgeschützte Tools und lass es per Function Calling eine SQLite-Datenbank erkunden, die es noch nie gesehen hat."
