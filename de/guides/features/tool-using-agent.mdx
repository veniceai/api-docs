...
description: "Gib einem Modell drei schreibgeschützte Tools und lass es per Function Calling über die Venice API eine SQLite-Datenbank erkunden, die es noch nie gesehen hat."
