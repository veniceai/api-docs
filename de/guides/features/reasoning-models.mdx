...
description: "Rufen Sie Venice-Reasoning-Modelle auf, die Chain-of-Thought-Tokens offenlegen, den Denkaufwand steuern und Schritt-für-Schritt-Antworten liefern."
...
Die vollständige Liste der Modelle, Preise und Kontextlimits finden Sie auf der [Models-Seite](/overview/models). Nicht alle Reasoning-Modelle unterstützen den Parameter [`reasoning_effort`](#reasoning-effort). Siehe [Modellunterstützung](#modellunterstützung) für Details.
...
Um mehr sichtbare Ausgabe zu erhalten, erhöhen Sie die Obergrenze, senken Sie `reasoning_effort` oder [deaktivieren Sie Reasoning](#reasoning-deaktivieren).
