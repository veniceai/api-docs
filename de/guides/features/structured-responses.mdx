...
Venice verwendet Chat Completions für die Textgenerierung und stellt OpenAIs Responses API derzeit nicht bereit. Strukturierte Antworten verwenden `response_format` bei `POST /chat/completions`.
