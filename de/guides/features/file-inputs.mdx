---
title: "File Inputs"
description: "Hängen Sie PDFs, Office-Dokumente, Text-, Daten- und Code-Dateien an Venice-Chat-Completions an — für Zusammenfassungen, Fragen oder Transformationen."
