...
description: "Extrahieren Sie Text und Token-Zahlen aus PDFs und Office-Dateien mit der Venice Text Parser API und nutzen Sie das Ergebnis in Prompts oder Pipelines."
