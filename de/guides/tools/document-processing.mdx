...
## Aus Text werden Datensätze

Extrahierter Text ist ein Ausgangspunkt, kein Ergebnis. [Strukturierte Daten aus Dokumenten extrahieren](/guides/tools/document-extraction) macht genau hier weiter: die Ausgabe an ein JSON-Schema binden, damit jedes Dokument dieselben Felder liefert, und zu einem Vision-Modell wechseln, wenn der Parser meldet, dass eine Datei keinen extrahierbaren Text enthält.

## Weiterführende Ressourcen

- [Strukturierte Daten aus Dokumenten extrahieren](/guides/tools/document-extraction)
