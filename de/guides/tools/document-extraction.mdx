...
description: "Verwandle ein PDF mit Venice /augment/text-parser und JSON-Schema in typisierte Datensätze und weich auf ein Vision-Modell aus, wenn es keinen Text gibt."
