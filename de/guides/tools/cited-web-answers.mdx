...
description: "Kombinieren Sie Venice Web Search, Web Scrape und Chat Completions in einem Skript, das eine Frage mit einem kurzen Briefing beantwortet, bei dem jede Aussage auf eine Quelle verweist."
