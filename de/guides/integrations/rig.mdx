...
<Note>
Bevorzugen Sie `venice::Client`, statt Rigs OpenAI-Client auf Venice zu richten. Der Standard-`openai::Client` zielt auf die Responses-API von OpenAI ab. Der Venice-Provider spricht `/chat/completions` und stellt [`VeniceParameters`](#venice-spezifische-parameter) bereit.
</Note>
