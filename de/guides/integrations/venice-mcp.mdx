...
description: "Der offizielle Venice Model Context Protocol-Server stellt 31 Venice-Tools für Chat, Bild, Video, Audio, Musik und Characters in jedem MCP-Host bereit."
...
| `VENICE_SIWX_TOKEN` | _(keiner)_ | x402-Wallet-Mode-Auth-Token. Siehe [x402 unten](#x402-wallet-modus). |
