...
description: "Der offizielle Venice Model Context Protocol-Server stellt 30 Venice-Tools für Chat, Bild, Video, Audio, Musik und Characters in jedem MCP-Host bereit."
...
<CardGroup cols={3}>
  <Card title="30 Tools" icon="toolbox">
...
**30 Tools** für jede Venice-Modalität, **3 Ressourcen** (`venice://models`, `venice://styles`, `venice://voices`) und **3 Prompt-Templates**.
