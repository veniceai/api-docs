...
|---|---|---|
| Charakter-Shots (1–2 Charaktere) | `seedance-2-0-reference-to-video-api` | Standard-R2V mit flachen `reference_image_urls`, `@Image`-Tags, bis zu 15 s, nativer Stereo-Sound |
...
| Establishing / Stimmung / Action | `seedance-2-0-image-to-video-api` | Keine Charaktere; epische Kino-Qualität, bis zu 15 s |
