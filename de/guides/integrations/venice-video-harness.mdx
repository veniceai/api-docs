...
description: "Steuern Sie Venice aus Claude Code oder Cursor mit dem Venice Video Harness-Toolkit für charakterkonsistente Videos, Storyboards und Erzählungen."
...
<CardGroup cols={3}>
  ...
  <Card title="Venice API-Schlüssel" icon="key" href="/guides/getting-started/generating-api-key">
    Von [venice.ai/settings/api](https://venice.ai/settings/api?utm_source=venice-api-documentation)
  </Card>
</CardGroup>
