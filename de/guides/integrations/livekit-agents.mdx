...
description: "Erstellen Sie Echtzeit-Sprachagenten mit LiveKit Agents und Venice, indem Sie Venice STT, LLM und TTS über das OpenAI-kompatible Plugin in einer STT-LLM-TTS-Pipeline verdrahten."
