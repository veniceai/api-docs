...
<Steps>
  ...
  <Step title="API-Schlüssel erstellen">
    Erstelle einen Schlüssel unter [venice.ai/settings/api](https://venice.ai/settings/api?utm_source=venice-api-documentation). Du fügst ihn im nächsten Schritt direkt in die Konfigurationsdatei ein.
  </Step>
