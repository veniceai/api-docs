---
title: Claude Code
description: "Konfigurieren Sie die Claude Code CLI so, dass Anthropic-Claude-Opus- und -Sonnet-Anfragen über Venice laufen — für private, nutzungsbasierte Coding-Agent-Inferenz."
"og:title": "Claude Code mit Venice | Venice API Docs"
"og:description": "Claude Code so einrichten, dass Claude Opus 4.5/4.6 und Sonnet 4.5/4.6 über Venice AI genutzt werden"
---
