---
title: OpenCode
description: "Verbinden Sie OpenCode über einen OpenAI-kompatiblen Custom Provider mit Venice — Ihr Coding-Agent läuft per Konfigurationsdatei auf privaten Modellen."
