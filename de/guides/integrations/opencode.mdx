---
title: OpenCode
description: "Verbinden Sie OpenCode per Custom Provider in opencode.json mit Venice: Ihr Terminal-Coding-Agent läuft mit einer Konfigurationsdatei auf privaten Modellen."
...
Wenn du wie oben `"model": "venice/z-ai-glm-5-3-flash"` gesetzt hast, sollte OpenCode dieses Venice-Modell standardmäßig verwenden. Du kannst den Default ändern, indem du `z-ai-glm-5-3-flash` durch eine andere Modell-ID aus dem [Textmodell-Katalog](/models/text) ersetzt und sie in die `models`-Map aufnimmst.
