...
Venice bettet ausschließlich Text ein. `OpenAIEmbeddings` von LangChain verwendet standardmäßig `check_embedding_ctx_length=True`, wodurch mit tiktoken tokenisiert wird und Integer-Token-Arrays gesendet werden können. Venice lehnt diese mit HTTP 400 ab. Setze daher `check_embedding_ctx_length=False`.
...
| Komplexes Reasoning | `z-ai-glm-5-3-flash` | Schnelles privates Reasoning-Modell |
| Function Calling | `z-ai-glm-5-3-flash` | Zuverlässige Tool-Nutzung |
