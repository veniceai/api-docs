...
description: "Venice AI mit LangChain für Chains, Agenten und RAG-Pipelines nutzen"
"og:title": "LangChain-Integration | Venice API Docs"
"og:description": "LangChain-Anwendungen auf Basis der privaten, unbeschränkten Modelle von Venice AI bauen"
---

Venice AI funktioniert dank vollständiger Kompatibilität zum OpenAI-SDK nahtlos mit [LangChain](https://python.langchain.com/). Bauen Sie Chains, Agenten und RAG-Pipelines auf der datenschutzorientierten Infrastruktur von Venice.
...
Verwenden Sie `ChatOpenAI` mit der Base-URL von Venice:
...
embeddings = OpenAIEmbeddings(
    ...
    api_key="your-venice-api-key",
    base_url="https://api.venice.ai/api/v1",
    check_embedding_ctx_length=False,  # Für Venice erforderlich
)
...
# Chain 1: Themenzusammenfassung erzeugen
...
Eine Retrieval-Augmented-Generation-Pipeline mit Venice bauen:
...
# Function-Calling-fähiges Modell verwenden
llm = ChatOpenAI(
    model="zai-org-glm-5-1",
    api_key="your-venice-api-key",
    base_url="https://api.venice.ai/api/v1",
...
Verwenden Sie die eingebaute Web-Suche von Venice über `venice_parameters`:
...
|----------|-------|-----|
| Allgemeine Chains | `venice-uncensored` | Schnell, günstig, unbeschränkt |
...
| Vision + Text | `qwen3-vl-235b-a22b` | Fortgeschrittenes Vision-Verständnis |
...
<Card title="Alle Modelle ansehen" icon="database" href="/de/models/overview">
  Alle Venice-Modelle mit Preisen und Fähigkeiten durchsuchen
</Card>
