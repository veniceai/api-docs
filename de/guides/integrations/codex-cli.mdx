---
title: Codex CLI
description: "Richten Sie die OpenAI Codex CLI per config.toml auf Venice-Modelle aus, sodass Coding-Agent-Anfragen über die private, OpenAI-kompatible API laufen."
