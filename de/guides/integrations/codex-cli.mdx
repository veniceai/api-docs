---
title: Codex CLI
description: "Richten Sie die OpenAI Codex CLI mit einer lokalen config.toml auf Venice-Modelle aus, sodass Coding-Agent-Anfragen über die private, OpenAI-kompatible API von Venice laufen."
