---
title: Codex CLI
description: "Richten Sie die OpenAI Codex CLI per config.toml-Provider-Eintrag, Ihrem VENICE_API_KEY und der OpenAI-kompatiblen Base-URL auf Venice-Modelle aus."
