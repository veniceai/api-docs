---
title: Venice Skills
description: "Offizielle Venice Agent Skills, die Endpunkt-Wissen in Claude Code, Cursor, Codex, OpenCode, Hermes und Cline laden, damit Coding-Agenten die Venice API korrekt aufrufen."
...
[Venice Skills](https://github.com/veniceai/skills) ist die kanonische Sammlung von [Agent Skills](https://www.anthropic.com/news/agent-skills) für die Venice-API. Jeder Skill ist ein eigenständiger Ordner mit einer `SKILL.md`, die ein LLM-Agent bei Bedarf lädt, um korrekt gegen einen bestimmten Bereich der API zu arbeiten.
...
<CardGroup cols={2}>
  ...
  <Card title="Agent Skills-Spezifikation" icon="arrow-up-right-from-square" href="https://www.anthropic.com/news/agent-skills">
