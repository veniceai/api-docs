---
title: Venice Skills
description: "Offizielle Venice Agent Skills laden Endpunkt-Wissen in Claude Code, Cursor, Codex, OpenCode, Hermes und Cline für zuverlässige Coding-Agenten."
...
| `venice-video` | `/video/*`-Generierung, Bearbeitung, Upscaling und asynchroner Job-Lebenszyklus |
