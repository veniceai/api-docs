---
title: "CrewAI"
description: "Bauen Sie Multi-Agenten-Crews mit CrewAI und Venice — private, unzensierte Venice-Modelle als LLM-Backend für rollenbasierte Agenten-Zusammenarbeit."
...
|-----------|-------------------|-----|
| Komplexes Reasoning / Strategie | `z-ai-glm-5-3-flash` | Schnelles privates Reasoning-Modell |
...
3. **GLM 5.3 Flash für Reasoning nutzen**: Verwende `z-ai-glm-5-3-flash` für Agenten, die komplexes Reasoning oder zuverlässiges Function Calling brauchen.
