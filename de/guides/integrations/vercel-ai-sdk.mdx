---
title: "Vercel AI SDK"
description: "Streamen Sie Venice-Chat-Completions in Next.js und React via OpenAI-kompatiblem Vercel-AI-SDK-Provider — für produktionsreife KI-UIs und Chatbots."
...
const MODELS = [
  ...
  { id: 'z-ai-glm-5-3-flash', name: 'GLM 5.3 Flash', desc: 'Schnelles privates Reasoning' },
...
| Komplexe Aufgaben | `z-ai-glm-5-3-flash` | Schnelles privates Reasoning |
...
| Tool Calling | `z-ai-glm-5-3-flash` | Zuverlässiges Function Calling |
