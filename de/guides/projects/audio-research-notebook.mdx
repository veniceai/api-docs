...
description: "Verwandle deine Quellen mit Venice in zitierte Antworten und einen Audio-Überblick mit zwei Hosts."
...
<CardGroup cols={2}>
  <Card title="Privater RAG-Bot" icon="database" href="/guides/projects/private-rag-bot">
