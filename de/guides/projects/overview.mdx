...
description: "End-to-End-Demo-Projekte auf Basis der Venice API – LLM-Gateways, Agents und Beispiel-Apps mit lauffähigem Code, den du lesen und für eigene Projekte anpassen kannst."
...
<div className="venice-demo-grid">
  ...
  <div className="venice-demo-card">
    ...
    <h3 className="venice-demo-title">Audio-Recherche-Notebook</h3>
    <p className="venice-demo-desc">Zitierte Antworten aus deinen Quellen, plus ein Audio-Überblick mit zwei Hosts, den du anhören kannst.</p>
    <div className="venice-demo-tags">
    ...
    <div className="venice-demo-actions">
      <a className="venice-demo-link" href="/de/guides/projects/audio-research-notebook">Zur Anleitung <span className="venice-demo-arrow">→</span></a>
