...
description: "Baue auf Venice ein OpenAI-kompatibles Rust-LLM-Gateway mit Axum, Postgres, SQLx, Bearer-Token-Auth, Streaming-Antworten, Rate-Limits und OpenTelemetry."
