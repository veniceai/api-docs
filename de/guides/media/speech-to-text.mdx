...
description: "Transkribiere Audiodateien in Text mit Venice-Speech-to-Text-Modellen über /audio/transcriptions, mit wählbaren Antwortformaten und Segment-Zeitstempeln."
