...
description: "Verwandle einen Webartikel mit Venice Text-to-Speech in eine Audiodatei: Text in Chunks teilen, per /audio/speech synthetisieren und zusammenfügen."
...
<Card title="Dieses Tutorial in Google Colab ausführen" icon="notebook" href="https://colab.research.google.com/github/veniceai/api-docs/blob/main/notebooks/article-narration.ipynb">
  Jeder Schritt unten als ausführbares Notebook, mit der Vertonung direkt zum Anhören. Nichts zu installieren.
</Card>
