...
<Note>
Voice-Handles sind modellspezifisch. Ein mit `tts-chatterbox-hd` erstelltes Handle muss mit `tts-chatterbox-hd` verwendet werden. Voice Cloning ist Text-to-Speech auf Basis eines Referenz-Samples. Um eine vorhandene Aufnahme in einer anderen Stimme neu aufzunehmen, verwende stattdessen die [Voice-Changer](/de/guides/media/voice-changer)-API.
</Note>
