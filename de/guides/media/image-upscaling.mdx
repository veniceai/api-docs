...
description: "Verbessere und skaliere Bilder mit der synchronen /image/upscale-API von Venice: sende base64-kodierte Eingaben und erhalte höher aufgelöste Bilder als Binärdaten."
