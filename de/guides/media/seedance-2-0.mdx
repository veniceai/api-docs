...
description: "Videos mit Seedance 2.0 und 2.5 auf Venice erzeugen, bearbeiten, verlängern und zusammenfügen - Text-/Bild-/Referenz-Workflows, Faces-off-API und familienspezifische Multimodal-Limits."
'og:title': "Seedance 2.0 & 2.5 Guide | Venice API Docs"
'og:description': "Videos mit Seedance 2.0 und 2.5 über die Venice API erzeugen. Workflows, Faces-off, Multimodal-Limits, Preise und Beispiele."
---
...
<Warning>
**Gesichter werden auf der öffentlichen Seedance-API nicht unterstützt.** Venice führt für öffentliche Seedance-Modelle kein Face-Asset-Provisioning und keine Face-Consent-Attestierung (`consents.seedance` / `needs_consent`) aus. Eingaben mit Gesichtern können upstream als Content-Policy-/Provider-Fehler abgelehnt werden. Für Likeness-/Face-Asset-Generierung die Venice-App oder Studio nutzen.
</Warning>
