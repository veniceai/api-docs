---
title: "Seedance 2.0"
description: "Seedance 2.0 — Venices Flaggschiff-Multimodal-Videomodell. Text-/Image-/Reference-to-Video auf einem Endpoint, mit vier aus der Prompt-Form abgeleiteten Workflows (Reference, Edit, Extend, Stitch)."
