...
description: "Videos mit Seedance 2.0 und 2.5 auf Venice generieren, bearbeiten, verlängern und zusammenfügen – Text-, Bild- und Reference-to-Video-Workflows, Medienrichtlinie der öffentlichen API und familienspezifische multimodale Limits."
...
`duration: "auto"` (oder `"-1"`) und `aspect_ratio: "adaptive"` (oder `"auto"`) bewirken, dass die Ausgabe dem Quellclip folgt. Siehe [Quellabgeglichenes Seitenverhältnis und Dauer](#source-matched-aspect-ratio-and-duration).
