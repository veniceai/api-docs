...
description: "Wenn ein Seedance-2.0-Request ein menschliches Gesicht enthält, verlangt die Venice-API vor der Verarbeitung eine einmalige Consent-Attestation. Dieser Guide deckt den Zwei-Call-Flow, das Consent-Objekt und die Antworten ab."
