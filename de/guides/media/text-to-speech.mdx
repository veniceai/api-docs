...
<Tip>
Du willst mehr als nur ein paar Sätze vertonen? [Artikel mit Text-to-Speech vertonen](/guides/media/article-narration) behandelt die Eingabegrenze von 4096 Zeichen, das Aufteilen von Text an Satzgrenzen, das Zusammenfügen der Teile zu einer einzigen Audiodatei sowie Streaming für interaktive Wiedergabe.
</Tip>

- [Audio-Speech-API](/api-reference/endpoint/audio/speech)
- [Text-to-Speech-Modelle](/models/text-to-speech)
- [Artikel mit Text-to-Speech vertonen](/guides/media/article-narration)
