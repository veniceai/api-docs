...
Video-, Musik- und Voice-Changer-Jobs unterliegen keinen Rate-Limits. Sie werden pro Generierung über Ihr Guthaben abgerechnet, sodass in der Praxis die Kosten und nicht eine Anfrageobergrenze die Beschränkung darstellen. Kalkulieren Sie einen Auftrag zuerst mit [`POST /video/quote`](/de/api-reference/endpoint/video/quote), [`POST /audio/quote`](/de/api-reference/endpoint/audio/quote) oder [`POST /audio/voice-changer/quote`](/de/api-reference/endpoint/audio/voice-changer/quote).
