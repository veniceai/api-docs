...
description: "Crea agenti vocali in tempo reale con LiveKit Agents e Venice collegando STT, LLM e TTS tramite il plugin compatibile con OpenAI in una pipeline."
