---
title: OpenCode
description: "Collega OpenCode a Venice tramite un provider personalizzato compatibile con OpenAI, così il tuo agente di coding gira su modelli Venice privati con un solo file di configurazione."
