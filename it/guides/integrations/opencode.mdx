---
title: OpenCode
description: "Collega OpenCode a Venice con un provider personalizzato in opencode.json e fai girare l'agente di coding da terminale su modelli privati con un solo file."
...
Se hai impostato `"model": "venice/z-ai-glm-5-3-flash"` come mostrato sopra, OpenCode dovrebbe usare quel modello Venice per impostazione predefinita. Puoi cambiare il default sostituendo `z-ai-glm-5-3-flash` con qualsiasi ID di modello del [catalogo dei modelli di testo](/models/text) e aggiungendolo alla mappa `models`.
