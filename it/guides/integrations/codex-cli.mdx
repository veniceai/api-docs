---
title: Codex CLI
description: "Punta la CLI OpenAI Codex ai modelli Venice con una voce model provider in config.toml, la tua VENICE_API_KEY e la base URL compatibile OpenAI."
