---
title: Codex CLI
description: "Punta OpenAI Codex CLI ai modelli Venice tramite un config.toml locale, così le richieste dell'agente di coding passano dall'API privata di Venice compatibile con OpenAI."
