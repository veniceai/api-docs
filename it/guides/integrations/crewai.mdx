...
description: "Costruisci crew multi-agente con CrewAI e Venice — configura i modelli Venice privati e senza censura come backend LLM per la collaborazione tra agenti basata sui ruoli."
