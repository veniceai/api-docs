---
title: "CrewAI"
description: "Costruisci crew multi-agente con CrewAI e Venice: configura i modelli privati e senza censura come backend LLM per la collaborazione tra agenti."
...
|-----------|-------------------|-----|
| Ragionamento complesso / Strategia | `z-ai-glm-5-3-flash` | Modello di ragionamento privato veloce |
...
3. **Usa GLM 5.3 Flash per il ragionamento**: usa `z-ai-glm-5-3-flash` per agenti che richiedono ragionamento complesso o un function calling affidabile.
