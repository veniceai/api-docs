...
|---|---|---|
| Inquadrature con personaggi (1-2 personaggi) | `seedance-2-0-reference-to-video-api` | R2V di default con `reference_image_urls` flat, tag `@Image`, fino a 15s, audio stereo nativo |
...
| Establishing / mood / action | `seedance-2-0-image-to-video-api` | Nessun personaggio; qualità cinematica epica, fino a 15s |
