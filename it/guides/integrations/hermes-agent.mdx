---
title: Hermes Agent
description: "Configura Venice come provider in Hermes Agent per un'AI privata e senza censura con memoria persistente, skill e messaggistica multi-piattaforma."
...
| **Video** | Generazione, editing, upscaling e analisi con modelli di chat compatibili con i video |
...
Ottieni una API key da [venice.ai/settings/api](https://venice.ai/settings/api?utm_source=venice-api-documentation) se non ne hai già una.
