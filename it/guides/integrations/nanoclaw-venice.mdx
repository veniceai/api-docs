---
title: NanoClaw
description: "Distribuisci NanoClaw, un assistente AI self-hosted per WhatsApp e Telegram, su Venice AI per inferenza privata e senza censura con isolamento Docker."
...
[Venice](https://venice.ai/?utm_source=venice-api-documentation) è una piattaforma AI privacy-first. [Non memorizza né registra alcun prompt o risposta](https://venice.ai/privacy?utm_source=venice-api-documentation) sui propri server: le tue conversazioni esistono solo sul tuo dispositivo. Le richieste sono cifrate end-to-end tramite il loro proxy verso provider GPU decentralizzati, con zero data retention. Questo significa che le conversazioni con il tuo assistente AI rimangono private, anche nei confronti di Venice stessa.
...
| **Prezzi** | Pay-per-token, nessun abbonamento. Oppure metti in staking [DIEM](https://venice.ai/lp/diem?utm_source=venice-api-documentation) per crediti giornalieri rinnovabili | Abbonamenti da 20–200$/mese o API pay-per-token |
...
<CardGroup cols={2}>
  ...
  <Card title="Venice API Key" icon="key" href="https://venice.ai/settings/api?utm_source=venice-api-documentation">
