---
title: Venice CLI
description: "Installa lo strumento a riga di comando ufficiale Venice per chat, ricerca web, generazione di immagini, text-to-speech, trascrizione, video ed embeddings."
