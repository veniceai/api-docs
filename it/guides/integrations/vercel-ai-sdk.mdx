---
title: "Vercel AI SDK"
description: "Esegui lo streaming delle chat completion Venice in app Next.js e React usando il provider OpenAI-compatibile del Vercel AI SDK per chatbot AI."
...
const MODELS = [
  ...
  { id: 'z-ai-glm-5-3-flash', name: 'GLM 5.3 Flash', desc: 'Ragionamento privato veloce' },
...
| Compiti complessi | `z-ai-glm-5-3-flash` | Ragionamento privato veloce |
...
| Tool calling | `z-ai-glm-5-3-flash` | Function calling affidabile |
