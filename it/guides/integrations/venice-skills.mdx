...
<Card title="GitHub: veniceai/skills" icon="github" href="https://github.com/veniceai/skills">
  18 skill che coprono l'intera API Venice. Licenza MIT. Sincronizzate con il [`swagger.yaml`](/api-reference/api-spec) pubblico.
</Card>

<CardGroup cols={3}>
  <Card title="18 skill" icon="layer-group">
