---
title: Claude Code
description: "Configura Claude Code CLI per instradare le richieste a Claude Opus e Sonnet tramite Venice, per inferenza privata e pay-per-use sul coding."
"og:title": "Claude Code with Venice | Venice API Docs"
"og:description": "Configura Claude Code per usare Claude Opus 4.5/4.6/4.7/4.8, Sonnet 4.5/4.6/4.7/4.8 e Fable 5 tramite Venice AI"
---

[Claude Code](https://docs.anthropic.com/en/docs/claude-code) è lo strumento CLI di Anthropic per il coding agentico. Questa guida ti mostra come eseguirlo tramite Venice AI per l'accesso pay-per-token a Claude Opus 4.5/4.6/4.7/4.8, Sonnet 4.5/4.6/4.7/4.8 e Fable 5.
...
<Steps>
  ...
  <Step title="Ottieni la tua API key">
    Genera una chiave da [venice.ai/settings/api](https://venice.ai/settings/api?utm_source=venice-api-documentation). La incollerai direttamente nel file di configurazione nel prossimo passaggio.
  </Step>
