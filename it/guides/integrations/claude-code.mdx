---
title: Claude Code
description: "Instrada le richieste della CLI Claude Code su Venice con claude-code-router per accesso pay-per-token ai modelli di coding Claude Opus, Sonnet e Fable."
