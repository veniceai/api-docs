...
description: "Usa i modelli di ragionamento Venice con token di chain-of-thought, controllo dello sforzo di thinking e risposte passo dopo passo."
...
Consulta l'elenco completo dei modelli, dei prezzi e dei limiti di contesto nella [pagina Modelli](/overview/models). Non tutti i modelli di ragionamento supportano il parametro [`reasoning_effort`](#reasoning-effort). Vedi il [supporto dei modelli](#supporto-dei-modelli) per i dettagli.
...
Per ottenere più output visibile, alza il limite, abbassa `reasoning_effort` o [disabilita il ragionamento](#disabilitare-il-ragionamento).
