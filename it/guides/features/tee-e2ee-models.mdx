...
<Info>
Per una panoramica delle modalità di privacy e indicazioni sulla scelta tra TEE ed E2EE, consulta [Privacy](/overview/privacy). Questa guida tratta i dettagli del protocollo e dell'implementazione.
</Info>

<Note>
TEE ed E2EE sono attualmente disponibili solo sui modelli di testo.
</Note>
...
<CodeGroup>
```bash cURL
# Genera un nonce casuale di 32 byte (previene attacchi replay)
...
def main():
    ...
    client_nonce = secrets.token_hex(32)  # 32 byte richiesti
