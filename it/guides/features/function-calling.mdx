...
description: "Consenti ai modelli di chat Venice di chiamare strumenti della tua applicazione con function calling compatibile OpenAI e l'API /chat/completions."
