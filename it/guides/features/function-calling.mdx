...
description: "Fai chiamare i tuoi tool ai modelli chat Venice con function calling compatibile OpenAI: definisci un array tools, esegui le chiamate, restituisci i risultati."
