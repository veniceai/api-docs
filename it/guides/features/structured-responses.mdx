...
description: "Forza i modelli chat Venice a restituire JSON conforme al tuo schema usando response_format e JSON Schema per un output affidabile e parsabile."
'og:title': "Structured Responses | Venice API Docs"
'og:description': "Usare risposte strutturate con l'API Venice"
---

Venice usa Chat Completions per la generazione di testo e attualmente non espone l'API Responses di OpenAI. Le risposte strutturate usano `response_format` su `POST /chat/completions`.
