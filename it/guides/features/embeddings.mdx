---
title: "Embeddings"
description: "Genera embedding vettoriali con l'endpoint /embeddings di Venice compatibile OpenAI per ricerca semantica, recupero RAG, clustering e similarità."
