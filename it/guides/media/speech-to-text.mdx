...
description: "Trascrivi file audio in testo con i modelli speech-to-text di Venice via /audio/transcriptions, scegliendo formati di risposta e timestamp dei segmenti."
