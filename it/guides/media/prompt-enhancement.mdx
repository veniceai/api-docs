...
description: "Riscrivi automaticamente i prompt di generazione e modifica delle immagini con il parametro enhance_prompt di Venice per output più dettagliati."
