...
description: "Genera audio parlato dal testo con i modelli text-to-speech di Venice, scegli voci specifiche per modello e ricevi output MP3 in streaming dall'endpoint /audio/speech."
