...
description: "Genera video da testo o immagini con l'API a coda asincrona di Venice: richiedi il prezzo, invia a /video/queue e fai polling su /video/retrieve per l'MP4."
