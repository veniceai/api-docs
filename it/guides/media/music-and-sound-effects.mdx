...
<Note>
I modelli voice-changer non sono accettati su questi endpoint. Converti invece una registrazione sorgente con l'API [Voice Changer](/it/guides/media/voice-changer).
</Note>
