---
title: "Seedance 2.0"
description: "Seedance 2.0 — Il modello video multimodale flagship di Venice. Text / image / reference-to-video su un unico endpoint, con quattro workflow (Reference, Edit, Extend, Stitch) dedotti dalla forma del prompt."
