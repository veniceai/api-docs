...
description: "Genera, modifica, estendi e unisci video con Seedance 2.0 e 2.5 su Venice - workflow testo/immagine/riferimento, API faces-off e limiti multimodali per famiglia."
'og:title': "Guida Seedance 2.0 e 2.5 | Venice API Docs"
'og:description': "Genera, modifica, estendi e unisci video con Seedance 2.0 e 2.5 tramite l'API Venice. Workflow, faces-off, limiti, prezzi ed esempi."
---
...
<Warning>
**I volti non sono supportati sull'API Seedance pubblica.** Venice non esegue provisioning di face asset né attestazione di consenso (`consents.seedance` / `needs_consent`) per i modelli Seedance pubblici. Gli input con volti possono essere rifiutati upstream come errore di content policy / provider. Per la generazione likeness / face asset usa l'app o Studio Venice.
</Warning>
