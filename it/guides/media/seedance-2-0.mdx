...
description: "Genera, modifica, estendi e unisci video con Seedance 2.0 e 2.5 su Venice - workflow text-, image- e reference-to-video, policy sui contenuti multimediali dell'API pubblica e limiti multimodali specifici della famiglia."
...
`duration: "auto"` (o `"-1"`) e `aspect_ratio: "adaptive"` (o `"auto"`) fanno sì che l'output segua la clip sorgente. Consulta [Rapporto d'aspetto e durata allineati alla sorgente](#source-matched-aspect-ratio-and-duration).
