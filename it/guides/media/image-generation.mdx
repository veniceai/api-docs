...
description: "Genera immagini da prompt testuali con l'API immagini nativa di Venice o l'endpoint OpenAI-compatibile, con stili e output binario o base64."
