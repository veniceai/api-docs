...
description: "Genera immagini da prompt testuali con l'API immagini nativa di Venice o con l'endpoint images compatibile con OpenAI, con controlli di stile e output binario o base64."
