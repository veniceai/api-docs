...
description: "Estrai testo e conteggio dei token da file PDF, DOCX, PPTX, XLSX e di testo semplice fino a 25 MB con l'API Venice Text Parser, senza inferenza."
