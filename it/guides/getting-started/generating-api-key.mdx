...
description: "Crea una chiave API Venice dalla dashboard, conserva il bearer token in modo sicuro e verifica che funzioni con una prima richiesta di chat completion autenticata."
