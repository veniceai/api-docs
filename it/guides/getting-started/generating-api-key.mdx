...
<Steps>
  <Step title="Apri le impostazioni API">
    Visita [https://venice.ai/settings/api](https://venice.ai/settings/api?utm_source=venice-api-documentation). Puoi aprire questa pagina anche dall'app Venice selezionando **API** nelle tue impostazioni.
...
Per risolvere l'errore, aumenta o rimuovi gli Epoch Consumption Limits della chiave su [venice.ai/settings/api](https://venice.ai/settings/api?utm_source=venice-api-documentation), oppure chiama [Update API Key](/api-reference/endpoint/api_keys/update) con nuovi `consumptionLimits`. I saldi a livello di account (USD, DIEM e crediti in bundle) sono fonti di pagamento indipendenti e vengono consumati automaticamente in base alla disponibilità; non è necessario sceglierne uno al momento della richiesta.
