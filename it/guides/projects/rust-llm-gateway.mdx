...
description: "Guida pratica per costruire su Venice un gateway LLM in Rust compatibile con OpenAI usando Axum, Postgres, SQLx, streaming, rate limit e OpenTelemetry."
