...
description: "Costruisci un agente di sicurezza in Python su Venice che individua vulnerabilità atomiche e le concatena in percorsi di exploit usando una mappa AST del repo e guardrail Pydantic."
