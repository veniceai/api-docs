...
<div className="venice-demo-grid">
  ...
  <div className="venice-demo-card">
    ...
    <h3 className="venice-demo-title">Notebook di ricerca audio</h3>
    <p className="venice-demo-desc">Risposte citate dalle tue fonti, più una panoramica audio a due voci che puoi ascoltare.</p>
    <div className="venice-demo-tags">
    ...
    <div className="venice-demo-actions">
      <a className="venice-demo-link" href="/it/guides/projects/audio-research-notebook">Leggi la guida <span className="venice-demo-arrow">→</span></a>
