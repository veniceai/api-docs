...
description: "Costruisci un agente di ricerca in Python su Venice che pianifica le ricerche, legge fonti web tramite l'API di scrape, estrae l'evidenza e scrive report Markdown con citazioni."
