...
description: "Modelli di embedding Venice come BGE-M3 e Qwen3 Embedding con prezzi per token, livelli di privacy e uso di /embeddings compatibile con OpenAI."
...
<Note>
Consulta l'[API Embeddings](/it/api-reference/endpoint/embeddings/generate) per esempi d'uso.
</Note>
