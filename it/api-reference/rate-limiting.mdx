---
title: "Rate limit"
description: "Rate limit dell'API Venice — quote di richieste e token per tier, limiti specifici per modello, header che espongono la capacità residua e come gestire le risposte 429."
