---
title: Introduzione
description: "Riferimento completo dell'API Venice: autenticazione Bearer, compatibilità OpenAI, header di risposta, gestione errori e tutti gli endpoint REST."
