---
title: Introduzione
description: "Riferimento dell'API Venice che copre autenticazione, debug, compatibilità con OpenAI, header di risposta, gestione degli errori e l'elenco completo degli endpoint supportati."
