...
Alcuni endpoint includono campi aggiuntivi specifici dell'endpoint. Ad esempio, gli errori di moderazione video possono includere se i crediti sono stati rimborsati:
...
Alcuni endpoint compatibili con OpenAI possono restituire oggetti errore in stile OpenAI per casi specifici, come gli errori di lunghezza del contesto:
