...
description: "Riferimento dei codici di errore dell'API Venice — codici di stato HTTP, formato della risposta di errore, stato dei rimborsi, indicazioni di retry e dettagli di validazione per le richieste fallite."
---
