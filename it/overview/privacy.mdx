...
| Modalità | Prefisso ID modello | Protezione |
| --- | --- | --- |
| **TEE** | `e2ee-*` | Inferenza isolata dall'hardware con attestation remota. |
| **E2EE** | `e2ee-*` | Cifratura lato client verso un TEE verificato. |

Entrambe le modalità usano lo stesso ID modello. Il flusso della richiesta determina se il modello viene eseguito solo in modalità TEE o usa E2EE lato client.
