...
description: "Costruisci un agente di sicurezza in Python su Venice che trova vulnerabilità atomiche e le concatena in exploit con AST del repo e Pydantic."
...
- Python 3.12+
- Una API key Venice da [venice.ai](https://venice.ai/?utm_source=venice-api-documentation)
