...
description: "Costruisci su Venice un gateway LLM in Rust compatibile con OpenAI usando Axum, Postgres, SQLx, autenticazione bearer, streaming e OpenTelemetry."
