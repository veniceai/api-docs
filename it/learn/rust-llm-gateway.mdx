...
description: "Costruisci su Venice un gateway LLM in Rust compatibile OpenAI con Axum, Postgres, SQLx, risposte in streaming, rate limit e span OpenTelemetry."
