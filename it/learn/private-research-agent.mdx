...
description: "Costruisci un agente di ricerca Python su Venice che pianifica ricerche, fa scraping delle fonti web, estrae evidenze e scrive report Markdown citati."
