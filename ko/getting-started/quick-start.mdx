---
title: "빠른 시작"
description: "Venice API 빠른 시작 — API 키를 생성해 환경 변수로 설정하고, OpenAI SDK와 base URL 설정으로 첫 번째 /chat/completions 채팅 완성 요청을 보내고, 이미지·비디오·오디오 엔드포인트를 몇 분 만에 살펴보세요."
...
<Steps>
  <Step title="API 키 발급받기">
    [Venice API 설정](https://venice.ai/settings/api?utm_source=venice-api-documentation)으로 이동하여 새 API 키를 생성하세요.
