---
title: "텍스트 모델"
description: "컨텍스트 길이, 가격, 특성, OpenAI 호환 /chat/completions 사용 예제와 함께 제공되는 Venice 채팅, 추론, 코드 생성 텍스트 모델 — 함수 호출, 비전, 무검열 등 기능별 카탈로그에서 모델 ID를 확인하세요."
...
API 요청에서 `id` 값을 `model` 매개변수로 사용하세요. 현재 115개의 모델을 사용할 수 있습니다.
