---
title: "텍스트 모델"
description: "Claude, GLM, Qwen 등 Venice 채팅·추론·코드 모델의 컨텍스트 길이, 토큰당 가격, 프라이버시 등급, 특성 안내."
...
API 요청에서 `id` 값을 `model` 매개변수로 사용하세요. 현재 123개의 모델을 사용할 수 있습니다.
...
<Note>
사용 예제는 [Chat Completions API](/ko/api-reference/endpoint/chat/completions)를 참조하세요.
</Note>
