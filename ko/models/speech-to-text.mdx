...
description: "다국어 지원, 타임스탬프, OpenAI 호환 /audio/transcriptions 엔드포인트로 오디오를 텍스트로 전사하는 Venice speech-to-text 모델 — Whisper Large V3, ElevenLabs Scribe 등 초당 가격을 비교하세요."
