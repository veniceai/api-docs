---
title: 소개
description: "Bearer 인증, 디버깅, OpenAI 호환성, 응답 헤더, 오류 처리, 지원되는 전체 엔드포인트 목록을 다루는 Venice API 참조 문서로, base URL https://api.venice.ai/api/v1 설정과 첫 /chat/completions 요청 예제를 포함합니다."
