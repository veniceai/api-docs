---
title: Venice API 가격
description: "텍스트 채팅 완성, 이미지 및 비디오 생성, 오디오 합성, 임베딩 모델별 100만 토큰당 USD 요금과 웹 검색, 스크래핑, 문서 파싱, RPC 호출, Diem 크레딧 등 기타 Venice API 서비스의 사용량 기반 비용을 확인하세요."
...
Pro 구독자는 Pro로 업그레이드 시 일회성 $10 API 크레딧을 받습니다. 작은 앱을 테스트하고 빌드하는 데 사용하세요.
