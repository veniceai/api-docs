...
description: "Axum, Postgres, SQLx, bearer-token 인증, 스트리밍 응답, 속도 제한, OpenTelemetry를 활용해 Venice 위에 OpenAI 호환 /v1/chat/completions Rust LLM 게이트웨이를 구축하는 실전 튜토리얼입니다."
