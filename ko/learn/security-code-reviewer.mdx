...
description: "AST 레포 맵과 Pydantic 가드레일을 사용해 원자적 취약점을 찾고 익스플로잇 경로로 연결하는 Python 보안 에이전트를 Venice에서 구축하세요. 코드베이스를 Markdown 보안 보고서로 바꾸는 두 에이전트 CLI 튜토리얼입니다."
...
- Python 3.12+
- [venice.ai](https://venice.ai/?utm_source=venice-api-documentation)의 Venice API 키
