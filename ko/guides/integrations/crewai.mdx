---
title: "CrewAI"
description: "CrewAI와 Venice로 멀티 에이전트 크루를 구축하세요 — 역할 기반 에이전트 협업의 LLM 백엔드로 비공개·무검열 Venice 모델을 구성하세요."
...
|-----------|-------------------|-----|
| 복잡한 추론 / 전략 | `z-ai-glm-5-3-flash` | 빠른 프라이빗 추론 모델 |
...
3. **추론에는 GLM 5.3 Flash 사용**: 복잡한 추론이나 신뢰성 있는 함수 호출이 필요한 에이전트에는 `z-ai-glm-5-3-flash`를 사용하세요.
