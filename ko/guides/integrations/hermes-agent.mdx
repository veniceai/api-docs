---
title: Hermes Agent
description: "Nous Research의 오픈소스 Hermes Agent에서 Venice를 모델 제공자로 설정해 영구 메모리, 커스텀 스킬, 내장 학습 루프, 멀티 플랫폼 메시징과 230개 이상 모델을 갖춘 비공개·무검열 셀프 호스팅 AI 에이전트를 활용하세요."
...
아직 API 키가 없다면 [venice.ai/settings/api](https://venice.ai/settings/api?utm_source=venice-api-documentation)에서 발급받으세요.
