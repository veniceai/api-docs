...
<Card title="GitHub: veniceai/skills" icon="github" href="https://github.com/veniceai/skills">
  19 skills covering the full Venice API. MIT licensed. Kept in sync with the public [`swagger.yaml`](/ko/api-reference/api-spec).
</Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Venice API Spec" icon="book" href="/ko/api-reference/api-spec">
