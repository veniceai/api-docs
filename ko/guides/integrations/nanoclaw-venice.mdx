...
See the [model catalog](/ko/models/text) for all available Venice models.
...
<AccordionGroup>
  ...
  <Accordion title="Model errors ('model does not exist')">
    ...
    **Linux:**
    ...
    Check available models at the [model catalog](/ko/models/text).
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="Using Claude Code through Venice (no bot)">
    ...
    **팁:** Add this to your `~/.zshrc` (or `~/.bashrc`) so you can quickly switch any terminal to Venice:
...
<AccordionGroup>
  ...
  <Accordion title="Can I use open-source models?">
    Yes. Venice hosts many models. Tell the bot "switch to zai-org-glm-5" or any Venice model ID. See the [model catalog](/ko/models/text).
  </Accordion>
...
<CardGroup cols={2}>
  ...
  <Card title="Venice Model Catalog" icon="list" href="/ko/models/text">
    Browse available models
  </Card>
  <Card title="Venice Privacy" icon="shield-halved" href="/ko/overview/privacy">
