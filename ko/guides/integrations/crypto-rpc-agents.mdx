...
| **x402 wallet** | Autonomous, crypto-native, or short-lived agents | Wallet signs a Sign-In-With-X message, pays per request in USDC on Base or Solana. No Venice account needed. See the [x402 guide](/ko/guides/integrations/x402-venice-api). |

Both methods share the same rate limits and billing in Venice credits.

<Tip>
Truly autonomous agents can mint their own API key by staking VVV on Base. See [Autonomous Agent API Key Creation](/ko/guides/getting-started/generating-api-key-agent).
</Tip>
...
Use [`GET /crypto/rpc/networks`](/ko/api-reference/endpoint/crypto/networks) for the live, authoritative list.
...
Full list and pricing detail in the [Crypto RPC API reference](/ko/api-reference/endpoint/crypto/rpc).
...
See [Autonomous Agent API Key Creation](/ko/guides/getting-started/generating-api-key-agent) for the complete walkthrough with code and the full error reference.
...
The same wallet auth works against `/crypto/rpc/{network}` for blockchain reads and writes. Full protocol details in the [x402 guide](/ko/guides/integrations/x402-venice-api).
...
|---|---|---|
| `400` | Unsupported or unmapped JSON-RPC method, or malformed batch | Verify the method against the [allowlist](/ko/api-reference/endpoint/crypto/rpc). The error body names the offending method. |
...
<CardGroup cols={2}>
  <Card title="Crypto RPC API Reference" icon="code" href="/ko/api-reference/endpoint/crypto/rpc">
    Full method list, pricing, and response headers
  </Card>
  <Card title="Supported Networks" icon="link" href="/ko/api-reference/endpoint/crypto/networks">
    Live list of supported network slugs
  </Card>
  <Card title="x402 Wallet Auth" icon="wallet" href="/ko/guides/integrations/x402-venice-api">
    Authenticate and pay with a Base or Solana wallet
  </Card>
  <Card title="Autonomous Agent API Key" icon="robot" href="/ko/guides/getting-started/generating-api-key-agent">
  ...
  <Card title="Pricing" icon="coins" href="/ko/overview/pricing">
