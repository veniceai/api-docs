...
<CardGroup cols={2}>
  ...
  <Card title="API Pricing" icon="coins" href="/ko/overview/pricing">
    Check model pricing and how Venice charges usage.
  </Card>

  <Card title="Chat Completions" icon="message" href="/ko/api-reference/endpoint/chat/completions">
    A common paid route for wallet-based access.
  </Card>

  <Card title="API Spec" icon="code" href="/ko/api-reference/api-spec">
