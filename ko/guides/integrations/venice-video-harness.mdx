...
- **Venice production skills** in `.claude/skills/` (compatible with the [Agent Skills](/ko/guides/integrations/venice-skills) format)
...
<CardGroup cols={3}>
  ...
  <Card title="Venice API key" icon="key" href="/ko/guides/getting-started/generating-api-key">
...
<CardGroup cols={2}>
  ...
  <Card title="Venice Video Generation" icon="film" href="/ko/guides/media/video-generation">
    The underlying API the harness drives
  </Card>
  <Card title="Reference-to-Video" icon="image" href="/ko/guides/media/reference-to-video">
    R2V guide for character consistency
  </Card>
  <Card title="Seedance 2.0" icon="bolt" href="/ko/guides/media/seedance-2-0">
