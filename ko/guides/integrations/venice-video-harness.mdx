...
description: "Claude Code 또는 Cursor에서 50개 이상의 Venice 비디오·이미지·오디오·음악 모델을 구동하는 Venice 최적화 harness로 캐릭터 일관성 있는 비디오, 스토리보드, 예고편, whisper.cpp 전사 기반 장편 내러티브를 제작하세요."
...
<CardGroup cols={3}>
  ...
  <Card title="Venice API 키" icon="key" href="/guides/getting-started/generating-api-key">
    [venice.ai/settings/api](https://venice.ai/settings/api?utm_source=venice-api-documentation)에서 발급
  </Card>
</CardGroup>
