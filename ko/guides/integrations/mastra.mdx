---
title: "Mastra"
description: "Venice의 프라이빗하고 무검열이며 OpenAI 호환인 채팅 모델을 커스텀 LLM 제공자로 구성해 Mastra 프레임워크로 TypeScript 기반 AI 에이전트, 도구 호출, 다단계 워크플로, Node.js 22.18 이상의 서버 애플리케이션을 구축하세요."
