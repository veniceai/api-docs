...
description: "base URL과 API 키를 교체해 OpenAI 앱을 Venice API로 마이그레이션하세요. chat, images, embeddings, TTS의 기능 호환성 표를 함께 제공합니다."
...
| 이미지 편집 | ✅ | ❌ | `/images/edits` 엔드포인트 없음. 네이티브 [`/image/edit`](/guides/media/image-editing)를 사용하세요 |
| TTS | ✅ | ✅ | 호환 |
| STT | ✅ | ✅ | 호환 |
| Responses API | ✅ | ✅ | 알파 |
