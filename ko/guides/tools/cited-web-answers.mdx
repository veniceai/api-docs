...
sidebarTitle: "인용 답변"
description: "Venice Web Search, Web Scrape, 채팅 완성(chat completions)을 하나의 스크립트로 엮어, 모든 주장이 출처로 연결되는 짧은 브리핑으로 질문에 답변하세요. /augment/search와 /augment/scrape 활용 Python 튜토리얼."
