...
title: "데모 및 프로젝트"
sidebarTitle: "개요"
description: "Venice API로 구축한 엔드투엔드 데모 프로젝트 — LLM 게이트웨이, 에이전트, 샘플 앱과 함께 직접 읽고 자신의 빌드에 맞게 수정할 수 있는 실행 가능한 코드를 제공합니다."
...
<div className="venice-demo-grid">
  ...
  <div className="venice-demo-card">
    ...
    <h3 className="venice-demo-title">오디오 리서치 노트북</h3>
    <p className="venice-demo-desc">여러분의 자료에서 인용이 포함된 답변과 함께, 들을 수 있는 두 진행자의 오디오 요약을 제공합니다.</p>
    <div className="venice-demo-tags">
      <span className="venice-demo-tag">Scrape</span>
      <span className="venice-demo-tag">Text Parser</span>
      <span className="venice-demo-tag">임베딩</span>
      <span className="venice-demo-tag">음성 합성</span>
    </div>
    <div className="venice-demo-actions">
      <a className="venice-demo-link" href="/ko/guides/projects/audio-research-notebook">가이드 읽기 <span className="venice-demo-arrow">→</span></a>
