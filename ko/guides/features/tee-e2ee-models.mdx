...
<Info>
개인정보 보호 모드의 개요와 TEE 또는 E2EE 선택에 대한 도움말은 [개인정보 보호](/overview/privacy)를 참조하세요. 이 가이드에서는 프로토콜 및 구현 세부 정보를 다룹니다.
</Info>

<Note>
TEE 및 E2EE는 현재 텍스트 모델에서만 사용할 수 있습니다.
</Note>
