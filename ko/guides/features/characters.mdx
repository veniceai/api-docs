---
title: "캐릭터"
description: "Venice API에서 공개된 캐릭터(characters)를 탐색하고 각 캐릭터의 슬러그(slug)를 조회하며, OpenAI 호환 chat completions 엔드포인트를 통해 원하는 페르소나와 실시간으로 대화하는 방법을 단계별 예제 코드와 함께 안내합니다."
