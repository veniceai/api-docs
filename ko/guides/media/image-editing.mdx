...
- [Image pricing](/ko/overview/pricing)
- [Models API](/ko/api-reference/endpoint/models/list) with `type=inpaint`
...
- Use [Image Generation](/ko/guides/media/image-generation) when you're starting from text instead of an existing image.
- Use [Image Models](/ko/models/image) to compare generation, edit, and enhancement model families.
- Use [Image Edit API](/ko/api-reference/endpoint/image/edit), [Multi-Edit API](/ko/api-reference/endpoint/image/multi-edit), and [Background Remove API](/ko/api-reference/endpoint/image/background-remove) for full schema details.
