---
title: 비디오 생성
description: "Venice의 비동기 비디오 API로 텍스트 프롬프트나 시작 이미지에서 mp4를 생성하세요 — /video/quote로 가격 조회, /video/queue로 작업 제출, /video/retrieve로 상태 폴링과 다운로드, /video/complete로 스토리지 정리를 수행합니다."
