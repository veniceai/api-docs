...
Use [Image Models](/ko/models/image) or the [Models API](/ko/api-reference/endpoint/models/list) to confirm which sizing fields each model accepts.
...
| `style_preset` | string | No | - | Apply a preset style from [Image Styles](/ko/api-reference/endpoint/image/styles) |
...
Validation is model-specific. Check [Image Models](/ko/models/image) and the [Models API](/ko/api-reference/endpoint/models/list) before relying on a parameter across multiple models.
...
Use [Image Models](/ko/models/image) to see which models support higher resolutions and how they are priced.

### Style presets

If the selected model supports it, `style_preset` lets you steer the output without rewriting your whole prompt. You can fetch valid preset names from [Image Styles](/ko/api-reference/endpoint/image/styles):
...
See [Image Styles](/ko/api-reference/endpoint/image/styles) for the current style list.
...
See [Image Models](/ko/models/image) for the current model list, pricing, and feature support.
