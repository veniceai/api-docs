...
sidebarTitle: "기사 낭독"
description: "Venice 텍스트-음성 변환 /audio/speech 엔드포인트로 웹 기사를 낭독된 오디오 파일로 만드는 Python 스크립트를 작성하고, 모델별 음성 선택, 4096자 제한 청크 분할, 이음새 없는 오디오 결합, 스트리밍까지 다룹니다."
...
<Card title="이 튜토리얼을 Google Colab에서 실행하기" icon="notebook" href="https://colab.research.google.com/github/veniceai/api-docs/blob/main/notebooks/article-narration.ipynb">
  아래의 모든 단계를 실행 가능한 노트북으로 제공하며, 낭독이 인라인으로 재생됩니다. 아무것도 설치할 필요가 없습니다.
</Card>
