...
description: "Construa na Venice um gateway LLM em Rust compatível com OpenAI com Axum, Postgres, SQLx, respostas em streaming, rate limits e spans OpenTelemetry."
