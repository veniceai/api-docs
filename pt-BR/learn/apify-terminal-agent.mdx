...
description: "Construa um agente de terminal em Python que raciocina com chat completions da Venice e raspa a web ao vivo via Apify Actors expostos por MCP."
