---
title: Venice API
description: "Documentação da Venice API — acesso privado e irrestrito a modelos de chat, imagem, áudio e vídeo compatíveis com OpenAI por trás de uma única chave de API."
