---
title: "Venice API"
description: "Guias, quickstarts e a referência completa da API para criar apps de IA privados na Venice com APIs de texto, imagem, vídeo e áudio compatíveis com OpenAI."
...
<div className="venice-apis-grid">
  ...
  <a className="venice-api-card" href="/pt-BR/api-reference/endpoint/audio/speech">
    ...
    <p className="venice-api-card-desc">Síntese de fala multilíngue e transcrição precisa, com clonagem de voz a partir de uma amostra de referência curta e conversão de voz speech-to-speech.</p>
...
<p className="venice-apis-extras">
  <a className="venice-apis-extras-cta" href="/pt-BR/guides/integrations/ai-agents#agentes-e-integrações">Explorar todos os apps de agente →</a>
</p>
...
<p className="venice-apis-extras">
  <a className="venice-apis-extras-cta" href="/pt-BR/guides/integrations/ai-agents#ferramentas-de-código">Explorar todos os agentes de programação →</a>
</p>
...
<a className="venice-models-cta" href="/pt-BR/models/overview">
  <span className="venice-models-cta-left">
    <span className="venice-models-cta-count">Mais de 350 modelos</span>
