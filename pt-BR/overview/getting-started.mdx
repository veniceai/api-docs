...
<Steps>
  <Step title="Obtenha sua chave de API">
    ...
    Para um passo a passo detalhado com screenshots, confira o [guia de chave de API](/guides/getting-started/generating-api-key).
  </Step>
...
<Card title="Ver todos os modelos de imagem" icon="image" href="/models/overview#image-models">
...
<CardGroup cols={2}>
  <Card title="Navegar pelos modelos" icon="database" href="/models/overview">
