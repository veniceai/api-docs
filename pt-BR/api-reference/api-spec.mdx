---
title: Introdução
description: "Referência completa da Venice API: autenticação Bearer, compatibilidade com OpenAI, cabeçalhos de resposta, tratamento de erros e todos os endpoints REST."
