---
title: Introdução
description: "Referência da Venice API cobrindo autenticação, depuração, compatibilidade com OpenAI, cabeçalhos de resposta, tratamento de erros e a lista completa de endpoints suportados."
