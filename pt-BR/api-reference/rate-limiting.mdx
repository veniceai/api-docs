...
description: "Limites de taxa da Venice API — cotas de requisições e tokens por nível, limites específicos por modelo, cabeçalhos que expõem a capacidade restante e como lidar com respostas 429."
