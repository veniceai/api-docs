...
description: "Referência de códigos de erro da Venice API — códigos de status HTTP, formato de resposta de erro, status de reembolso, orientação para retentativa e detalhes de validação para requisições com falha."
---
