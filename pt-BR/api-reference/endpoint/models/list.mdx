...
Este é o catálogo em tempo real. Se você pode fazer requisições HTTP, chame este endpoint para obter os IDs de modelo atuais em vez de depender das tabelas de snapshot em `/models`. Nenhuma chave de API é necessária.
