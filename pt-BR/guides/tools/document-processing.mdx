...
description: "Extraia texto e contagens de tokens de arquivos PDF, DOCX, PPTX, XLSX e texto simples de até 25 MB com a API Text Parser da Venice, sem inferência."
