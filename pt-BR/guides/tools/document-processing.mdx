...
## Transformando o texto em registros

O texto extraído é um ponto de partida, não um resultado. [Extraindo dados estruturados de documentos](/guides/tools/document-extraction) continua a partir daqui: fixando a saída em um esquema JSON para que cada documento produza os mesmos campos, e mudando para um modelo de visão quando o parser informa que um arquivo não tem texto para extrair.

## Recursos relacionados

- [Extraindo dados estruturados de documentos](/guides/tools/document-extraction)
