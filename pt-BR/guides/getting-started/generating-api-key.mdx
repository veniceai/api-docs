...
description: "Crie uma chave de API Venice a partir do painel, armazene o bearer token com segurança e verifique se ela funciona com uma primeira requisição autenticada a chat completions."
