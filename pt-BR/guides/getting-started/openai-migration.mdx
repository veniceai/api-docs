...
description: "Migre aplicações de chat, embeddings e imagem compatíveis com OpenAI para a Venice em minutos trocando a base URL e a chave de API — mesmo SDK, mais privacidade."
