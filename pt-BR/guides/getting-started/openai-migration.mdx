...
"og:title": "Migrate from OpenAI | Documentação da API Venice"
...
| Embeddings | ✅ | ✅ | Same API |
| Image Generation | ✅ | ✅ | compatível com OpenAI via `/images/generations`* |
| TTS | ✅ | ✅ | Compatible |
| STT | ✅ | ✅ | Compatible |
...
*Venice also provides an compatível com OpenAI endpoint at `POST /images/generations` for easier migration from DALL-E. For Venice's native image API with additional options, veja [Image Generate](/pt-BR/api-reference/endpoint/image/generate).
