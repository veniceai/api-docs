...
description: "Gere uma chave de API Venice de forma autônoma a partir de um agente de IA on-chain, fazendo stake de VVV na Base e assinando um token de validação emitido pela Venice com uma carteira."
