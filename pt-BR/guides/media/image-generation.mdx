...
description: "Gere imagens a partir de prompts de texto com o endpoint /image/generate da Venice ou a API compatível com OpenAI, com presets de estilo e saída base64."
