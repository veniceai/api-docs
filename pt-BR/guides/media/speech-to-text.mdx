...
description: "Transcreva arquivos de áudio em texto com os modelos de fala para texto da Venice usando o endpoint /audio/transcriptions compatível com OpenAI."
