...
description: "Envie mídia com rosto ao Seedance 2.0 na Venice: atestação em duas chamadas, objeto de consentimento, resposta needs_consent, dedupe e revogação."
