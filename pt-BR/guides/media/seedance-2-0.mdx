...
description: "Gere, edite, estenda e una vídeos com Seedance 2.0 e 2.5 na Venice - fluxos texto/imagem/referência, API faces-off e limites multimodais por família."
'og:title': "Guia Seedance 2.0 e 2.5 | Venice API Docs"
'og:description': "Gere, edite, estenda e una vídeos com Seedance 2.0 e 2.5 via API Venice. Fluxos, faces-off, limites, preços e exemplos."
---
