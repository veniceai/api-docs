...
description: "Gere, edite, estenda e costure vídeos com Seedance 2.0 e 2.5 na Venice - fluxos de text-to-video, image-to-video e reference-to-video, política de mídia da API pública e limites multimodais específicos por família."
