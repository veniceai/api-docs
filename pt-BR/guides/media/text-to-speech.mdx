...
description: "Gere áudio falado a partir de texto com os modelos de texto para fala da Venice, escolha uma voz específica do modelo e salve a resposta binária do endpoint /audio/speech."
