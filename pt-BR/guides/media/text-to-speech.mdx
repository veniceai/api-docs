...
description: "Gere áudio falado a partir de texto com os modelos de texto para fala da Venice via /audio/speech: escolha modelo, voz e salve o áudio binário."
