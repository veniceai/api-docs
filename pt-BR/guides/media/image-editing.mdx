...
'og:title': "Image Editing | Documentação da API Venice"
...
- [Image pricing](/pt-BR/overview/pricing)
- [Models API](/pt-BR/api-reference/endpoint/models/list) with `type=inpaint`
...
<Note>
Some edit models have stricter content policies than image generation models. Por exemplo, `qwen-edit` blocks requests involving explicit sexual imagery, sexualized minors, or real-world violence.
</Note>
...
- Use [Image Generation](/pt-BR/guides/media/image-generation) when you're starting from text instead of an existing image.
- Use [Image Models](/pt-BR/models/image) to compare generation, edit, and enhancement model families.
- Use [Image Edit API](/pt-BR/api-reference/endpoint/image/edit), [Multi-Edit API](/pt-BR/api-reference/endpoint/image/multi-edit), and [Background Remove API](/pt-BR/api-reference/endpoint/image/background-remove) for full schema details.
