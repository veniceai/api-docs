...
description: "Edite, faça inpainting, componha entradas em camadas e remova fundos de imagens usando as APIs síncronas de edição de imagem, multi-edição e remoção de fundo da Venice."
