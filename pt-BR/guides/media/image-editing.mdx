...
description: "Edite, faça inpainting, componha entradas em camadas e remova fundos com as APIs síncronas de edição, multi-edição e remoção de fundo da Venice."
