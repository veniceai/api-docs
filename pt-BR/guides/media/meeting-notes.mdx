...
description: "Transforme uma gravação em decisões e itens de ação com a API /audio/transcriptions da Venice, ligando cada item ao momento em que foi acordado."
