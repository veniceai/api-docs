...
description: "Gere vídeos a partir de prompts de texto ou imagens iniciais na API de fila assíncrona da Venice — envie um job, faça polling do status e baixe o vídeo finalizado."
