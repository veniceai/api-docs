...
description: "Clone uma voz a partir de uma pequena amostra de áudio com o Chatterbox HD, salve o handle de voz retornado e gere fala pela API de áudio da Venice."
