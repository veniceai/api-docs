...
description: "O servidor oficial Model Context Protocol da Venice expõe 30 ferramentas Venice para chat, imagem, vídeo, áudio, música e personagens em qualquer host MCP."
...
<CardGroup cols={3}>
  <Card title="30 ferramentas" icon="toolbox">
...
**30 ferramentas** abrangendo cada modalidade Venice, **3 recursos** (`venice://models`, `venice://styles`, `venice://voices`) e **3 templates de prompt**.
