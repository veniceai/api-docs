---
title: Codex CLI
description: "Aponte o Codex CLI da OpenAI para modelos Venice com uma entrada de provedor no config.toml, sua VENICE_API_KEY e a base URL compatível com OpenAI."
