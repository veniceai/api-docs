---
title: Codex CLI
description: "Aponte o Codex CLI da OpenAI para modelos Venice com um config.toml local para que o agente de código use a API privada e compatível com OpenAI."
