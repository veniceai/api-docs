---
title: Claude Code
description: "Roteie requisições do Claude Code CLI pela Venice com o claude-code-router: acesso pago por token aos modelos de código Claude Opus, Sonnet e Fable."
