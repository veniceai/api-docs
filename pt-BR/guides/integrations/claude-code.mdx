---
title: Claude Code
description: "Configure o CLI do Claude Code para rotear requisições de Claude Opus e Sonnet pela Venice e obter inferência privada de agente paga por uso."
"og:title": "Claude Code com Venice | Documentação da API Venice"
"og:description": "Configure o Claude Code para usar Claude Opus 4.5/4.6/4.7/4.8, Sonnet 4.5/4.6/4.7/4.8 e Fable 5 através da Venice AI"
---

O [Claude Code](https://docs.anthropic.com/en/docs/claude-code) é a ferramenta CLI da Anthropic para codificação agêntica. Este guia mostra como executá-lo via Venice AI para acesso por token (pay-per-token) aos modelos Claude Opus 4.5/4.6/4.7/4.8, Sonnet 4.5/4.6/4.7/4.8 e Fable 5.
...
<CardGroup cols={3}>
  ...
  <Card title="Modelos Claude" icon="microchip">
    Acesse Opus 4.5/4.6/4.7/4.8, Sonnet 4.5/4.6/4.7/4.8 e Fable 5 através da Venice
  </Card>
...
<Steps>
  ...
  <Step title="Obtenha sua chave de API">
    Gere uma chave em [venice.ai/settings/api](https://venice.ai/settings/api?utm_source=venice-api-documentation). Você a colará diretamente no arquivo de configuração na próxima etapa.
  </Step>
...
| Claude Opus 4.7 | `claude-opus-4-7` | Raciocínio complexo, grandes refatorações |
| Claude Opus 4.7 Fast | `claude-opus-4-7-fast` | Raciocínio complexo com menor latência |
| Claude Opus 4.8 | `claude-opus-4-8` | Raciocínio complexo, grandes refatorações |
| Claude Opus 4.8 Fast | `claude-opus-4-8-fast` | Raciocínio complexo com menor latência |
| Claude Fable 5 | `claude-fable-5` | Tarefas complexas que exigem a maior inteligência |
