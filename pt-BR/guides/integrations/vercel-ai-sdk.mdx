---
title: "Vercel AI SDK"
description: "Faça streaming de chat completions da Venice em apps Next.js e React com o provedor compatível com OpenAI do Vercel AI SDK para UIs de IA e chatbots."
...
const MODELS = [
  ...
  { id: 'z-ai-glm-5-3-flash', name: 'GLM 5.3 Flash', desc: 'Raciocínio privado rápido' },
...
| Tarefas complexas | `z-ai-glm-5-3-flash` | Raciocínio privado rápido |
...
| Tool calling | `z-ai-glm-5-3-flash` | Function calling confiável |
