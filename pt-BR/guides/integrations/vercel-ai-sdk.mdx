...
The [Vercel AI SDK](https://sdk.vercel.ai/) is the most popular way to build AI features in Next.js, React, Svelte, and Vue apps. Venice works pronto para uso as an compatível com OpenAI provider.
...
Create a Venice provider using the compatível com OpenAI adapter:
...
<CardGroup cols={2}>
  ...
  <Card title="Venice Models" icon="database" href="/pt-BR/models/overview">
