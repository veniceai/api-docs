---
title: NanoClaw
description: "Implante o NanoClaw, assistente de IA auto-hospedado para WhatsApp e Telegram, na Venice AI para inferência privada e sem censura com isolamento Docker."
...
A [Venice](https://venice.ai/?utm_source=venice-api-documentation) é uma plataforma de IA focada em privacidade. Ela [não armazena nem registra prompts ou respostas](https://venice.ai/privacy?utm_source=venice-api-documentation) em seus servidores — suas conversas existem apenas no seu dispositivo. As requisições são criptografadas ponta a ponta através de seu proxy para provedores de GPU descentralizados, com zero retenção de dados. Isso significa que as conversas com seu assistente de IA permanecem privadas, até mesmo da própria Venice.
...
| **Preço** | Pague por token, sem assinatura. Ou faça staking de [DIEM](https://venice.ai/lp/diem?utm_source=venice-api-documentation) para créditos diários | Assinaturas de $20–200/mês ou API por token |
...
<CardGroup cols={2}>
  ...
  <Card title="Chave de API Venice" icon="key" href="https://venice.ai/settings/api?utm_source=venice-api-documentation">
