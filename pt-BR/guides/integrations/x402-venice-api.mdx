...
### With compatível com OpenAI tools
...
<CardGroup cols={2}>
  ...
  <Card title="API Pricing" icon="coins" href="/pt-BR/overview/pricing">
    Check model pricing and how Venice charges usage.
  </Card>

  <Card title="Chat Completions" icon="message" href="/pt-BR/api-reference/endpoint/chat/completions">
    A common paid route for wallet-based access.
  </Card>

  <Card title="API Spec" icon="code" href="/pt-BR/api-reference/api-spec">
