---
title: "Integração com LangChain"
description: "Conecte modelos da Venice ao LangChain para chains, agentes, uso de ferramentas e pipelines RAG usando o cliente ChatOpenAI compatível com OpenAI e os SDKs em Python ou JS."
"og:title": "Integração com LangChain | Documentação da API Venice"
