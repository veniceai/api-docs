...
"og:title": "LangChain Integration | Documentação da API Venice"
...
documents = [
    ...
    "The Venice API is compatível com OpenAI, supporting chat completions, images, audio, video, and embeddings.",
...
<Card title="View All Models" icon="database" href="/pt-BR/models/overview">
