...
<Card title="GitHub: veniceai/skills" icon="github" href="https://github.com/veniceai/skills">
  19 skills covering the full Venice API. MIT licensed. Kept in sync with the public [`swagger.yaml`](/pt-BR/api-reference/api-spec).
</Card>
...
| `venice-responses` | `/responses`, the compatível com OpenAI Responses API (Alpha) |
...
Por exemplo, an agent that needs to generate music will load `venice-audio-music` and immediately know:
...
<CardGroup cols={2}>
  ...
  <Card title="Venice API Spec" icon="book" href="/pt-BR/api-reference/api-spec">
