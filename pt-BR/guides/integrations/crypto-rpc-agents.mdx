...
description: "Use a Venice tanto como provedora de modelos quanto como camada RPC de blockchain para agentes de IA autônomos — uma credencial, mais de 230 modelos, 11 chains, sem MetaMask."
