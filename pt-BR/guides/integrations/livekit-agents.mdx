...
description: "Crie agentes de voz em tempo real com LiveKit Agents e Venice, conectando STT, LLM e TTS da Venice por meio do plugin compatível com OpenAI em um pipeline STT-LLM-TTS."
