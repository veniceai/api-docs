---
title: "CrewAI"
description: "Construa equipes multiagentes com CrewAI e Venice configurando modelos privados e sem censura da Venice como backend LLM para colaboração por papéis."
"og:title": "CrewAI | Documentação da API Venice"
...
|-----------|-------------------|-----|
| Raciocínio complexo / Estratégia | `z-ai-glm-5-3-flash` | Modelo privado rápido de raciocínio |
...
3. **Use GLM 5.3 Flash para raciocínio**: Use `z-ai-glm-5-3-flash` para agentes que precisam de raciocínio complexo ou function calling confiável.
