---
title: OpenCode
description: "Conecte o OpenCode à Venice por um provedor compatível com OpenAI para que seu agente de código rode em modelos privados com um único arquivo de config."
