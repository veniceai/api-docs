---
title: OpenCode
description: "Conecte o OpenCode à Venice com um provedor personalizado no opencode.json para que seu agente de código no terminal use modelos privados com um só arquivo."
...
Se definiu `"model": "venice/z-ai-glm-5-3-flash"` como mostrado acima, o OpenCode deve usar esse modelo Venice por padrão. Você pode mudar o padrão substituindo `z-ai-glm-5-3-flash` por qualquer ID de modelo do [catálogo de modelos de texto](/models/text) e adicionando-o ao mapa `models`.
