...
|---|---|---|
| Tomadas de personagem (1-2 personagens) | `seedance-2-0-reference-to-video-api` | R2V padrão com `reference_image_urls` flat, tags `@Image`, até 15s, áudio estéreo nativo |
...
| Estabelecimento / atmosfera / ação | `seedance-2-0-image-to-video-api` | Sem personagens; qualidade cinemática épica, até 15s |
