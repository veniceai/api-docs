...
- **Venice production skills** in `.claude/skills/` (compatible with the [Agent Skills](/pt-BR/guides/integrations/venice-skills) format)
...
<CardGroup cols={3}>
  ...
  <Card title="Venice API key" icon="key" href="/pt-BR/guides/getting-started/generating-api-key">
...
Você também pode call into the harness's modules directly from your own TypeScript:
...
<CardGroup cols={2}>
  ...
  <Card title="Venice Video Generation" icon="film" href="/pt-BR/guides/media/video-generation">
    The underlying API the harness drives
  </Card>
  <Card title="Reference-to-Video" icon="image" href="/pt-BR/guides/media/reference-to-video">
    R2V guide for character consistency
  </Card>
  <Card title="Seedance 2.0" icon="bolt" href="/pt-BR/guides/media/seedance-2-0">
