...
| Chamada de ferramentas / saída estruturada | `z-ai-glm-5-3-flash` | Modelo privado rápido para agentes |
| Raciocínio complexo | `z-ai-glm-5-3-flash` | Melhor planejamento em múltiplas etapas |
