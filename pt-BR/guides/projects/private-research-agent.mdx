...
description: "Construa um agente de pesquisa em Python na Venice que planeja buscas, lê fontes via API de scrape, extrai evidências e gera relatórios Markdown citados."
