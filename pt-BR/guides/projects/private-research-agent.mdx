...
description: "Construa um agente de pesquisa em Python na Venice que planeja buscas, lê fontes da web pela API de scrape, extrai evidências e escreve relatórios em Markdown com citações."
