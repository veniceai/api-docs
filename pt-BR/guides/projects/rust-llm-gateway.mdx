...
description: "Construa sobre a Venice um gateway LLM em Rust compatível com OpenAI usando Axum, Postgres, SQLx, autenticação bearer-token, streaming, limites de taxa e OpenTelemetry."
