...
description: "Guia prático para construir sobre a Venice um gateway LLM em Rust compatível com OpenAI usando Axum, Postgres, SQLx, streaming, limites de taxa e OpenTelemetry."
