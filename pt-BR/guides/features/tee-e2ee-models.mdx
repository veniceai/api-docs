...
<Info>
Para uma visão geral dos modos de privacidade e ajuda para escolher TEE ou E2EE, consulte [Privacidade](/overview/privacy). Este guia aborda os detalhes do protocolo e da implementação.
</Info>

<Note>
TEE e E2EE estão disponíveis atualmente apenas em modelos de texto.
</Note>
...
<CodeGroup>
```bash cURL
# Gera um nonce aleatório de 32 bytes (previne ataques de repetição)
