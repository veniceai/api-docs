...
description: "Permita que os modelos de chat da Venice chamem ferramentas da sua aplicação com function calling compatível com OpenAI via /chat/completions."
