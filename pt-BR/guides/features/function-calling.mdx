...
O exemplo acima para depois de uma única ida e volta. Agentes reais continuam avançando, porque o modelo geralmente precisa de várias ferramentas antes de poder responder. [Construindo um Agente que Usa Ferramentas com Function Calling](/guides/features/tool-using-agent) percorre o loop inteiro contra um banco de dados que o modelo nunca viu, incluindo chamadas de ferramenta paralelas, o retorno de erros dos quais o modelo se recupera e a diferença entre um modelo que recusa e uma guarda que impede.
...
- [Construindo um Agente que Usa Ferramentas com Function Calling](/guides/features/tool-using-agent)
