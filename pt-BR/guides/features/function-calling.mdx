...
description: "Permita que os modelos de chat da Venice chamem as ferramentas da sua aplicação com function calling compatível com OpenAI e a API de chat completions."
