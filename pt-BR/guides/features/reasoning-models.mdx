...
description: "Use modelos de raciocínio da Venice que expõem tokens de cadeia de pensamento, controlam o esforço e mostram respostas passo a passo no chat."
...
Veja a lista completa de modelos, preços e limites de contexto na [página de modelos](/overview/models). Nem todos os modelos de raciocínio suportam o parâmetro [`reasoning_effort`](#esforço-de-raciocínio). Veja [suporte por modelo](#suporte-por-modelo) para detalhes.
...
Para obter mais saída visível, aumente o limite, reduza `reasoning_effort` ou [desabilite o raciocínio](#desabilitando-o-raciocínio).
