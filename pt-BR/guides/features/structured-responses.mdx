...
'og:title': "Structured Responses | Documentação da API Venice"
...
Aqui está um exemplo of an API call using response\_format to explain the step-by-step process of solving a math equation.
