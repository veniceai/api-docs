---
title: API 定价
"og:title": "定价 | Venice API 文档"
"og:description": "了解 Venice API 的定价。"
---

除非另有说明，价格均以每 100 万 tokens 计。所有价格单位为美元。1 Diem = 每天 1 美元的算力。
...
| 模型 | ID | 输入价格 | 输出价格 | 缓存读 | 缓存写 | 上下文 | 隐私 |
|---|---|---|---|---|---|---|---|
...
*价格按每 100 万 tokens 计。[查看所有模型 →](/zh/models/text)*

### 嵌入

<div id="pricing-embedding-placeholder">

| 模型 | ID | 输入（每 100 万 tokens） | 输出（每 100 万 tokens） | 隐私 |
|---|---|---|---|---|
...
| 模型 | ID | 价格 | 隐私 |
|---|---|---|---|
| Recraft V4 Pro | `recraft-v4-pro` | 每张图：$0.29 | Anonymized |
| GPT Image 2 | `gpt-image-2` | 1K：$0.27，2K：$0.51，4K：$0.84 | Anonymized |
| GPT Image 1.5 | `gpt-image-1-5` | 每张图：$0.26 | Anonymized |
| Nano Banana Pro | `nano-banana-pro` | 1K：$0.18，2K：$0.23，4K：$0.35 | Anonymized |
| Ideogram V4 | `ideogram-v4` | 每张图：$0.15 | Anonymized |
| Nano Banana 2 | `nano-banana-2` | 1K：$0.10，2K：$0.14，4K：$0.19 | Anonymized |
| Qwen Image 2 Pro | `qwen-image-2-pro` | 每张图：$0.10 | Anonymized |
| Wan 2.7 Pro | `wan-2-7-pro-text-to-image` | 每张图：$0.09 | Anonymized |
| Flux 2 Max | `flux-2-max` | 每张图：$0.09 | Anonymized |
| Grok Imagine High Quality (SOTA) | `grok-imagine-image-quality` | 1K：$0.08，2K：$0.10 | Private |
| ImagineArt 1.5 Pro | `imagineart-1.5-pro` | 每张图：$0.06 | Anonymized |
| Qwen Image 2 | `qwen-image-2` | 每张图：$0.05 | Anonymized |
| Recraft V4 | `recraft-v4` | 每张图：$0.05 | Anonymized |
| Seedream V4.5 | `seedream-v4` | 每张图：$0.05 | Anonymized |
| Seedream V5 Lite | `seedream-v5-lite` | 每张图：$0.05 | Anonymized |
| Flux 2 Pro | `flux-2-pro` | 每张图：$0.04 | Anonymized |
| Grok Imagine | `grok-imagine-image` | 1K：$0.04，2K：$0.06 | Private |
| Wan 2.7 | `wan-2-7-text-to-image` | 每张图：$0.04 | Anonymized |
| Background Remover | `bria-bg-remover` | 每张图：$0.03 | Anonymized |
| Qwen Image | `qwen-image` | 每张图：$0.03 | Anonymized |
| Anime (WAI) | `wai-Illustrious` | 每张图：$0.01 | Private |
| Chroma | `chroma` | 每张图：$0.01 | Private |
| Lustify SDXL | `lustify-sdxl` | 每张图：$0.01 | Private |
| Lustify v7 | `lustify-v7` | 每张图：$0.01 | Private |
| Lustify v8 | `lustify-v8` | 每张图：$0.01 | Private |
| Venice SD35 | `venice-sd35` | 每张图：$0.01 | Private |
| Z-Image Turbo | `z-image-turbo` | 每张图：$0.01 | Private |
| Hunyuan Image 3.0 (Beta) | `hunyuan-image-v3` | 每张图：$0.09 | Private |
| Krea v2 Large (Beta) | `krea-v2-large` | 每张图：$0.07 | Anonymized |
| Krea v2 Medium (Beta) | `krea-v2-medium` | 每张图：$0.04 | Anonymized |
...
<Info>
如需在生成前获取精确价格，请使用 [Audio Quote API](/zh/api-reference/endpoint/audio/quote)。按时长计费的模型有固定的价格档位，而按秒计费的模型则根据输出长度收费。
</Info>
...
视频定价因分辨率和时长而异。访问[视频模型页面](/zh/models/video)以获取精确报价，或使用 [Video Quote API](/zh/api-reference/endpoint/video/quote)。

| 模型 | ID | 类型 | 定价 | 隐私 |
|---|---|---|---|---|
| Grok Imagine | `grok-imagine-text-to-video` | Text to Video | 浮动 | Anonymized |
| Grok Imagine | `grok-imagine-image-to-video` | Image to Video | 浮动 | Anonymized |
| Grok Imagine 1.5 Private | `grok-imagine-1-5-image-to-video-private` | Image to Video | 浮动 | Private |
| Grok Imagine Private | `grok-imagine-text-to-video-private` | Text to Video | 浮动 | Private |
| Grok Imagine Private | `grok-imagine-image-to-video-private` | Image to Video | 浮动 | Private |
| Grok Imagine Private | `grok-imagine-video-to-video-private` | Text to Video | 浮动 | Private |
| Grok Imagine R2V (Beta) | `grok-imagine-reference-to-video` | Text to Video | 浮动 | Anonymized |
| Grok Imagine R2V Private | `grok-imagine-reference-to-video-private` | Text to Video | 浮动 | Private |
| HappyHorse 1.0 | `happyhorse-1-0-text-to-video` | Text to Video | 浮动 | Anonymized |
| HappyHorse 1.0 | `happyhorse-1-0-image-to-video` | Image to Video | 浮动 | Anonymized |
| HappyHorse 1.0 Edit | `happyhorse-1-0-video-to-video` | Text to Video | 浮动 | Anonymized |
| HappyHorse 1.0 Reference | `happyhorse-1-0-reference-to-video` | Text to Video | 浮动 | Anonymized |
| Kling 2.5 Turbo Pro | `kling-2.5-turbo-pro-text-to-video` | Text to Video | 浮动 | Anonymized |
| Kling 2.5 Turbo Pro | `kling-2.5-turbo-pro-image-to-video` | Image to Video | 浮动 | Anonymized |
| Kling 2.6 Pro | `kling-2.6-pro-text-to-video` | Text to Video | 浮动 | Anonymized |
| Kling 2.6 Pro | `kling-2.6-pro-image-to-video` | Image to Video | 浮动 | Anonymized |
| Kling O3 4K | `kling-o3-4k-text-to-video` | Text to Video | 浮动 | Anonymized |
| Kling O3 4K | `kling-o3-4k-image-to-video` | Image to Video | 浮动 | Anonymized |
| Kling O3 4K R2V | `kling-o3-4k-reference-to-video` | Text to Video | 浮动 | Anonymized |
| Kling O3 Pro | `kling-o3-pro-text-to-video` | Text to Video | 浮动 | Anonymized |
| Kling O3 Pro | `kling-o3-pro-image-to-video` | Image to Video | 浮动 | Anonymized |
| Kling O3 Pro R2V (Beta) | `kling-o3-pro-reference-to-video` | Text to Video | 浮动 | Anonymized |
| Kling O3 Standard | `kling-o3-standard-text-to-video` | Text to Video | 浮动 | Anonymized |
| Kling O3 Standard | `kling-o3-standard-image-to-video` | Image to Video | 浮动 | Anonymized |
| Kling O3 Standard R2V (Beta) | `kling-o3-standard-reference-to-video` | Text to Video | 浮动 | Anonymized |
| Kling V3 4K | `kling-v3-4k-text-to-video` | Text to Video | 浮动 | Anonymized |
| Kling V3 4K R2V | `kling-v3-4k-reference-to-video` | Text to Video | 浮动 | Anonymized |
| Kling V3 Pro | `kling-v3-pro-text-to-video` | Text to Video | 浮动 | Anonymized |
| Kling V3 Pro | `kling-v3-pro-image-to-video` | Image to Video | 浮动 | Anonymized |
| Kling V3 Pro Motion Control | `kling-v3-pro-motion-control` | Text to Video | 浮动 | Anonymized |
| Kling V3 Standard | `kling-v3-standard-text-to-video` | Text to Video | 浮动 | Anonymized |
| Kling V3 Standard | `kling-v3-standard-image-to-video` | Image to Video | 浮动 | Anonymized |
| Kling V3 Standard Motion Control | `kling-v3-standard-motion-control` | Text to Video | 浮动 | Anonymized |
| Longcat Distilled | `longcat-distilled-image-to-video` | Image to Video | 浮动 | Private |
| Longcat Distilled | `longcat-distilled-text-to-video` | Text to Video | 浮动 | Private |
| Longcat Full Quality | `longcat-image-to-video` | Image to Video | 浮动 | Private |
| Longcat Full Quality | `longcat-text-to-video` | Text to Video | 浮动 | Private |
| LTX Video 2.0 19B | `ltx-2-19b-full-text-to-video` | Text to Video | 浮动 | Private |
| LTX Video 2.0 19B | `ltx-2-19b-full-image-to-video` | Image to Video | 浮动 | Private |
| LTX Video 2.0 19B Distilled | `ltx-2-19b-distilled-text-to-video` | Text to Video | 浮动 | Private |
| LTX Video 2.0 19B Distilled | `ltx-2-19b-distilled-image-to-video` | Image to Video | 浮动 | Private |
| LTX Video 2.0 Fast | `ltx-2-fast-image-to-video` | Image to Video | 浮动 | Anonymized |
| LTX Video 2.0 Fast | `ltx-2-fast-text-to-video` | Text to Video | 浮动 | Anonymized |
| LTX Video 2.0 Full Quality | `ltx-2-full-image-to-video` | Image to Video | 浮动 | Anonymized |
| LTX Video 2.0 Full Quality | `ltx-2-full-text-to-video` | Text to Video | 浮动 | Anonymized |
| LTX Video 2.3 Fast | `ltx-2-v2-3-fast-image-to-video` | Image to Video | 浮动 | Anonymized |
| LTX Video 2.3 Fast | `ltx-2-v2-3-fast-text-to-video` | Text to Video | 浮动 | Anonymized |
| LTX Video 2.3 Full Quality | `ltx-2-v2-3-full-image-to-video` | Image to Video | 浮动 | Anonymized |
| LTX Video 2.3 Full Quality | `ltx-2-v2-3-full-text-to-video` | Text to Video | 浮动 | Anonymized |
| Ovi | `ovi-image-to-video` | Image to Video | 浮动 | Private |
| PixVerse C1 | `pixverse-c1-text-to-video` | Text to Video | 浮动 | Anonymized |
| PixVerse C1 | `pixverse-c1-image-to-video` | Image to Video | 浮动 | Anonymized |
| PixVerse C1 R2V | `pixverse-c1-reference-to-video` | Text to Video | 浮动 | Anonymized |
| PixVerse C1 Transition | `pixverse-c1-transition` | Text to Video | 浮动 | Anonymized |
| PixVerse v5.6 | `pixverse-v5.6-text-to-video` | Text to Video | 浮动 | Anonymized |
| PixVerse v5.6 | `pixverse-v5.6-image-to-video` | Image to Video | 浮动 | Anonymized |
| PixVerse v5.6 Transition | `pixverse-v5.6-transition` | Text to Video | 浮动 | Anonymized |
| Runway Gen-4 Aleph | `runway-gen4-aleph` | Text to Video | 浮动 | Anonymized |
| Runway Gen-4 Turbo | `runway-gen4-turbo` | Text to Video | 浮动 | Anonymized |
| Runway Gen-4.5 | `runway-gen4-5` | Text to Video | 浮动 | Anonymized |
| Runway Gen-4.5 | `runway-gen4-5-text` | Text to Video | 浮动 | Anonymized |
| Seedance 1.5 Pro | `seedance-1-5-pro-text-to-video` | Text to Video | 浮动 | Anonymized |
| Seedance 1.5 Pro | `seedance-1-5-pro-image-to-video` | Image to Video | 浮动 | Anonymized |
| Seedance 2.0 | `seedance-2-0-text-to-video` | Text to Video | 浮动 | Anonymized |
| Seedance 2.0 | `seedance-2-0-image-to-video` | Image to Video | 浮动 | Anonymized |
| Seedance 2.0 Enhanced (Beta) | `seedance-2-0-enhanced-text-to-video` | Text to Video | 浮动 | Anonymized |
| Seedance 2.0 Enhanced R2V (Beta) | `seedance-2-0-enhanced-reference-to-video` | Text to Video | 浮动 | Anonymized |
| Seedance 2.0 Fast | `seedance-2-0-fast-text-to-video` | Text to Video | 浮动 | Anonymized |
| Seedance 2.0 Fast | `seedance-2-0-fast-image-to-video` | Image to Video | 浮动 | Anonymized |
| Seedance 2.0 Fast R2V | `seedance-2-0-fast-reference-to-video` | Text to Video | 浮动 | Anonymized |
| Seedance 2.0 R2V | `seedance-2-0-reference-to-video` | Text to Video | 浮动 | Anonymized |
| Topaz Video Upscale | `topaz-video-upscale` | Text to Video | 浮动 | Anonymized |
| Veo 3 Fast | `veo3-fast-text-to-video` | Text to Video | 浮动 | Anonymized |
| Veo 3 Fast | `veo3-fast-image-to-video` | Image to Video | 浮动 | Anonymized |
| Veo 3 Full Quality | `veo3-full-text-to-video` | Text to Video | 浮动 | Anonymized |
| Veo 3 Full Quality | `veo3-full-image-to-video` | Image to Video | 浮动 | Anonymized |
| Veo 3.1 Fast | `veo3.1-fast-text-to-video` | Text to Video | 浮动 | Anonymized |
| Veo 3.1 Fast | `veo3.1-fast-image-to-video` | Image to Video | 浮动 | Anonymized |
| Veo 3.1 Full Quality | `veo3.1-full-text-to-video` | Text to Video | 浮动 | Anonymized |
| Veo 3.1 Full Quality | `veo3.1-full-image-to-video` | Image to Video | 浮动 | Anonymized |
| Vidu Q3 | `vidu-q3-text-to-video` | Text to Video | 浮动 | Anonymized |
| Vidu Q3 | `vidu-q3-image-to-video` | Image to Video | 浮动 | Anonymized |
| Wan 2.1 Pro | `wan-2.1-pro-image-to-video` | Image to Video | 浮动 | Private |
| Wan 2.2 A14B | `wan-2.2-a14b-text-to-video` | Text to Video | 浮动 | Private |
| Wan 2.5 Preview | `wan-2.5-preview-image-to-video` | Image to Video | 浮动 | Anonymized |
| Wan 2.5 Preview | `wan-2.5-preview-text-to-video` | Text to Video | 浮动 | Anonymized |
| Wan 2.6 | `wan-2.6-image-to-video` | Image to Video | 浮动 | Anonymized |
| Wan 2.6 | `wan-2.6-text-to-video` | Text to Video | 浮动 | Anonymized |
| Wan 2.6 Flash | `wan-2.6-flash-image-to-video` | Image to Video | 浮动 | Anonymized |
| Wan 2.7 | `wan-2-7-text-to-video` | Text to Video | 浮动 | Anonymized |
| Wan 2.7 | `wan-2-7-image-to-video` | Image to Video | 浮动 | Anonymized |
| Wan 2.7 Edit | `wan-2-7-video-to-video` | Text to Video | 浮动 | Anonymized |
| Wan 2.7 Reference | `wan-2-7-reference-to-video` | Text to Video | 浮动 | Anonymized |
| Wan 2.7 Uncensored | `wan-2-7-uncensored-image-to-video` | Image to Video | 浮动 | Anonymized |
| Wan 2.7 Uncensored (Beta) | `wan-2-7-uncensored-text-to-video` | Text to Video | 浮动 | Anonymized |
...
| 功能 | 配置 | 定价 |
|---|---|---|
| 网页搜索 | `enable_web_search: true` | 每 1K 次请求 $10.00 |
| 网页抓取 | `enable_web_scraping: true` | 每 1K 个 URL $10.00 |
| X 搜索 (xAI) | `enable_x_search: true` | 每 1K 条结果 $10.00 |

</div>

<Info>
**网页抓取**会自动检测每个请求中的最多 5 个 URL，抓取并将内容转换为结构化 markdown，再将提取的文本加入模型上下文。仅成功抓取的 URL 才会计费。

**X 搜索**为受支持的 Grok 模型（例如 `grok-4-20-beta`）启用 xAI 原生搜索。此功能会在网络和 X/Twitter 中搜索实时信息。按模型返回的搜索结果数计费（例如，模型返回 10 条搜索结果，则按 10 条 × $0.01 = $0.10 收费）。

这些费用会在标准模型 token 价格之外额外收取。
</Info>
...
<CardGroup cols={3}>
  <Card title="USD" icon="credit-card" href="https://venice.ai/settings/api">
    使用信用卡购买 API credit。Credit 永不过期。
  </Card>
  <Card title="加密货币" icon="bitcoin" href="https://venice.ai/settings/api">
    使用加密货币购买 API credit，费率与 USD 相同。
  </Card>
  <Card title="Stake DIEM" icon="coins" href="https://venice.ai/token">
    每个 Diem = 每天 $1 的 credit，每日刷新。
  </Card>
</CardGroup>

### Pro 用户

升级到 Pro 的订阅者可获得一次性 $10 的 API credit。可用于测试和构建小型应用。
