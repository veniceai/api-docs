---
title: Venice API
description: "Venice API 官方文档——通过单一 API 密钥私密、无审查地访问 OpenAI 兼容的 chat、image、audio 和 video 模型，涵盖 230+ 开源模型、TEE 与 E2EE 隐私模式、DIEM 计费、Skills 工具调用以及各类 SDK 与 agent 集成指南。"
