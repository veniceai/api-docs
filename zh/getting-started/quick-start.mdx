---
title: "快速开始"
description: "Venice API 快速开始指南：生成 API 密钥并配置环境变量，安装 OpenAI 兼容 SDK，用 Python、Node.js 或 curl 发送第一个 /chat/completions 聊天补全请求，并在几分钟内继续探索图像生成、视频与音频端点，开始构建你的应用。"
...
<Steps>
  <Step title="获取你的 API 密钥">
    前往 [Venice API 设置](https://venice.ai/settings/api?utm_source=venice-api-documentation) 并生成一个新的 API 密钥。
