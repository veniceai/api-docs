---
title: "构建私有 RAG 机器人"
description: "使用 Venice embeddings 嵌入、Qdrant 向量搜索、FastEmbed 本地重排序和 Venice chat completions 用 Python 构建私有 RAG 检索增强生成机器人，摄取您的文档、检索并重排相关 chunk，获得有据可循、可引用的答案。"
