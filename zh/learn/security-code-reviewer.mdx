---
title: "构建代码库安全审查器"
description: "在 Venice 上用 Python 构建双 agent 代码库安全审查器：借助 AST 代码仓库映射和 Pydantic 防护找出原子级漏洞，并将其串联成账户接管等利用路径，最终生成可指向任何 Python 代码库的 Markdown 审查报告，附 GitHub 完整代码仓库。"
...
- Python 3.12+
- 来自 [venice.ai](https://venice.ai/?utm_source=venice-api-documentation) 的 Venice API 密钥
