---
title: 简介
description: "Venice API 参考文档，涵盖 Bearer API 密钥身份验证、OpenAI 兼容性、base URL 配置、响应标头、错误处理与调试，以及聊天补全、图像、视频、音频、嵌入等所有受支持端点的完整列表与 OpenAPI 规范，帮助开发者快速集成无审查模型与私有推理能力。"
