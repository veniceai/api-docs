---
title: Hermes Agent
description: "将 Venice 配置为 Nous Research 开源 Hermes Agent 的模型提供方，通过单一 OpenAI 兼容端点访问 230+ 文本、图像、视频、音频与 embeddings 模型，获得具备持久记忆、自定义技能和多平台消息能力的私有 AI。"
...
如果您还没有 API 密钥，可以从 [venice.ai/settings/api](https://venice.ai/settings/api?utm_source=venice-api-documentation) 获取。
