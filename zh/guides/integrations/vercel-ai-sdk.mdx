---
title: "Vercel AI SDK"
description: "通过 Vercel AI SDK 的 OpenAI 兼容提供方，在 Next.js 和 React 应用中以流式方式调用 Venice chat completions，构建生产级 AI UI 和聊天机器人。"
...
const MODELS = [
  ...
  { id: 'z-ai-glm-5-3-flash', name: 'GLM 5.3 Flash', desc: '快速的私有推理' },
