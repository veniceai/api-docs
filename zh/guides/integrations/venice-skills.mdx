---
title: Venice Skills
description: "官方 Venice Agent Skills 将端点知识加载到 Claude Code、Cursor、Codex、OpenCode、Hermes 和 Cline，打造可靠的编码 agent。"
"og:title": "Venice Skills | Venice API Docs"
"og:description": "即插即用的 Agent Skills，教你的编码 agent 正确使用每一个 Venice 端点。"
---
...
<Card title="GitHub: veniceai/skills" icon="github" href="https://github.com/veniceai/skills">
  18 个 skill，覆盖完整的 Venice API。MIT 许可。与公开的 [`swagger.yaml`](/api-reference/api-spec) 保持同步。
</Card>

<CardGroup cols={3}>
  <Card title="18 个 Skill" icon="layer-group">
