---
title: "Rig"
description: "使用 Rig 0.42 原生的 venice 提供程序在 Rust 中构建类型化智能体，直接对接 Venice API，支持对话补全、流式传输、工具调用、结构化输出、嵌入、转录、图像生成、语音以及 venice_parameters 专属参数，并提供可运行的 Rust 示例代码。"
