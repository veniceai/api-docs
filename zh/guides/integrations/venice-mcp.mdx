...
description: "官方 Venice Model Context Protocol 服务器以 @veniceai/mcp-server 发布到 npm，在 Claude Desktop、Cursor 等 MCP 宿主中暴露 31 个 Venice 工具，覆盖聊天、图像、视频、音频、音乐、embeddings 与角色。"
...
<Steps>
  <Step title="获取 Venice API 密钥">
    从 [venice.ai/settings/api](https://venice.ai/settings/api?utm_source=venice-api-documentation) 生成。逐步说明请参阅 [API 密钥指南](/guides/getting-started/generating-api-key)。
  </Step>
...
| `VENICE_SIWX_TOKEN` | _(无)_ | x402 钱包模式身份验证 token。请参阅[下方的 x402](#x402-钱包模式)。 |
