---
title: NanoClaw
description: "在 Venice 上部署 NanoClaw —— 一款面向 WhatsApp 和 Telegram 的轻量级自托管个人 AI 助手，按 token 用量付费、无需 Anthropic 订阅，每个聊天运行在独立 Docker 容器中，实现私有、无审查的聊天和媒体生成。"
...
[Venice](https://venice.ai/?utm_source=venice-api-documentation) 是一个隐私优先的 AI 平台。他们[不存储或记录任何 prompt 或响应](https://venice.ai/privacy?utm_source=venice-api-documentation) 在其服务器上——您的对话仅存在于您的设备上。请求通过其代理端到端加密到去中心化 GPU 提供商，零数据保留。这意味着您的 AI 助手对话保持私密，即使对 Venice 自身也是如此。
...
| **定价** | 按 token 付费，无订阅。或质押 [DIEM](https://venice.ai/lp/diem?utm_source=venice-api-documentation) 获取每日刷新的 credit | 每月 $20–200 订阅或按 token 付费 API |
| **无审查推理** | 是（开源模型） | 否 |
...
<CardGroup cols={2}>
  ...
  <Card title="Venice API 密钥" icon="key" href="https://venice.ai/settings/api?utm_source=venice-api-documentation">
    从您的 Venice 账户生成
  </Card>
</CardGroup>
