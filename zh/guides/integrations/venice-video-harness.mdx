...
description: "通过 Claude Code、Cursor 等 IDE agent 驱动 Venice Video Harness 这一社区维护的开源工具包，调用 50+ Venice 视频、图像、音频和音乐模型，生成角色一致的视频、故事板、预告片和长篇叙事内容，支持文本优先剪辑工作流。"
...
<CardGroup cols={3}>
  ...
  <Card title="Venice API 密钥" icon="key" href="/guides/getting-started/generating-api-key">
    来自 [venice.ai/settings/api](https://venice.ai/settings/api?utm_source=venice-api-documentation)
  </Card>
</CardGroup>
