...
<div className="venice-demo-grid">
  ...
  <div className="venice-demo-card">
    ...
    <h3 className="venice-demo-title">音频研究笔记本</h3>
    <p className="venice-demo-desc">从你的资料获得带引用的答案，加上一段可以收听的双主持人音频概览。</p>
    <div className="venice-demo-tags">
      <span className="venice-demo-tag">Scrape</span>
      <span className="venice-demo-tag">文本解析</span>
      <span className="venice-demo-tag">嵌入</span>
      <span className="venice-demo-tag">文本转语音</span>
    </div>
    <div className="venice-demo-actions">
      <a className="venice-demo-link" href="/zh/guides/projects/audio-research-notebook">阅读指南 <span className="venice-demo-arrow">→</span></a>
