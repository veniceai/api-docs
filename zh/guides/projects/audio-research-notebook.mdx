...
这里的检索故意保持简单：向量放在 Python 列表里，余弦相似度用循环计算。对几十份资料来说，这是恰到好处的机制，也能让各个环节保持一目了然。当你发现规模不够用时，[构建私有 RAG 机器人](/guides/projects/private-rag-bot)介绍了同一条流水线，但使用真正的向量数据库和重排序步骤。
...
<CardGroup cols={2}>
  <Card title="私有 RAG 机器人" icon="database" href="/guides/projects/private-rag-bot">
