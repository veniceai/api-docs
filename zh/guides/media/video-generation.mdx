---
title: 视频生成
description: "在 Venice 异步队列 API 上从文本 prompt 或起始图像生成视频——调用 /video/quote 预估美元价格、通过 /video/queue 提交任务保存 queue_id、轮询 /video/retrieve 检查状态并下载 MP4 文件，再用 /video/complete 清理存储。"
