---
title: "网页搜索与抓取"
sidebarTitle: "网页搜索与抓取"
description: "使用 Venice Web Search（/augment/search）查找带标题、URL、摘要和日期的最新来源，并使用 Web Scrape（/augment/scrape）将选定公开页面提取为可供模型使用的 Markdown，为推理提供可核查的源材料与上下文。"
"og:title": "网页搜索与抓取 | Venice API 文档"
...
<Tip>
正在构建搜索到抓取的流水线？[基于网页搜索的带引用回答](/guides/tools/cited-web-answers) 会一步步介绍完整工作流，包括来源选择、处理提取失败的页面，以及生成每条论断都能追溯到 URL 的回答。
</Tip>

- [Web Search API 参考](/api-reference/endpoint/augment/search)
- [Web Scrape API 参考](/api-reference/endpoint/augment/scrape)
- [基于网页搜索的带引用回答](/guides/tools/cited-web-answers)
- [私密研究 Agent](/learn/private-research-agent)
