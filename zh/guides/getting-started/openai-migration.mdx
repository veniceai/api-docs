---
title: "从 OpenAI 迁移"
description: "只需更换 base URL 和 API 密钥，即可将 OpenAI 应用迁移到 Venice API，并附有涵盖 chat、图像、embeddings 和 TTS 的特性兼容性表。"
...
| Image Edits | ✅ | ❌ | 无 `/images/edits` 端点；请使用原生 [`/image/edit`](/guides/media/image-editing) |
| TTS | ✅ | ✅ | 兼容 |
| STT | ✅ | ✅ | 兼容 |
| Responses API | ✅ | ✅ | Alpha |
