...
description: "ابنِ وكيل طرفية بلغة Python يفكّر بإكمالات محادثة Venice API ويتصرّف عبر خادم Apify MCP لكشط الويب الحي باستخدام Actors مع استدعاء الدوال والبثّ إلى CLI."
