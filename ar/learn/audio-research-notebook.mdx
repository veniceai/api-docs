...
description: "حوّل مصادرك من روابط وملفات PDF إلى إجابات موثّقة بالاستشهادات ونظرة عامة صوتية بمُقدِّمَين باستخدام خمس نقاط نهاية من Venice API على غرار NotebookLM."
