...
description: "ابنِ وكيل أمان بلغة Python على Venice يكتشف الثغرات الذرّية ويربطها في مسارات استغلال باستخدام خريطة مستودع مبنية على AST وضوابط Pydantic."
...
- Python 3.12+
- مفتاح Venice API من [venice.ai](https://venice.ai/?utm_source=venice-api-documentation)
