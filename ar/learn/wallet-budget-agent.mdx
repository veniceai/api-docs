...
description: "ادفع مقابل الاستدلال على Venice من محفظة دون مفتاح API عبر x402 وUSDC، وضع سقفًا لما يستطيع الوكيل إنفاقه مع دفتر يسجّل كل خصم لكل طلب /chat/completions."
