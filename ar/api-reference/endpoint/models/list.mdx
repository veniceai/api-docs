...
هذا هو الكتالوج الحيّ. إذا كان بإمكانك إجراء طلبات HTTP، فاستدعِ هذه النقطة للحصول على معرّفات النماذج الحالية بدلًا من الاعتماد على جداول اللقطة في `/models`. لا حاجة إلى مفتاح API.
