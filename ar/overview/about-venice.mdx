---
title: Venice API
description: "وثائق Venice API الرسمية — وصول خاص وغير مُقيَّد إلى نماذج الدردشة والصور والصوت والفيديو المتوافقة مع OpenAI خلف مفتاح API واحد فقط بدون تسجيل."
