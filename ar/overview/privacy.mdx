...
<Note>
تتوفر TEE و E2EE حاليًا لنماذج النص فقط.
</Note>

| الوضع | بادئة معرّف النموذج | الحماية |
| --- | --- | --- |
| **TEE** | `e2ee-*` | استدلال معزول بالعتاد مع تصديق عن بُعد. |
| **E2EE** | `e2ee-*` | تشفير من جانب العميل إلى TEE موثوق. |

يستخدم كلا الوضعين معرّف النموذج نفسه. يحدد تدفق الطلب ما إذا كان النموذج يعمل في وضع TEE فقط أو يستخدم E2EE من جانب العميل.
