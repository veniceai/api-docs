---
title: تسعير API
"og:title": "التسعير | وثائق Venice API"
...
| Ideogram V4 | `ideogram-v4` | لكل صورة: $0.15 | Anonymized |
...
| Flux 2 Pro | `flux-2-pro` | لكل صورة: $0.04 | Anonymized |
...
| ElevenLabs Music | `elevenlabs-music` | 60 ث: $0.87، 120 ث: $1.73، 180 ث: $2.59، 240 ث: $3.45، 300 ث: $4.32، 360 ث: $5.18، 420 ث: $6.04، 480 ث: $6.90، 540 ث: $7.77، 600 ث: $8.63 | Anonymized |
...
|---|---|---|---|---|
| Grok Imagine | `grok-imagine-text-to-video` | Text to Video | متغيّر | Anonymized |
| Grok Imagine | `grok-imagine-image-to-video` | Image to Video | متغيّر | Anonymized |
...
| Grok Imagine R2V (Beta) | `grok-imagine-reference-to-video` | Text to Video | متغيّر | Anonymized |
...
<CardGroup cols={3}>
  ...
  <Card title="عملة مشفّرة" icon="bitcoin" href="https://venice.ai/settings/api">
    اشترِ أرصدة API بالعملة المشفّرة. نفس الأسعار كـ USD.
  </Card>
  <Card title="مراهنة DIEM" icon="coins" href="https://venice.ai/token">
