---
title: تسعير Venice API
description: "تسعير Venice API لنماذج النص والصورة والفيديو والصوت والموسيقى، بما في ذلك الأسعار لكل رمز، ولكل توليد، ولكل ثانية بالدولار الأمريكي وVVV وDIEM."
...
| ↳ >272K Context | | $0.50 | $2.25 | $0.05 | $0.63 | | |
...
| ↳ >272K Context | | $10.00 | $37.50 | $1.00 | $12.50 | | |
...
| ↳ >272K Context | | $5.00 | $22.50 | $0.50 | $6.25 | | |
...
*الأسعار لكل مليون رمز. [عرض كل النماذج ←](/ar/models/text)*
...
| Hunyuan Image 3.0 | `hunyuan-image-v3` | لكل صورة: $0.09 | Private |
...
| Krea v2 Large | `krea-v2-large` | لكل صورة: $0.07 | Anonymized |
...
| Krea v2 Medium | `krea-v2-medium` | لكل صورة: $0.04 | Anonymized |
...
| Muse Image | `muse-image` | لكل صورة: $0.02 | Anonymized |
...
| النموذج | المعرّف | لكل تحرير | صورة إدخال إضافية |
|---|---|---|---|
...
> **التحرير بصور إدخال متعددة:** يشمل سعر **لكل تحرير** أول صورة إدخال. النماذج التي تُدرج سعر **صورة إدخال إضافية** تتقاضى ذلك الرسم عن كل صورة إدخال إضافية بعد الأولى. مثال: التحرير بثلاث صور إدخال على نموذج بسعر $0.11 لكل تحرير مع رسم صورة إضافية $0.0035 يكلف $0.11 + 2 × $0.0035 = $0.117.
...
#### توليد الأغاني (حسب المدة)

| النموذج | المعرّف | التسعير حسب المدة | الخصوصية |
|---|---|---|---|
...
<Info>
للحصول على تسعير دقيق قبل التوليد، استخدم [واجهة Audio Quote API](/ar/api-reference/endpoint/audio/quote). النماذج القائمة على المدة لها مستويات أسعار ثابتة، بينما تحتسب النماذج القائمة على الثانية السعر بناءً على طول الإخراج.
</Info>
...
يختلف تسعير الفيديو حسب الدقّة والمدة. تفضّل بزيارة [صفحة نماذج الفيديو](/ar/models/video) للحصول على عروض أسعار دقيقة، أو استخدم [واجهة Video Quote API](/ar/api-reference/endpoint/video/quote).

| النموذج | المعرّف | النوع | التسعير | الخصوصية |
|---|---|---|---|---|
| Flux 3 | `flux-3-text-to-video` | Text to Video | متغيّر | Anonymized |
| Flux 3 | `flux-3-image-to-video` | Image to Video | متغيّر | Anonymized |
| Flux 3 First Last Frame | `flux-3-first-last-frame-to-video` | Text to Video | متغيّر | Anonymized |
...
| Gemini Omni Flash 1.1 | `gemini-omni-flash-1-1-text-to-video` | Text to Video | متغيّر | Anonymized |
| Gemini Omni Flash 1.1 | `gemini-omni-flash-1-1-image-to-video` | Image to Video | متغيّر | Anonymized |
| Gemini Omni Flash 1.1 Edit | `gemini-omni-flash-1-1-video-to-video` | Text to Video | متغيّر | Anonymized |
| Gemini Omni Flash 1.1 R2V | `gemini-omni-flash-1-1-reference-to-video` | Text to Video | متغيّر | Anonymized |
| Gemini Omni Flash R2V | `gemini-omni-flash-reference-to-video` | Text to Video | متغيّر | Anonymized |
| Grok Imagine | `grok-imagine-text-to-video-private` | Text to Video | متغيّر | Private |
| Grok Imagine | `grok-imagine-image-to-video-private` | Image to Video | متغيّر | Private |
| Grok Imagine | `grok-imagine-video-to-video-private` | Text to Video | متغيّر | Private |
| Grok Imagine 1.5 | `grok-imagine-1-5-text-to-video-private` | Text to Video | متغيّر | Private |
| Grok Imagine 1.5 | `grok-imagine-1-5-image-to-video-private` | Image to Video | متغيّر | Private |
| Grok Imagine 1.5 R2V | `grok-imagine-1-5-reference-to-video-private` | Text to Video | متغيّر | Private |
| Grok Imagine R2V | `grok-imagine-reference-to-video-private` | Text to Video | متغيّر | Private |
...
| Kling O3 Pro R2V | `kling-o3-pro-reference-to-video` | Text to Video | متغيّر | Anonymized |
...
| Kling O3 Standard R2V | `kling-o3-standard-reference-to-video` | Text to Video | متغيّر | Anonymized |
...
| LTX Video 2.5 Fast | `ltx-2-5-fast-image-to-video` | Image to Video | متغيّر | Anonymized |
| LTX Video 2.5 Fast | `ltx-2-5-fast-text-to-video` | Text to Video | متغيّر | Anonymized |
| LTX Video 2.5 Pro | `ltx-2-5-pro-image-to-video` | Image to Video | متغيّر | Anonymized |
| LTX Video 2.5 Pro | `ltx-2-5-pro-text-to-video` | Text to Video | متغيّر | Anonymized |
| MiniMax H3 | `minimax-h3-text-to-video` | Text to Video | متغيّر | Anonymized |
| MiniMax H3 | `minimax-h3-image-to-video` | Image to Video | متغيّر | Anonymized |
| MiniMax H3 Enhanced | `minimax-h3-enhanced-text-to-video` | Text to Video | متغيّر | Anonymized |
| MiniMax H3 Max | `minimax-h3-max-text-to-video` | Text to Video | متغيّر | Private |
| MiniMax H3 Max | `minimax-h3-max-image-to-video` | Image to Video | متغيّر | Private |
| MiniMax H3 Max Multi-Angle | `minimax-h3-max-multi-angle` | Text to Video | متغيّر | Private |
| MiniMax H3 Max R2V | `minimax-h3-max-reference-to-video` | Text to Video | متغيّر | Private |
| MiniMax H3 Max Turbo | `minimax-h3-max-turbo-text-to-video` | Text to Video | متغيّر | Private |
| MiniMax H3 Max Turbo | `minimax-h3-max-turbo-image-to-video` | Image to Video | متغيّر | Private |
| MiniMax H3 R2V | `minimax-h3-reference-to-video` | Text to Video | متغيّر | Anonymized |
| MiniMax H3 R2V Enhanced | `minimax-h3-enhanced-reference-to-video` | Text to Video | متغيّر | Anonymized |
...
| Seedance 1.5 Pro | `seedance-1-5-pro-text-to-video-basic` | Text to Video | متغيّر | Anonymized |
| Seedance 1.5 Pro | `seedance-1-5-pro-image-to-video-basic` | Image to Video | متغيّر | Anonymized |
| Seedance 2.0 | `seedance-2-0-text-to-video-basic` | Text to Video | متغيّر | Anonymized |
| Seedance 2.0 | `seedance-2-0-image-to-video-basic` | Image to Video | متغيّر | Anonymized |
| Seedance 2.0 Fast | `seedance-2-0-fast-text-to-video-basic` | Text to Video | متغيّر | Anonymized |
| Seedance 2.0 Fast | `seedance-2-0-fast-image-to-video-basic` | Image to Video | متغيّر | Anonymized |
| Seedance 2.0 Fast R2V | `seedance-2-0-fast-reference-to-video-basic` | Text to Video | متغيّر | Anonymized |
| Seedance 2.0 Mini | `seedance-2-0-mini-text-to-video-basic` | Text to Video | متغيّر | Anonymized |
| Seedance 2.0 Mini | `seedance-2-0-mini-image-to-video-basic` | Image to Video | متغيّر | Anonymized |
| Seedance 2.0 Mini R2V | `seedance-2-0-mini-reference-to-video-basic` | Text to Video | متغيّر | Anonymized |
| Seedance 2.0 R2V | `seedance-2-0-reference-to-video-basic` | Text to Video | متغيّر | Anonymized |
| Seedance 2.5 | `seedance-2-5-text-to-video-basic` | Text to Video | متغيّر | Anonymized |
| Seedance 2.5 | `seedance-2-5-image-to-video-basic` | Image to Video | متغيّر | Anonymized |
| Seedance 2.5 R2V | `seedance-2-5-reference-to-video-basic` | Text to Video | متغيّر | Anonymized |
...
| Wan 2.2 Enhanced | `wan-2-2-enhanced-image-to-video` | Image to Video | متغيّر | Anonymized |
...
| Wan 2.7 Enhanced | `wan-2-7-enhanced-text-to-video` | Text to Video | متغيّر | Anonymized |
| Wan 2.7 Reference | `wan-2-7-reference-to-video` | Text to Video | متغيّر | Anonymized |
| Wan 3.0 | `wan-3-0-text-to-video` | Text to Video | متغيّر | Anonymized |
| Wan 3.0 | `wan-3-0-image-to-video` | Image to Video | متغيّر | Anonymized |
| Wan 3.0 Prime | `wan-3-0-prime-text-to-video` | Text to Video | متغيّر | Anonymized |
| Wan 3.0 Prime | `wan-3-0-prime-image-to-video` | Image to Video | متغيّر | Anonymized |
| Wan 3.0 Prime Pro | `wan-3-0-prime-pro-text-to-video` | Text to Video | متغيّر | Anonymized |
| Wan 3.0 Prime Pro | `wan-3-0-prime-pro-image-to-video` | Image to Video | متغيّر | Anonymized |
| Wan 3.0 Prime Pro Reference | `wan-3-0-prime-pro-reference-to-video` | Text to Video | متغيّر | Anonymized |
| Wan 3.0 Prime Reference | `wan-3-0-prime-reference-to-video` | Text to Video | متغيّر | Anonymized |
| Wan 3.0 Pro | `wan-3-0-pro-text-to-video` | Text to Video | متغيّر | Anonymized |
| Wan 3.0 Pro | `wan-3-0-pro-image-to-video` | Image to Video | متغيّر | Anonymized |
| Wan 3.0 Pro Reference | `wan-3-0-pro-reference-to-video` | Text to Video | متغيّر | Anonymized |
| Wan 3.0 Reference | `wan-3-0-reference-to-video` | Text to Video | متغيّر | Anonymized |
...
<CardGroup cols={3}>
  <Card title="USD" icon="credit-card" href="https://venice.ai/settings/api?utm_source=venice-api-documentation">
    اشترِ أرصدة Venice ببطاقة ائتمان. الأرصدة لا تنتهي صلاحيتها.
  </Card>
  <Card title="Crypto" icon="bitcoin" href="https://venice.ai/settings/api?utm_source=venice-api-documentation">
    اشترِ أرصدة Venice بالعملة المشفّرة. نفس الأسعار كـ USD.
  </Card>
  <Card title="Stake DIEM" icon="coins" href="https://venice.ai/token?utm_source=venice-api-documentation">
    كل Diem = $1 يوميًا من الأرصدة التي تتجدّد كل يوم. يتطلّب حساب Venice مع محفظة Base متصلة.
  </Card>
</CardGroup>

### مستخدمو Pro

Pro هو اشتراك مخصّص لتطبيق Venice على الويب والجوال. وهو لا يشمل أي استخدام مجاني أو غير محدود للـ API. تُحتسب جميع طلبات API لكل رمز، أو لكل صورة، أو لكل عملية توليد وفقًا للأسعار المذكورة في الجداول أعلاه، بغضّ النظر عن مستوى الاشتراك.

يحصل مشتركو Pro على **رصيد Venice لمرة واحدة بقيمة $10** عند الترقية. يُطبَّق هذا الرصيد على استخدام API كرصيد مُجمَّع: تُنفق مفاتيح API من الحساب المرتبط بالترتيب التالي **DIEM ← الأرصدة المُجمَّعة ← USD**، لذلك لا يُستخدم مبلغ الـ $10 إلا بعد استنفاد أي حصة DIEM مرصودة للحقبة الحالية. راجع [VVV و DIEM](/overview/vvv-diem) للاطّلاع على ترتيب الإنفاق الكامل، و[رصيد الفوترة](/api-reference/endpoint/billing/balance) لمعرفة أي عملة سيُخصم منها مفتاحك بعد ذلك.

### الفئة المجانية

لا توجد فئة مجانية للـ API ولا مفتاح تجربة مجاني. المفتاح المُنشأ حديثًا يُصادَق عليه، ولكن نقاط النهاية المدفوعة (إتمامات الدردشة، وتوليد الصور، والصوت، والفيديو، والتضمينات) تُعيد `402 INSUFFICIENT_BALANCE` إلى أن يمتلك الحساب رصيدًا قابلًا للإنفاق بـ DIEM، أو أرصدة مُجمَّعة، أو USD. موّل الحساب بـ USD أو بالعملة المشفّرة من [venice.ai/settings/api](https://venice.ai/settings/api?utm_source=venice-api-documentation)، أو ارصد DIEM للحصول على حصة يومية متجدّدة.
