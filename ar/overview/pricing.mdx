...
description: "أسعار Venice API لكل مليون رمز لنماذج النص والصورة والفيديو والصوت والتضمين (embedding)، بالإضافة إلى تكاليف الاعتمادات للبحث على الويب واستدعاءات RPC وخدمات أخرى."
