...
<Note>
الحصّة اليومية المجانية من الطلبات على [venice.ai](https://venice.ai) هي ميزة في تطبيق الويب الموجَّه للمستهلك وليست في API. تُخصم طلبات API دائمًا من رصيدك المموَّل.
</Note>

### استخدام مفاتيح Venice مع مزوّدين آخرين

تعمل مفاتيح Venice API فقط مع `https://api.venice.ai/api/v1`. وهي ليست قابلة للتبادل مع مفاتيح OpenRouter أو OpenAI أو Anthropic أو غيرهم من المزوّدين، كما أن مفاتيح هؤلاء المزوّدين لن تنجح في المصادقة مع Venice. لاستخدام نماذج Venice، أنشئ مفتاحًا من [venice.ai/settings/api](https://venice.ai/settings/api) ووجِّه عميلك إلى عنوان Venice الأساسي.
