...
description: "حوّل ملف PDF إلى سجلات مُنمّطة عبر /augment/text-parser في Venice API مع فرض مخطط JSON، وارجع إلى نموذج رؤية عند غياب النصّ القابل للاستخراج من المسح الضوئي."
