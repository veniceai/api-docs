...
description: "ادمج Venice Web Search وWeb Scrape ونماذج إكمال الدردشة في سكربت Python يجيب عن سؤال بموجز يرتبط فيه كل ادعاء بمصدره عبر /augment/search و/augment/scrape."
...
- دع النموذج يخطّط لعدة استعلامات قبل البحث، كما يفعل عرض [وكيل البحث الخاص](/learn/private-research-agent).
