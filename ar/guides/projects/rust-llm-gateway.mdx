...
description: "دليل عملي لبناء بوابة LLM بلغة Rust متوافقة مع OpenAI عبر Venice باستخدام Axum و Postgres و SQLx مع استجابات البث ومحددات المعدل و OpenTelemetry."
