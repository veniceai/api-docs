...
description: "ابنِ وكيلًا يستخدم استدعاء الدوال عبر Venice API: امنح النموذج ثلاث أدوات للقراءة فقط ودعه يستكشف قاعدة بيانات SQLite لم يرَها من قبل باستدعاءات متوازية."
