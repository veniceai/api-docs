...
description: "استدعِ نماذج التفكير المنطقي في Venice التي تكشف tokens سلسلة التفكير، وتتحكم في جهد التفكير، وتُظهر إجابات خطوة بخطوة في chat completions."
...
اطلع على القائمة الكاملة للنماذج والأسعار وحدود السياق في [صفحة النماذج](/overview/models). لا تدعم جميع نماذج التفكير المنطقي معامل [`reasoning_effort`](#جهد-التفكير-المنطقي). انظر [دعم النموذج](#دعم-النموذج) للتفاصيل.
...
للحصول على المزيد من المخرجات المرئية، ارفع الحد، أو خفّض `reasoning_effort`، أو [عطّل التفكير المنطقي](#تعطيل-التفكير-المنطقي).
