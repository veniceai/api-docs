...
description: "دع نماذج المحادثة في Venice تستدعي أدواتك عبر استدعاء الدوال المتوافق مع OpenAI: عرّف مصفوفة tools، ونفّذ الاستدعاءات، وأعد النتائج للنموذج."
...
يتوقّف المثال أعلاه بعد جولة واحدة ذهابًا وإيابًا. أما الوكلاء الحقيقيون فيواصلون العمل، لأن النموذج عادةً ما يحتاج إلى عدة أدوات قبل أن يتمكّن من الإجابة. يمرّ دليل [بناء وكيل يستخدم الأدوات عبر استدعاء الدوال](/guides/features/tool-using-agent) بالحلقة كاملةً في مواجهة قاعدة بيانات لم يرَها النموذج من قبل، بما في ذلك استدعاءات الأدوات المتوازية، وإعادة الأخطاء التي يتعافى منها النموذج، والفرق بين نموذج يرفض من تلقاء نفسه وحماية لا يستطيع تجاوزها.
...
- [بناء وكيل يستخدم الأدوات عبر استدعاء الدوال](/guides/features/tool-using-agent)
