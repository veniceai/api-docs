...
تستخدم Venice واجهة Chat Completions لإنشاء النصوص، ولا توفر حاليًا واجهة Responses API الخاصة بـ OpenAI. تستخدم الردود المنظمة `response_format` على `POST /chat/completions`.
