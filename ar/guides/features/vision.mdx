...
`content` هو مصفوفة من الكتل، لذا يمكن لرسالة مستخدم واحدة أن تتضمن عدة كتل `image_url` إلى جانب النص. استخدم ذلك لمقارنة الصور أو لطرح أسئلة تمتد عبر أكثر من صورة واحدة:
...
تستهلك كل صورة رموز سياق. إذا أعاد طلب يحتوي على عدة صور الخطأ `TOO_MANY_TOKENS` (HTTP 400)، فقلّل عدد الصور، أو اختصر تعليماتك، أو انتقل إلى نموذج بنافذة سياق أكبر.
