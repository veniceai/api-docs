...
<Info>
للحصول على نظرة عامة حول أوضاع الخصوصية والمساعدة في الاختيار بين TEE وE2EE، راجع [الخصوصية](/overview/privacy). يغطي هذا الدليل تفاصيل البروتوكول والتنفيذ.
</Info>

<Note>
تتوفر TEE وE2EE حاليًا لنماذج النص فقط.
</Note>
...
<CodeGroup>
```bash cURL
# توليد nonce عشوائي بحجم 32 بايت (يمنع هجمات إعادة التشغيل)
