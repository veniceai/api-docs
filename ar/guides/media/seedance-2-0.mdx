...
description: "أنشئ وحرّر ومدّد والصِق مقاطع الفيديو مع Seedance 2.0 و 2.5 على Venice - تدفقات النص/الصورة/المرجع، وسلوك واجهة faces-off، وحدود الوسائط المتعددة حسب العائلة."
'og:title': "دليل Seedance 2.0 و 2.5 | وثائق Venice API"
'og:description': "ولِّد وحرِّر ومدِّد وادمج مقاطع الفيديو باستخدام Seedance 2.0 و 2.5 عبر Venice API. أنماط سير العمل وfaces-off والحدود والتسعير والأمثلة."
---
...
<Warning>
**الوجوه غير مدعومة على واجهة Seedance العامة.** لا تشغّل Venice تجهيز أصول الوجه ولا إثبات موافقة الوجه (`consents.seedance` / `needs_consent`) لنماذج Seedance العامة. قد تُرفض المدخلات التي تحتوي على وجوه في المنبع كخطأ سياسة محتوى / مزوّد. لتوليد likeness / أصول الوجه استخدم تطبيق Venice أو Studio.
</Warning>
