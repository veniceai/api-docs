---
title: "Seedance 2.0"
description: "Seedance 2.0 — نموذج Venice متعدد الوسائط الرائد للفيديو. النص / الصورة / المرجع إلى فيديو على نقطة نهاية واحدة، مع أربعة سير عمل (Reference، Edit، Extend، Stitch) يُستنتج من شكل التعليمة."
