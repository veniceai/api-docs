...
<Tip>
هل تريد سرد نص أطول من بضع جمل؟ يغطي دليل [سرد المقالات باستخدام تحويل النص إلى كلام](/guides/media/article-narration) حدَّ الإدخال البالغ 4096 حرفًا، وتقسيم النص على حدود الجمل، ودمج الأجزاء في ملف صوتي واحد، والبثّ للتشغيل التفاعلي.
</Tip>

- [واجهة برمجة تطبيقات الكلام الصوتي](/api-reference/endpoint/audio/speech)
- [نماذج تحويل النص إلى كلام](/models/text-to-speech)
- [سرد المقالات باستخدام تحويل النص إلى كلام](/guides/media/article-narration)
