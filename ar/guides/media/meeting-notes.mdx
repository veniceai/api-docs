...
description: "حوّل تسجيلًا صوتيًا إلى قرارات ومهام إجرائية تعود بروابط إلى اللحظة التي اتُّفق فيها عليها، باستخدام نقطة نهاية /audio/transcriptions في Venice API."
