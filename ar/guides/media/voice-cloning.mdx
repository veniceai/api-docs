...
<Note>
معرّفات الصوت مرتبطة بنموذج محدد. يجب استخدام المعرّف الذي أُنشئ باستخدام `tts-chatterbox-hd` مع `tts-chatterbox-hd` فقط. استنساخ الصوت هو تحويل نصٍ إلى كلام من عيّنة مرجعية. لإعادة تسجيل تسجيل موجود بصوتٍ آخر، استخدم واجهة برمجة تطبيقات [تغيير الصوت](/ar/guides/media/voice-changer) بدلًا من ذلك.
</Note>
