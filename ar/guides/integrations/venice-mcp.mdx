...
description: "يكشف خادم Venice Model Context Protocol الرسمي 30 أداة Venice للدردشة والصور والفيديو والصوت والموسيقى والشخصيات في أي مضيف MCP."
...
[خادم Venice MCP](https://github.com/veniceai/venice-mcp-server) هو خادم [Model Context Protocol](https://modelcontextprotocol.io/) الرسمي لـ Venice. يكشف Venice API بالكامل (الدردشة، الصور، الفيديو، الصوت، الموسيقى، embeddings، web augment، والشخصيات) كـ **30 أداة** يمكن لأي وكيل متوافق مع MCP استدعاؤها.
...
<CardGroup cols={3}>
  <Card title="30 أداة" icon="toolbox">
...
**30 أداة** تغطي كل صيغ Venice، و**3 موارد** (`venice://models`, `venice://styles`, `venice://voices`)، و**3 قوالب prompt**.
