...
description: "يكشف خادم Venice Model Context Protocol الرسمي 31 أداة Venice للدردشة والصور والفيديو والصوت والموسيقى والشخصيات في أي مضيف MCP مثل Claude Desktop وCursor."
...
<Steps>
  <Step title="احصل على مفتاح Venice API">
    أنشئ واحدًا من [venice.ai/settings/api](https://venice.ai/settings/api?utm_source=venice-api-documentation). انظر [دليل مفتاح API](/guides/getting-started/generating-api-key) للحصول على تعليمات خطوة بخطوة.
  </Step>
...
| `VENICE_SIWX_TOKEN` | _(لا شيء)_ | رمز مصادقة وضع محفظة x402. انظر [x402 أدناه](#وضع-محفظة-x402). |
