...
description: "شغّل Venice من Claude Code أو Cursor عبر أداة محسّنة لـ Venice لإنشاء فيديوهات متسقة الشخصيات، وقصص مصورة، ومقاطع دعائية، وسرد طويل."
...
|---|---|---|
| لقطات الشخصيات (1-2 شخصية) | `seedance-2-0-reference-to-video-basic` | R2V افتراضي مع `reference_image_urls` مسطّحة، ووسوم `@Image`، حتى 15 ثانية، وصوت ستيريو أصلي |
...
| تأسيسي / مزاجي / حركة | `seedance-2-0-image-to-video-basic` | بدون شخصيات؛ جودة سينمائية ملحمية، حتى 15 ثانية |
