...
description: "شغّل Venice من Claude Code أو Cursor عبر مجموعة أدوات Venice Video Harness لإنشاء مقاطع فيديو متسقة الشخصيات وقصص مصورة وسرد قصصي."
...
<CardGroup cols={3}>
  ...
  <Card title="مفتاح Venice API" icon="key" href="/guides/getting-started/generating-api-key">
    من [venice.ai/settings/api](https://venice.ai/settings/api?utm_source=venice-api-documentation)
  </Card>
</CardGroup>
