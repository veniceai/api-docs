---
title: Claude Code
description: "اضبط Claude Code CLI لتوجيه طلبات Anthropic Claude Opus وSonnet عبر Venice للحصول على استدلال خاص قائم على الاستخدام لوكيل البرمجة."
"og:title": "Claude Code مع Venice | Venice API Docs"
"og:description": "إعداد Claude Code لاستخدام Claude Opus 4.5/4.6/4.7/4.8 و Sonnet 4.5/4.6/4.7/4.8 و Fable 5 عبر Venice AI"
---

[Claude Code](https://docs.anthropic.com/en/docs/claude-code) هو أداة CLI من Anthropic للبرمجة الوكيلية. يوضح هذا الدليل كيفية تشغيله عبر Venice AI للحصول على وصول مدفوع لكل token إلى Claude Opus 4.5/4.6/4.7/4.8 و Sonnet 4.5/4.6/4.7/4.8 و Fable 5.
...
<CardGroup cols={3}>
  ...
  <Card title="نماذج Claude" icon="microchip">
    الوصول إلى Opus 4.5/4.6/4.7/4.8 و Sonnet 4.5/4.6/4.7/4.8 و Fable 5 عبر Venice
  </Card>
...
<Steps>
  ...
  <Step title="احصل على مفتاح API الخاص بك">
    ولِّد مفتاحًا من [venice.ai/settings/api](https://venice.ai/settings/api?utm_source=venice-api-documentation). ستلصقه مباشرة في ملف التكوين في الخطوة التالية.
  </Step>
...
| Claude Opus 4.7 | `claude-opus-4-7` | استدلال معقد، إعادة هيكلة كبيرة |
| Claude Opus 4.7 Fast | `claude-opus-4-7-fast` | استدلال معقد بزمن استجابة أقل |
| Claude Opus 4.8 | `claude-opus-4-8` | استدلال معقد، إعادة هيكلة كبيرة |
| Claude Opus 4.8 Fast | `claude-opus-4-8-fast` | استدلال معقد بزمن استجابة أقل |
| Claude Fable 5 | `claude-fable-5` | المهام المعقدة التي تتطلب أعلى ذكاء |
