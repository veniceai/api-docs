---
title: "LangChain"
description: "ادمج نماذج Venice في LangChain للسلاسل والوكلاء واستخدام الأدوات وخطوط أنابيب RAG عبر عميل ChatOpenAI المتوافق مع OpenAI وSDKs بايثون أو JS."
...
تُضمِّن Venice النص فقط. يستخدم `OpenAIEmbeddings` في LangChain القيمة الافتراضية `check_embedding_ctx_length=True`، والتي تقوم بالتقسيم إلى tokens باستخدام tiktoken وقد ترسل مصفوفات من الـ tokens الصحيحة. ترفض Venice هذه المصفوفات بـ HTTP 400، لذا اضبط `check_embedding_ctx_length=False`.
...
embeddings = OpenAIEmbeddings(
    ...
    api_key="your-venice-api-key",
    base_url="https://api.venice.ai/api/v1",
    check_embedding_ctx_length=False,  # مطلوب: أرسل نصًا، وليس معرّفات tokens
)
...
| التفكير المعقد | `z-ai-glm-5-3-flash` | نموذج استدلال خاص وسريع |
| استدعاء الدوال | `z-ai-glm-5-3-flash` | استخدام موثوق للأدوات |
