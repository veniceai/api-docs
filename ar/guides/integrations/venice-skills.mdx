---
title: Venice Skills
description: "مهارات وكلاء Venice الرسمية تُحمّل معرفة endpoints إلى Claude Code وCursor وCodex وOpenCode وHermes وCline حتى تستدعي وكلاء البرمجة Venice بشكل صحيح."
