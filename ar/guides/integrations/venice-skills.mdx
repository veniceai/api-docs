...
[Venice Skills](https://github.com/veniceai/skills) هي المجموعة الرسمية من [Agent Skills](https://www.anthropic.com/news/agent-skills) لـ Venice API. كل مهارة عبارة عن مجلد مستقل بذاته يحتوي على `SKILL.md` يقوم وكيل LLM بتحميله عند الطلب للعمل بشكل صحيح مع منطقة معينة من سطح API.
