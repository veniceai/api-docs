---
title: NanoClaw
description: "انشر NanoClaw، مساعد ذكاء اصطناعي شخصي خفيف لـ WhatsApp وTelegram، على Venice API للحصول على دردشة وتوليد وسائط خاصة وغير مُقيَّدة بالدفع لكل توكن دون اشتراك."
...
[Venice](https://venice.ai/?utm_source=venice-api-documentation) منصة ذكاء اصطناعي تضع الخصوصية أولًا. وهم [لا يخزّنون أو يسجّلون أي طلبات أو ردود](https://venice.ai/privacy?utm_source=venice-api-documentation) على خوادمهم — محادثاتك موجودة فقط على جهازك. تُشفَّر الطلبات من طرف إلى طرف عبر وكيلهم إلى مزوّدي GPU اللامركزيين، مع عدم الاحتفاظ بأي بيانات. هذا يعني أن محادثات مساعد الذكاء الاصطناعي الخاص بك تبقى خاصة، حتى من Venice أنفسهم.
...
| **التسعير** | الدفع لكل توكن، بدون اشتراك. أو ضع [DIEM](https://venice.ai/lp/diem?utm_source=venice-api-documentation) للحصول على رصيد يتجدد يوميًا | اشتراكات بقيمة 20-200 دولار/شهر أو API بالدفع لكل توكن |
...
<CardGroup cols={2}>
  ...
  <Card title="مفتاح Venice API" icon="key" href="https://venice.ai/settings/api?utm_source=venice-api-documentation">
