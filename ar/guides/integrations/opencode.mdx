---
title: OpenCode
description: "اربط OpenCode بـ Venice API عبر مزوّد مخصص متوافق مع OpenAI في opencode.json ليعمل وكيل البرمجة في الطرفية على نماذج Venice الخاصة بمفتاح VENICE_API_KEY."
...
إذا قمت بتعيين `"model": "venice/z-ai-glm-5-3-flash"` كما هو موضح أعلاه، يجب أن يستخدم OpenCode نموذج Venice هذا افتراضيًا. يمكنك تغيير الافتراضي باستبدال `z-ai-glm-5-3-flash` بأي معرّف نموذج من [كتالوج النماذج النصية](/models/text) وإضافته إلى خريطة `models`.
