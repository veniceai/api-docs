...
description: "Pay for Venice inference from a wallet with no API key via x402, in USDC per request, and cap what the agent can spend with a budget it enforces."
