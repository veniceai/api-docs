...
description: "Build an OpenAI-compatible Rust LLM gateway on Venice with Axum, Postgres, SQLx, streaming responses, rate limits, and OpenTelemetry spans."
