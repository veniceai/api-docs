...
description: "Build a Python security agent on Venice that finds atomic vulnerabilities and chains them into exploit paths using an AST repo map and Pydantic."
...
- Python 3.12+
- A Venice API key from [venice.ai](https://venice.ai/?utm_source=venice-api-documentation)
