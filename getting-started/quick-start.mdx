---
title: "Quickstart"
description: "Generate a Venice API key, install the OpenAI-compatible SDK, and send your first chat completion request to api.venice.ai in minutes."
...
<Steps>
  <Step title="Get your API key">
    Head to your [Venice API Settings](https://venice.ai/settings/api?utm_source=venice-api-documentation) and generate a new API key.
