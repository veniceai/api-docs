---
title: "Text Models"
description: "Venice chat, reasoning, and code models including Claude, GLM, and Qwen, with context lengths, per-token pricing, privacy tiers, and traits."
...
Use the `id` value as the `model` parameter in API requests. 123 models currently available.
