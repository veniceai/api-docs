...
description: "Every model on the Venice API across text, image, video, audio, and embeddings, with pricing, context lengths, privacy tiers, and capabilities."
...
Use the `id` value as the `model` parameter in API requests. 363 models currently available.
...
| GPT Image 2.5 Flare | `gpt-image-2-5-flare-edit` | $0.08 / extra image $0.0097 | Anonymized |
| GPT Image 2.5 Sunburst | `gpt-image-2-5-sunburst-edit` | $0.08 / extra image $0.0097 | Anonymized |
...
| Qwen Image 3 | `qwen-image-3-edit` | $0.04 / extra image $0.0035 | Anonymized |
| Qwen Image 3 Pro | `qwen-image-3-pro-edit` | $0.05 / extra image $0.0035 | Anonymized |
...
| Gemini Omni Flash 1.1 | `gemini-omni-flash-1-1-text-to-video` | Text to Video | Variable — use Video Quote API | Anonymized |
| Gemini Omni Flash 1.1 | `gemini-omni-flash-1-1-image-to-video` | Image to Video | Variable — use Video Quote API | Anonymized |
| Gemini Omni Flash 1.1 Edit | `gemini-omni-flash-1-1-video-to-video` | Text to Video | Variable — use Video Quote API | Anonymized |
| Gemini Omni Flash 1.1 R2V | `gemini-omni-flash-1-1-reference-to-video` | Text to Video | Variable — use Video Quote API | Anonymized |
...
| MiniMax H3 Max | `minimax-h3-max-text-to-video` | Text to Video | Variable — use Video Quote API | Private |
| MiniMax H3 Max | `minimax-h3-max-image-to-video` | Image to Video | Variable — use Video Quote API | Private |
| MiniMax H3 Max Multi-Angle | `minimax-h3-max-multi-angle` | Text to Video | Variable — use Video Quote API | Private |
| MiniMax H3 Max R2V | `minimax-h3-max-reference-to-video` | Text to Video | Variable — use Video Quote API | Private |
| MiniMax H3 Max Turbo | `minimax-h3-max-turbo-text-to-video` | Text to Video | Variable — use Video Quote API | Private |
| MiniMax H3 Max Turbo | `minimax-h3-max-turbo-image-to-video` | Image to Video | Variable — use Video Quote API | Private |
...
| Wan 3.0 Prime Pro | `wan-3-0-prime-pro-text-to-video` | Text to Video | Variable — use Video Quote API | Anonymized |
| Wan 3.0 Prime Pro | `wan-3-0-prime-pro-image-to-video` | Image to Video | Variable — use Video Quote API | Anonymized |
| Wan 3.0 Prime Pro Reference | `wan-3-0-prime-pro-reference-to-video` | Text to Video | Variable — use Video Quote API | Anonymized |
| Wan 3.0 Prime Reference | `wan-3-0-prime-reference-to-video` | Text to Video | Variable — use Video Quote API | Anonymized |
| Wan 3.0 Pro | `wan-3-0-pro-text-to-video` | Text to Video | Variable — use Video Quote API | Anonymized |
| Wan 3.0 Pro | `wan-3-0-pro-image-to-video` | Image to Video | Variable — use Video Quote API | Anonymized |
| Wan 3.0 Pro Reference | `wan-3-0-pro-reference-to-video` | Text to Video | Variable — use Video Quote API | Anonymized |
...
| ElevenLabs Music v2 | `elevenlabs-music-v2` | Duration-tiered — use Audio Quote API | Anonymized |
| ElevenLabs Music v2.5 | `elevenlabs-music-v2-5` | Duration-tiered — use Audio Quote API | Anonymized |
