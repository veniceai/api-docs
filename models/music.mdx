...
- **Duration-based:** Price scales with duration tier. ElevenLabs Music accepts any duration from 60–240 seconds, priced by tier (1–60s, 61–120s, 121–180s, 181–240s). ACE-Step 1.5 uses fixed duration options.
