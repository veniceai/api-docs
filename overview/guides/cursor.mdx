...
<Info>
Non-Claude models (e.g. `minimax-m25`, `kimi-k2-5`, `gpt-4o`) are **not affected** and work without the prefix. The `venice-` prefix is safe to use on any model since Venice always strips it, but it is only required for Claude models in Cursor.
</Info>
