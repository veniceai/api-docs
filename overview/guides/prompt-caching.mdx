...
| Provider | Min Tokens | Cache Lifetime | Write Cost | Read Discount | Explicit Markers |
|----------|------------|----------------|------------|---------------|------------------|
| Claude Opus 4.5 | ~4,000 | 5 min | +25% | 90% | Required |
| GPT-5.2 | 1,024 | 5-10 min | None | 90% | Not needed |
| Gemini | ~1,024 | 1 hour | None | 75-90% | Not needed |
| Grok | ~1,024 | 5 min | None | 75-88% | Not needed |
| DeepSeek | ~1,024 | 5 min | None | 50% | Not needed |
| MiniMax | ~1,024 | 5 min | None | 90% | Not needed |
| Kimi | ~1,024 | 5 min | None | 50% | Not needed |
