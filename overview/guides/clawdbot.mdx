...
During onboarding, OpenClaw shows all available Venice models. Some suggestions:

| Use case | Model | Privacy |
|---|---|---|
| General chat | `venice/llama-3.3-70b` | Private |
...
- **Private** models (Llama, Qwen, DeepSeek, Venice Uncensored) run entirely on Venice's infrastructure. Prompts are never stored or logged.
