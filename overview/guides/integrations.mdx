...
* Agents
  ...
  * [Molt Bot](https://docs.molt.bot/providers/venice) Discord bot with Venice API integration. See our [AI Agents guide](/overview/guides/ai-agents#molt-bot-instructions) for setup instructions.
