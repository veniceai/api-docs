...
See the full list of models, pricing and context limits on the [Models page](/overview/models).
...
Pass `disable_thinking` in `venice_parameters`, or use it as a [model suffix](/api-reference/endpoint/chat/model_feature_suffix).
