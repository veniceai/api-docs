...
| 429 | `queue`, `retrieve` | Rate limit exceeded or model at capacity | Retry with backoff |
...
5. Handle `404` as invalid, expired, or deleted media; handle `429/500` with retries/backoff
