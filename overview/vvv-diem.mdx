...
Use the token dashboard at [venice.ai/token](https://venice.ai/token?utm_source=venice-api-documentation). The dashboard lives in the Venice app and requires signing in with a connected Base wallet — do not send tokens directly to a contract address.
...
<CardGroup cols={2}>
  ...
  <Card title="Token dashboard" icon="chart-line" href="https://venice.ai/token?utm_source=venice-api-documentation">
    Stake VVV, mint DIEM, and stake DIEM for Venice credit. Requires signing in with a connected Base wallet.
  </Card>
