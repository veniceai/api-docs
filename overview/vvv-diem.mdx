---
title: VVV & DIEM
description: "Fund Venice API inference with staked DIEM tokens, worth $1 of compute per day each, minted by staking VVV on Base with a daily allowance."
...
| Token | Role |
| --- | --- |
| **[VVV](https://venice.ai/lp/vvv?utm_source=venice-api-documentation)** | Venice's foundational token on Base. Stake it to earn yield and to mint DIEM. |
| **sVVV** | Receipt for staked VVV. Lock sVVV at the current [Mint Rate](https://diem-calculator.venice.ai/) to mint DIEM. |
| **[DIEM](https://venice.ai/lp/diem?utm_source=venice-api-documentation)** | Tokenized compute unit. Stake DIEM to unlock a perpetual daily Venice credit equal to $1 per DIEM. |
...
Use the token dashboard at [venice.ai/token](https://venice.ai/token?utm_source=venice-api-documentation). The dashboard lives in the Venice app and requires a Venice account with a connected Base wallet — do not send tokens directly to a contract address.
...
<CardGroup cols={2}>
  ...
  <Card title="Token dashboard" icon="chart-line" href="https://venice.ai/token?utm_source=venice-api-documentation">
    Stake VVV, mint DIEM, and stake DIEM for Venice credit. Requires a Venice account with a connected Base wallet.
  </Card>
  ...
  <Card title="VVV & DIEM overview" icon="circle-info" href="https://venice.ai/lp/vvv?utm_source=venice-api-documentation">
    Public overview of Venice's token model and how DIEM becomes inference.
  </Card>
</CardGroup>
