---
title: "Deprecations"
description: "Venice model lifecycle policy with deprecation criteria, 7-15 day notice timelines, migration guidance, and the list of retired model IDs."
...
|---|---|---|---|
| GPT-5.2 Codex | `openai-gpt-52-codex` | Sep 16, 2026 | Retiring Soon |
| Mistral Small 4 | `mistral-small-2603` | Sep 18, 2026 | Retiring Soon |
| Sora 2 | `sora-2-image-to-video` | Sep 24, 2026 | Retiring Soon |
| Sora 2 | `sora-2-text-to-video` | Sep 24, 2026 | Retiring Soon |
| Sora 2 Pro | `sora-2-pro-image-to-video` | Sep 24, 2026 | Retiring Soon |
| Sora 2 Pro | `sora-2-pro-text-to-video` | Sep 24, 2026 | Retiring Soon |
| Wan 2.1 Pro | `wan-2.1-pro-image-to-video` | Sep 29, 2026 | Retiring Soon |
| Wan 2.2 A14B | `wan-2.2-a14b-text-to-video` | Sep 29, 2026 | Retiring Soon |
