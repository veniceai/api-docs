...
|------------------|-------------|------------|--------|--------|
| `qwen3-235b` | `qwen3-235b-a22b-thinking-2507` or `qwen3-235b-a22b-instruct-2507` | Dec 14, 2025 | Deprecated | Splitting into specialized models with improved pricing |
