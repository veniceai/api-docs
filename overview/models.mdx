...
|------------|----------|----------------|---------------|--------------|--------|
| Venice Uncensored 1.1 | `venice-uncensored` | `$0.20 / $0.90` | 32,768 | — | — |
| Venice Reasoning (D) | `qwen-2.5-qwq-32b` | `$0.50 / $2.00` | 32,768 | Reasoning | — |
...
| DeepSeek R1 671B (D) | `deepseek-r1-671b` | `$3.50 / $14.00` | 131,072 | Reasoning | default_reasoning |
