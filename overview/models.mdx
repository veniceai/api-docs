...
| [Venice Large 1.1 (D)](https://huggingface.co/Qwen/Qwen3-235B-A22B-Instruct-2507-FP8) | `qwen3-235b` | `$0.45 / $3.50` | 131,072 | Function Calling, Reasoning | default_code |
...
<Warning>
**Model Deprecation Notice**: `qwen3-235b` (Venice Large 1.1) is being deprecated and will be replaced with two specialized models on **December 14, 2025**:
- `qwen3-235b-a22b-thinking-2507` ($0.45 / $3.50) for reasoning tasks with thinking enabled
- `qwen3-235b-a22b-instruct-2507` ($0.15 / $0.75) for standard tasks without thinking

After December 14, `qwen3-235b` will automatically route to `qwen3-235b-a22b-thinking-2507` regardless of the `disable_thinking` parameter. To use the lower-cost non-thinking model, explicitly specify `qwen3-235b-a22b-instruct-2507`. [Learn more about deprecations](/overview/deprecations).
</Warning>
