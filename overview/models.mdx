...
|------------|----------|----------------|---------------|--------------|--------|
| Venice Uncensored 1.1 | `venice-uncensored` | `$0.50 / $2.00` | 32,768 | — | most_uncensored |
...
| Qwen Image | `qwen-image` | `$0.01` | Qwen Image | highest_quality |
| FLUX Standard (D) | `flux-dev` | `$0.01` | FLUX.1 Dev | — |
| FLUX Custom (D) | `flux-dev-uncensored` | `$0.01` | FLUX.1 Dev | — |
| Lustify SDXL | `lustify-sdxl` | `$0.01` | Lustify SDXL | most_uncensored |
