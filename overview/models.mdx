...
*Pricing is per 1M tokens (input / output). Additional usage-based pricing applies when using `enable_web_search` or `enable_web_scraping`. See [pricing details](/overview/pricing#web-search-and-scraping).*
