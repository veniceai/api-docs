...
| Venice Reasoning (D) | `qwen-2.5-qwq-32b` | `$0.50 / $2.00` | 32,768 | ✕ | ✔ | — |
...
| Llama 3.1 405B (D) | `llama-3.1-405b` | `$1.50 / $6.00` | 65,536 | ✕ | ✕ | most_intelligent |
| Dolphin 72B (D) | `dolphin-2.9.2-qwen2-72b` | `$0.70 / $2.80` | 32,768 | ✕ | ✕ | most_uncensored |
| Qwen 2.5 VL 72B (D) | `qwen-2.5-vl` | `$0.70 / $2.80` | 32,768 | ✕ | ✕ | — |
| Qwen 2.5 Coder 32B (D) | `qwen-2.5-coder-32b` | `$0.50 / $2.00` | 32,768 | ✕ | ✕ | default_code |
| DeepSeek R1 671B (D) | `deepseek-r1-671b` | `$3.50 / $14.00` | 131,072 | ✕ | ✔ | default_reasoning |
...
| Pony Realism (D) | `pony-realism` | `$0.01` | Pony Realism | most_uncensored |
