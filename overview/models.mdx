...
| [Venice Large 1.1 (D)](https://huggingface.co/Qwen/Qwen3-235B-A22B-Instruct-2507-FP8) | `qwen3-235b` | `$0.90 / $4.50` | 131,072 | Function Calling, Reasoning | — |
...
<Warning>
**Model Deprecation Notice**: `qwen3-235b` (Venice Large 1.1) will be deprecated on **December 11, 2025**. We recommend migrating to `zai-org-glm-4.6` (GLM 4.6) for similar capabilities with better pricing at $0.85 / $2.75. [Learn more about deprecations](/overview/deprecations).
</Warning>
