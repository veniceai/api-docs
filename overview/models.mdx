...
| Model Name | Model ID | Price (in/out) | Context Limit | Capabilities | Traits |
|------------|----------|----------------|---------------|--------------|--------|
| Grok 4.1 Fast | `grok-41-fast` | `$0.50 / $1.25` | 262,144 | Function Calling, Reasoning, Vision | — |
| [Gemini 3 Pro Preview](https://deepmind.google/models/gemini/pro/) | `gemini-3-pro-preview` | `$2.50 / $15.00` | 202,752 | Function Calling, Reasoning, Vision | — |
| [Kimi K2 Thinking](https://huggingface.co/moonshotai/Kimi-K2-Thinking) | `kimi-k2-thinking` | `$0.75 / $3.20` | 262,144 | Function Calling, Reasoning | — |
...
- **Reasoning**: Advanced logical reasoning capabilities with visible thinking process. See [Reasoning Models guide](/overview/guides/reasoning-models) for output formats.
