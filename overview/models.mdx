...
| [Venice Small](https://huggingface.co/Qwen/Qwen3-4B) | `qwen3-4b` | `$0.05 / $0.15` | 40,960 | Function Calling, Reasoning | — |
...
| [Llama 3.3 70B](https://huggingface.co/meta-llama/Llama-3.3-70B-Instruct) | `llama-3.3-70b` | `$0.70 / $2.80` | 65,536 | Function Calling | default, function_calling_default |
...
| [FLUX Standard (D)](https://huggingface.co/black-forest-labs/FLUX.1-dev) | `flux-dev` | `$0.01` | FLUX.1 Dev | highest_quality |
| [FLUX Custom (D)](https://huggingface.co/black-forest-labs/FLUX.1-dev) | `flux-dev-uncensored` | `$0.01` | FLUX.1 Dev | — |
