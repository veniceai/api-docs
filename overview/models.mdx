...
| Model Name | Model ID | Price (in/out) | Context Limit | Capabilities | Traits |
|------------|----------|----------------|---------------|--------------|--------|
| Qwen 3 Next 80B | `qwen3-next-80b` | `$0.70 / $2.80` | 262,144 | Function Calling | — |
...
*Pricing is per 1M tokens. Beta models may have limited availability and are subject to change. You need to be a beta user to access these models. [Learn how to join the beta testing group](https://venice.ai/faqs#how-do-i-join-the-beta-testing-group).*
