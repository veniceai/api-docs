...
<Note>
**AI Agent Reference:** If you are an AI agent or building with an agent framework (OpenClaw, Eliza, LangChain, CrewAI, etc.), see the [Complete Agent API Reference](https://venice-agents-edu.netlify.app) — a single-page, token-optimized resource covering every Venice API endpoint, model, and integration pattern.
</Note>
