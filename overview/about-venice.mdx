---
title: "Venice API"
description: "Private, unrestricted access to all the leading AI models across text, image, video, and audio. OpenAI-compatible, behind one API key."
...
<div className="venice-hero-copy">
  ...
  <p className="venice-hero-subtitle">Plus the tools to build with them: web search, document parsing, and MCP.</p>
...
<div className="venice-section-header">
  ...
  <p className="venice-section-subtitle">The same auth, error codes, and rate limit headers across all of them.</p>
</div>
