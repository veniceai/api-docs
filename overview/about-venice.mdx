---
title: "Venice API"
description: "Private, unrestricted access to OpenAI-compatible chat, image, audio, and video models behind one API key."
og:title: "Venice API Docs"
mode: "wide"
---

<div className="venice-hero-copy">
  <p className="venice-hero-tagline">The API for private, unrestricted intelligence.</p>
  <p className="venice-hero-subtitle">Chat, image, audio, and video. Keep the OpenAI SDK you already use and swap the base URL.</p>
