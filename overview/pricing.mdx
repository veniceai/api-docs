...
| Claude Opus 4.5 | `claude-opus-45` | $6.00 | $30.00 | $0.60 | $7.50 | 198K | Anonymized |
| Claude Sonnet 4.6 (Beta) | `claude-sonnet-4-6` | $3.75 | $18.75 | $0.38 | $4.69 | 1000K | Anonymized |
| ↳ >200K Context | | $6.00 | $25.00 | $0.60 | $7.50 | | |
| Claude Sonnet 4.5 (Beta) | `claude-sonnet-45` | $3.75 | $18.75 | $0.38 | $4.69 | 198K | Anonymized |
...
<CardGroup cols={3}>
  <Card title="USD" icon="credit-card" href="https://venice.ai/settings/api" horizontal>
    Buy API credits with credit card. Credits never expire.
  </Card>
  <Card title="Crypto" icon="bitcoin" href="https://venice.ai/settings/api" horizontal>
    Buy API credits with cryptocurrency. Same rates as USD.
  </Card>
  <Card title="Stake DIEM" icon="coins" href="https://venice.ai/token" horizontal>
