...
<CardGroup cols={3}>
  <Card title="USD" icon="credit-card" href="https://venice.ai/settings/api">
    Buy API credits with credit card or bank transfer. Credits never expire.
  </Card>
  <Card title="Crypto" icon="bitcoin" href="https://venice.ai/settings/api">
    Buy API credits with cryptocurrency. Same rates as USD.
  </Card>
  <Card title="Stake VVV" icon="coins" href="https://venice.ai/token">
    Earn 1 Diem per staked VVV. Each Diem = $1/day of credits that refresh daily.
  </Card>
</CardGroup>
