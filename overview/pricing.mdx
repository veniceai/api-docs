...
| ------------------------------------------------------------------------------------------------------------------------------------ | :-------------------: | :-------------------: | :--------------------: | :--------------------: |
| <div style={{whiteSpace: 'nowrap'}}>Venice Small (Qwen 3 4B)<br />Llama 3.2 3B<br />BGE 3 Embeddings</div>                                           | 1.5 VCU               | $0.15                 | 6 VCU                  | $0.60                  |
| <div style={{whiteSpace: 'nowrap'}}>Venice Medium (Mistral Small 3.1 24B)<br />Venice Uncensored<br />Qwen 2.5 Coder 32B<br />Qwen 2.5 QWQ 32B</div> | 5 VCU                 | $0.50                 | 20 VCU                 | $2.00                  |
