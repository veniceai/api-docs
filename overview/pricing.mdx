---
title: API Pricing
description: "Venice API pricing per million tokens for text, image, video, audio, and embedding models, plus Diem-based pricing for compute-billed endpoints."
