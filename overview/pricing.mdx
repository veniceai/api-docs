...
| Claude Sonnet 4.5 (Beta) | `claude-sonnet-4-5` | $3.75 | $18.75 | $0.38 | $4.69 | 198K | Anonymized |
| Claude Sonnet 4.6 (Beta) | `claude-sonnet-4-6` | $3.60 | $18.00 | $0.36 | $4.50 | 1000K | Anonymized |
| ↳ >200K Context | | $7.20 | $27.00 | $0.72 | $9.00 | | |
| DeepSeek V3.2 | `deepseek-v3.2` | $0.40 | $1.00 | $0.20 | - | 160K | Private |
| Gemini 3 Flash Preview | `gemini-3-flash-preview` | $0.70 | $3.75 | $0.07 | - | 256K | Anonymized |
| Gemini 3 Pro Preview | `gemini-3-pro-preview` | $2.50 | $15.00 | $0.63 | - | 198K | Anonymized |
| Gemini 3.1 Pro Preview (Beta) | `gemini-3-1-pro-preview` | $2.50 | $15.00 | $0.50 | $0.50 | 1000K | Anonymized |
...
| GLM 4.7 Flash (Beta) | `zai-org-glm-4.7-flash` | $0.13 | $0.50 | - | - | 128K | Private |
...
| GPT-5.2 Codex (Beta) | `openai-gpt-52-codex` | $2.19 | $17.50 | $0.22 | - | 256K | Anonymized |
| GPT-5.3 Codex (Beta) | `openai-gpt-53-codex` | $2.19 | $17.50 | $0.22 | - | 400K | Anonymized |
| Grok 4.1 Fast | `grok-41-fast` | $0.50 | $1.25 | $0.13 | - | 256K | Anonymized |
| Grok Code Fast 1 | `grok-code-fast-1` | $0.25 | $1.87 | $0.03 | - | 256K | Anonymized |
| Hermes 3 Llama 3.1 405b (Beta) | `hermes-3-llama-3.1-405b` | $1.10 | $3.00 | - | - | 128K | Private |
| Kimi K2 Thinking | `kimi-k2-thinking` | $0.75 | $3.20 | $0.38 | - | 256K | Private |
| Kimi K2.5 (Beta) | `kimi-k2-5` | $0.75 | $3.75 | $0.13 | - | 256K | Private |
| Llama 3.2 3B | `llama-3.2-3b` | $0.15 | $0.60 | - | - | 128K | Private |
| Llama 3.3 70B | `llama-3.3-70b` | $0.70 | $2.80 | - | - | 128K | Private |
| MiniMax M2.1 | `minimax-m21` | $0.40 | $1.60 | $0.04 | - | 198K | Private |
| MiniMax M2.5 | `minimax-m25` | $0.40 | $1.60 | $0.04 | - | 198K | Private |
| NVIDIA Nemotron 3 Nano 30B (Beta) | `nvidia-nemotron-3-nano-30b-a3b` | $0.07 | $0.30 | - | - | 128K | Private |
| OpenAI GPT OSS 120B (Beta) | `openai-gpt-oss-120b` | $0.07 | $0.30 | - | - | 128K | Private |
...
| Qwen 3 Next 80b (Beta) | `qwen3-next-80b` | $0.35 | $1.90 | - | - | 256K | Private |
| Qwen 3.5 35B A3B (Beta) | `qwen3-5-35b-a3b` | $0.31 | $2.50 | $0.06 | - | 256K | Private |
...
| Nano Banana 2 | `nano-banana-2` | 1K: $0.08, 2K: $0.16, 4K: $0.32 | Anonymized |
| Recraft V4 | `recraft-v4` | Per Image: $0.06 | Anonymized |
| ImagineArt 1.5 Pro | `imagineart-1.5-pro` | Per Image: $0.05 | Anonymized |
...
| Background Remover | `bria-bg-remover` | Per Image: $0.02 | Anonymized |
...
| Nano Banana 2 | `nano-banana-2-edit` | $0.08 |
...
| MMAudio V2 | `mmaudio-v2-text-to-audio` | $0.00092 | Anonymized |
...
<Info>
Web Scraping automatically detects up to 5 URLs per request, scrapes and converts content into structured markdown, and adds the extracted text into model context. Only successfully scraped URLs are billed. These charges apply in addition to standard model token pricing.
</Info>
