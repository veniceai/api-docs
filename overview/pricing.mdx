...
| Google Gemma 4 31B Instruct | `google-gemma-4-31b-it` | $0.13 | $0.36 | $0.09 | - | 256K | Private |
...
| NVIDIA Nemotron 3 Ultra 550B | `nvidia-nemotron-3-ultra-550b-a55b` | $0.63 | $3.13 | $0.19 | - | 256K | Private |
...
| Qwen Edit Uncensored | `qwen-edit-nsfw` | $0.04 |
