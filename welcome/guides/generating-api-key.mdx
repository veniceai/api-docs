...
<Steps>
  <Step title="Visit the API Settings Page">
    ...
    <Frame>
      <img src="/images/guides/api-keys/dashboard.png" alt="API Settings Page" />
    </Frame>
  </Step>
  ...
  <Step title="Click Generate New API Key">
    ...
    <Frame>
      <img src="/images/guides/api-keys/create-key.png" alt="Create Key Page" />
    </Frame>
  </Step>
  ...
  <Step title="Generate the key">
    ...
    <Frame>
      <img src="/images/guides/api-keys/result.png" alt="Create Key Page" />
    </Frame>
  </Step>
</Steps>
