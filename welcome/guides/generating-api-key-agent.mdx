...
<Steps>
  ...
  <Step title="Stake VVV with Venice">
    ...
    <Frame as="div">
      ![](/Screenshot2025-03-12at12.06.52PM.png)
    </Frame>
  ...
  <Step title="Generate API Key">
    ...
    You will need the following information to proceed, which is described further within the "[Generating API Key Guide](https://docs.venice.ai/welcome/guides/generating-api-key)" :
