...
description: "Genera imágenes a partir de prompts de texto con la API nativa de imagen de Venice o con el endpoint de imágenes compatible con OpenAI, con controles de estilo y salida binaria o en base64."
