...
description: "Genera imágenes a partir de prompts de texto con el endpoint /image/generate de Venice o la API compatible con OpenAI, con presets de estilo y salida base64."
