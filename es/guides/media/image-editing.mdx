...
description: "Edita, haz inpainting, compón entradas en capas y elimina fondos de imágenes usando las APIs síncronas de edición de imagen, multi-edit y eliminación de fondo de Venice."
