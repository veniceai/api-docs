...
description: "Genera vídeos a partir de prompts de texto o imágenes iniciales con la API de cola asíncrona de Venice — envía una tarea, consulta su estado y descarga el vídeo final."
