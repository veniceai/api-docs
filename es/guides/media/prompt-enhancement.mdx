...
description: "Reescribe automáticamente los prompts de generación y edición de imágenes con el parámetro enhance_prompt de Venice para mejorar la salida."
