...
description: "Reescribe prompts de imagen automáticamente con el parámetro enhance_prompt de Venice en /image/generate y /image/edit para resultados más detallados."
