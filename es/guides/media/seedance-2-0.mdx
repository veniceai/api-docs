...
description: "Genera, edita, extiende y une videos con Seedance 2.0 y 2.5 en Venice: flujos de trabajo de texto, imagen y referencia a video, política de medios de la API pública y límites multimodales específicos por familia."
...
`duration: "auto"` (o `"-1"`) y `aspect_ratio: "adaptive"` (o `"auto"`) hacen que la salida siga el clip de origen. Consulta [Relación de aspecto y duración coincidentes con el origen](#source-matched-aspect-ratio-and-duration).
