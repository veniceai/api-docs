...
Esta guía cubre las variantes, los cuatro flujos de trabajo, la **política de medios de la API pública**, los **límites multimodales específicos por familia**, los precios y ejemplos con `curl`.
