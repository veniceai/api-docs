...
Conecta clips de entrada con transiciones generadas por IA. Respeta los topes **específicos por familia** de duración combinada y número de clips en [Límites de entrada multimodal](#multimodal-input-limits) (Seedance 2.0: ≤3 clips / ≤15 s combinados; Seedance 2.5: topes de video más altos).
...
`omni_reference_task_type: "edit"` pre-guía la clasificación de BytePlus. `duration: "auto"` (o `"-1"`) y `aspect_ratio: "adaptive"` (o `"auto"`) hacen que la salida siga el clip de origen. Consulta [Relación de aspecto y duración coincidentes con el origen](#source-matched-aspect-ratio-and-duration) y [`omni_reference_task_type`](#omni_reference_task_type-seedance-25-r2v).
