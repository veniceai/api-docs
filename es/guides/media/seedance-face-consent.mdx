...
description: "Cuando una solicitud de Seedance 2.0 contiene un rostro humano, la API de Venice requiere una atestación de consentimiento única antes de procesar el contenido. Esta guía cubre el flujo de dos llamadas, el objeto de consentimiento y las respuestas."
