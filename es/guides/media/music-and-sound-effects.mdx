...
<Note>
Los modelos de cambiador de voz no se aceptan en estos endpoints. Convierte una grabación de origen con la API de [Voice Changer](/es/guides/media/voice-changer) en su lugar.
</Note>
