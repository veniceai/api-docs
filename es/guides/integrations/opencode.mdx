---
title: OpenCode
description: "Conecta OpenCode con Venice mediante un proveedor personalizado compatible con OpenAI para que tu agente de programación se ejecute sobre modelos privados de Venice con un único archivo de configuración."
