---
title: OpenCode
description: "Conecta OpenCode a Venice con un proveedor personalizado en opencode.json para que tu agente de código en la terminal use modelos privados con un solo archivo."
...
Si estableces `"model": "venice/z-ai-glm-5-3-flash"` como se muestra arriba, OpenCode debería usar ese modelo de Venice por defecto. Puedes cambiar el predeterminado sustituyendo `z-ai-glm-5-3-flash` por cualquier ID de modelo del [catálogo de modelos de texto](/models/text) y añadiéndolo al mapa `models`.
