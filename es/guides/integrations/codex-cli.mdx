---
title: Codex CLI
description: "Apunta la CLI de OpenAI Codex a los modelos de Venice con un archivo local config.toml para que las solicitudes del agente de programación pasen por la API privada y compatible con OpenAI de Venice."
