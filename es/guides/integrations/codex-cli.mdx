---
title: Codex CLI
description: "Apunta la CLI de OpenAI Codex a los modelos de Venice con un proveedor en config.toml, tu VENICE_API_KEY y la URL base compatible con OpenAI."
