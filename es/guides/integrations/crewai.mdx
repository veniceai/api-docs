...
|-----------|-------------------|-----|
| Razonamiento complejo / Estrategia | `z-ai-glm-5-3-flash` | Modelo privado de razonamiento rápido |
...
3. **Usa GLM 5.3 Flash para razonamiento**: usa `z-ai-glm-5-3-flash` para agentes que necesiten razonamiento complejo o function calling fiable.
