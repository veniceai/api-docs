...
description: "Construye crews multiagente con CrewAI y Venice — configura modelos privados y sin censura de Venice como backend LLM para la colaboración de agentes basada en roles."
