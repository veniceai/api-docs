...
description: "El servidor MCP oficial de Venice expone 31 herramientas de chat, imagen, vídeo, audio y embeddings a Claude Desktop, Cursor y cualquier host MCP."
...
| `VENICE_SIWX_TOKEN` | _(ninguno)_ | Token de auth en modo monedero x402. Consulta [x402 más abajo](#modo-monedero-x402). |
