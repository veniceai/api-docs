...
description: "El servidor MCP oficial de Venice expone 30 herramientas de chat, imagen, vídeo, audio, música y personajes en cualquier host MCP."
...
<CardGroup cols={3}>
  <Card title="30 herramientas" icon="toolbox">
...
**30 herramientas** que cubren cada modalidad de Venice, **3 recursos** (`venice://models`, `venice://styles`, `venice://voices`) y **3 plantillas de prompt**.
