...
|---|---|---|
| Tomas de personaje (1-2 personajes) | `seedance-2-0-reference-to-video-api` | R2V por defecto con `reference_image_urls` planos, etiquetas `@Image`, hasta 15s, audio estéreo nativo |
...
| Establecimiento / atmósfera / acción | `seedance-2-0-image-to-video-api` | Sin personajes; calidad cinematográfica épica, hasta 15s |
