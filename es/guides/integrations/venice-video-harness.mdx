...
description: "Controla Venice desde Claude Code o Cursor con el kit Venice Video Harness para vídeos con personajes consistentes, storyboards y narrativas."
...
<CardGroup cols={3}>
  ...
  <Card title="API key de Venice" icon="key" href="/guides/getting-started/generating-api-key">
    Desde [venice.ai/settings/api](https://venice.ai/settings/api?utm_source=venice-api-documentation)
  </Card>
</CardGroup>
