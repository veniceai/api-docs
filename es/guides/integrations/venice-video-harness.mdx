...
description: "Controla Venice desde Claude Code o Cursor con un harness para vídeos con personajes consistentes, storyboards, tráileres y narrativa."
...
|---|---|---|
| Tomas de personaje (1-2 personajes) | `seedance-2-0-reference-to-video-basic` | R2V por defecto con `reference_image_urls` planos, etiquetas `@Image`, hasta 15s, audio estéreo nativo |
...
| Establecimiento / atmósfera / acción | `seedance-2-0-image-to-video-basic` | Sin personajes; calidad cinematográfica épica, hasta 15s |
