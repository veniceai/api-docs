...
description: "Usa Venice como proveedor de modelos y capa RPC de blockchain para agentes autónomos: una clave de API, más de 230 modelos y JSON-RPC en 11 cadenas."
