...
"og:description": "Configura Claude Code para usar Claude Opus 4.5/4.6/4.7/4.8, Sonnet 4.5/4.6/4.7/4.8 y Fable 5 a través de Venice AI"
---

[Claude Code](https://docs.anthropic.com/en/docs/claude-code) es la herramienta CLI de Anthropic para programación con agentes. Esta guía te muestra cómo ejecutarlo a través de Venice AI para obtener acceso por uso a Claude Opus 4.5/4.6/4.7/4.8, Sonnet 4.5/4.6/4.7/4.8 y Fable 5.
...
<CardGroup cols={3}>
  ...
  <Card title="Modelos Claude" icon="microchip">
    Accede a Opus 4.5/4.6/4.7/4.8, Sonnet 4.5/4.6/4.7/4.8 y Fable 5 a través de Venice
  </Card>
...
<Steps>
  ...
  <Step title="Obtén tu API key">
    Genera una clave en [venice.ai/settings/api](https://venice.ai/settings/api?utm_source=venice-api-documentation). La pegarás directamente en el archivo de configuración en el siguiente paso.
  </Step>
...
| Claude Opus 4.7 | `claude-opus-4-7` | Razonamiento complejo, refactorizaciones grandes |
| Claude Opus 4.7 Fast | `claude-opus-4-7-fast` | Razonamiento complejo con menor latencia |
| Claude Opus 4.8 | `claude-opus-4-8` | Razonamiento complejo, refactorizaciones grandes |
| Claude Opus 4.8 Fast | `claude-opus-4-8-fast` | Razonamiento complejo con menor latencia |
| Claude Fable 5 | `claude-fable-5` | Tareas complejas que requieren la máxima inteligencia |
