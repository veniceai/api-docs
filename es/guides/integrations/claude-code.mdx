---
title: Claude Code
description: "Enruta las solicitudes de Claude Code CLI por Venice con claude-code-router para acceso de pago por token a los modelos Claude Opus, Sonnet y Fable."
