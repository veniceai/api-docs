---
title: Claude Code
description: "Configura la CLI de Claude Code para enrutar las solicitudes de Anthropic Claude Opus y Sonnet a través de Venice para inferencia privada de agentes de programación basada en uso."
