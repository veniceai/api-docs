...
description: "Usa Venice AI con LangChain para chains, agentes y pipelines RAG"
"og:title": "Integración con LangChain | Venice API Docs"
"og:description": "Crea aplicaciones LangChain impulsadas por los modelos privados y sin censura de Venice AI"
---

Venice AI funciona sin problemas con [LangChain](https://python.langchain.com/) gracias a la compatibilidad total con el SDK de OpenAI. Crea cadenas, agentes y pipelines RAG con la infraestructura de Venice centrada en la privacidad.
...
embeddings = OpenAIEmbeddings(
    ...
    api_key="your-venice-api-key",
    base_url="https://api.venice.ai/api/v1",
    check_embedding_ctx_length=False,  # Necesario para Venice
)
...
### Chain sencilla con plantilla de prompt
...
Usa la búsqueda web integrada de Venice vía `venice_parameters`:
...
| Razonamiento complejo | `zai-org-glm-5-1` | Mejor modelo flagship privado |
...
| Económico / alto volumen | `qwen3-5-9b` | $0,10/1M de entrada |

<Card title="Ver todos los modelos" icon="database" href="/es/models/overview">
