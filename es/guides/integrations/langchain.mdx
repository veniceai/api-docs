...
description: "Conecta modelos de Venice con LangChain para chains, agentes, uso de herramientas y pipelines RAG usando el cliente ChatOpenAI compatible con OpenAI y los SDKs de Python o JS."
