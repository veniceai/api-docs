---
title: "LangChain"
description: "Conecta modelos de Venice con LangChain para chains, agentes, herramientas y RAG usando ChatOpenAI y los SDKs de Python o JavaScript."
...
Venice genera embeddings únicamente de texto. `OpenAIEmbeddings` de LangChain usa por defecto `check_embedding_ctx_length=True`, lo que tokeniza con tiktoken y puede enviar arreglos de tokens enteros. Venice los rechaza con HTTP 400, así que establece `check_embedding_ctx_length=False`.
...
embeddings = OpenAIEmbeddings(
    ...
    api_key="your-venice-api-key",
    base_url="https://api.venice.ai/api/v1",
    check_embedding_ctx_length=False,  # Obligatorio: enviar texto, no IDs de tokens
)
...
| Razonamiento complejo | `z-ai-glm-5-3-flash` | Modelo privado de razonamiento rápido |
| Function calling | `z-ai-glm-5-3-flash` | Uso fiable de herramientas |
