...
description: "Convierte un PDF en registros tipados con el text-parser de Venice y salida con esquema JSON, recurriendo a un modelo de visión si el archivo es un escaneo."
