...
description: "Convierte un PDF en registros tipados con /augment/text-parser y esquemas JSON de Venice, y recurre a la visión cuando no haya texto que extraer."
