...
description: "Encadena Venice Web Search y Web Scrape en un chat completion que responde preguntas con un informe citado donde cada afirmación enlaza a una fuente."
