...
description: "Combina Venice Web Search, Web Scrape y las completions de chat en un script que responde a una pregunta con un informe donde cada afirmación enlaza a una fuente."
