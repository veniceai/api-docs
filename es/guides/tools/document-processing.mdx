...
description: "Extrae texto y recuentos de tokens de archivos PDF, DOCX, PPTX, XLSX y texto plano de hasta 25 MB con la API Text Parser de Venice, sin inferencia."
