...
description: "Acuña una clave de API de Venice de forma autónoma desde un agente on-chain con staking de VVV en Base y firma de un desafío SIWE con monedero."
'og:title': "Autonomous Agent API Key | Venice API Docs"
'og:description': Cómo un agente de IA autónomo puede acuñar su propia API key de Venice firmando un desafío SIWE emitido por Venice con un monedero que tiene VVV en staking en Base.
---
