...
description: "Acuña una clave de API de Venice de forma autónoma desde un agente de IA on-chain haciendo staking de VVV en Base y firmando un token de validación emitido por Venice con un monedero."
