...
description: "Reduce costes y latencia en la API de Venice almacenando en caché contenido repetido del prompt, como prompts del sistema, historial de conversación y contexto de documentos entre solicitudes."
