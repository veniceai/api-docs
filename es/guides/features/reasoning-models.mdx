...
description: "Llama a los modelos de razonamiento de Venice con tokens de cadena de pensamiento, control del esfuerzo y respuestas paso a paso en chat."
...
Consulta la lista completa de modelos, precios y límites de contexto en la [página de Modelos](/overview/models). No todos los modelos de razonamiento admiten el parámetro [`reasoning_effort`](#esfuerzo-de-razonamiento). Consulta [soporte por modelo](#soporte-por-modelo) para más detalles.
...
Para obtener más salida visible, sube el tope, baja `reasoning_effort` o [desactiva el razonamiento](#desactivar-el-razonamiento).
