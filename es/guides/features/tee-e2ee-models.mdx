...
<Info>
Para obtener una descripción general de los modos de privacidad y ayuda para elegir TEE o E2EE, consulta [Privacidad](/overview/privacy). Esta guía cubre los detalles del protocolo y la implementación.
</Info>
...
<CodeGroup>
```bash cURL
# Genera un nonce aleatorio de 32 bytes (evita ataques de repetición)
