...
description: "Permite que los modelos de chat de Venice llamen a las herramientas de tu aplicación con llamada a funciones compatible con OpenAI y la API de chat completions."
