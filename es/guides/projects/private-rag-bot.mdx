...
description: "Construye un bot RAG privado usando embeddings de Venice, búsqueda vectorial con Qdrant, re-ranking con FastEmbed y chat completions de Venice para obtener respuestas fundamentadas y con citas."
