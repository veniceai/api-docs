...
description: "Guía práctica para construir un LLM gateway en Rust sobre Venice, compatible con OpenAI, usando Axum, Postgres, SQLx, streaming, límites de tasa y OpenTelemetry."
