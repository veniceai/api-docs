...
<div className="venice-demo-grid">
  ...
  <div className="venice-demo-card">
    ...
    <h3 className="venice-demo-title">Cuaderno de investigación con audio</h3>
    <p className="venice-demo-desc">Respuestas citadas a partir de tus fuentes, más un resumen de audio a dos voces que puedes escuchar.</p>
    <div className="venice-demo-tags">
      <span className="venice-demo-tag">Scrape</span>
      <span className="venice-demo-tag">Analizador de texto</span>
      <span className="venice-demo-tag">Embeddings</span>
      <span className="venice-demo-tag">Texto a voz</span>
    </div>
    <div className="venice-demo-actions">
      <a className="venice-demo-link" href="/es/guides/projects/audio-research-notebook">Leer la guía <span className="venice-demo-arrow">→</span></a>
