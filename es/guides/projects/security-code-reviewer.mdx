...
description: "Construye un agente de seguridad en Python sobre Venice que encuentra vulnerabilidades atómicas y las encadena en rutas de explotación usando un mapa de repositorio AST y guardrails de Pydantic."
