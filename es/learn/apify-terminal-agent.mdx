...
description: "Construye un agente de terminal en Python que razona con chat completions de Venice y raspa la web en vivo mediante Apify Actors expuestos por MCP."
