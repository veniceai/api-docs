...
description: "Construye un agente de seguridad en Python sobre Venice que halla vulnerabilidades atómicas y las encadena en rutas de explotación con un mapa AST y Pydantic."
...
- Python 3.12+
- Una clave API de Venice de [venice.ai](https://venice.ai/?utm_source=venice-api-documentation)
