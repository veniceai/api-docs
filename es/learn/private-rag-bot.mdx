...
description: "Construye un bot RAG privado con embeddings de Venice, búsqueda vectorial Qdrant, re-ranking con FastEmbed y chat completions que responden con citas."
