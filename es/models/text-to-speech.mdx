...
description: "Modelos de texto a voz de Venice como Kokoro, ElevenLabs Turbo y Orpheus con voces multilingües, precios por carácter y audio en streaming."
...
Usa el valor `id` como parámetro `model` en las solicitudes a la API. Actualmente hay 11 modelos disponibles.
...
[API de voz](/es/api-reference/endpoint/audio/speech) para ejemplos.
</Note>
