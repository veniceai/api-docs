...
description: "Modelos de embeddings de Venice como BGE-M3 y Qwen3 Embedding con precios por token, niveles de privacidad y uso de /embeddings compatible con OpenAI."
...
<Note>
Consulta la [API de embeddings](/es/api-reference/endpoint/embeddings/generate) para ejemplos de uso.
</Note>
