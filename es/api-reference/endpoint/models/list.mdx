...
Este es el catálogo en vivo. Si puedes hacer solicitudes HTTP, llama a este endpoint para obtener los IDs de modelo actuales en lugar de depender de las tablas de snapshot en `/models`. No se requiere clave de API.
