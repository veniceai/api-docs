---
title: Introducción
description: "Referencia completa de la API de Venice: autenticación Bearer, compatibilidad con OpenAI, cabeceras de respuesta, manejo de errores y cada endpoint REST."
