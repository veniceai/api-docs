...
| `model` | string | No | `firered-image-edit` | Edit model ID |
...
| `modelId` | string | No | `firered-image-edit` | Edit model ID |
...
The default edit model is `firered-image-edit`, priced at **$0.04 per edit**. Other edit-capable models may have different pricing and constraints.
...
<Note>
Some edit models have stricter content policies than image generation models. For example, `firered-image-edit` blocks requests involving explicit sexual imagery, sexualized minors, or real-world violence.
</Note>
