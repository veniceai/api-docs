---
title: "Seedance 2.0"
description: "Generate, edit, extend, and stitch videos with Seedance 2.0 on Venice — text, image, and reference-to-video workflows on one endpoint, with worked examples."
