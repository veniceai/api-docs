...
description: "Transcribe audio files to text with Venice speech-to-text models via /audio/transcriptions, choosing response formats and segment timestamps."
