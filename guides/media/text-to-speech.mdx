...
<Tip>
Narrating something longer than a few sentences? [Narrating Articles with Text-to-Speech](/guides/media/article-narration) covers the 4096-character input cap, splitting text on sentence boundaries, joining the pieces into one audio file, and streaming for interactive playback.
</Tip>

- [Audio Speech API](/api-reference/endpoint/audio/speech)
- [Text-to-Speech Models](/models/text-to-speech)
- [Narrating Articles with Text-to-Speech](/guides/media/article-narration)
