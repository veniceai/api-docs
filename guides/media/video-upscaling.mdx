...
description: "Enhance video resolution and quality with the topaz-video-upscale model on Venice's async video queue, with 1x, 2x, or 4x upscaling factors."
...
| `"Insufficient balance"` | Account credits too low | Add credits at [venice.ai/settings/api](https://venice.ai/settings/api?utm_source=venice-api-documentation) |
