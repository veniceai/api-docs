...
Use the styles endpoint when you want exact preset names instead of guessing them. See [Style References](/guides/media/style-references) for validation examples, prompting tips, and model support guidance.
