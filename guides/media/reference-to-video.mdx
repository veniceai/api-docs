...
description: "Generate consistent AI videos with character elements and scene references using Kling O3 and Grok Imagine R2V in the Venice Video Studio."
...
This feature is available on **Kling O3** and **Grok Imagine R2V** models in the [Venice Video Studio](https://venice.ai/video?utm_source=venice-api-documentation). Each model family uses a different approach to reference images — see the model-specific sections below.
...
Go to [venice.ai/video](https://venice.ai/video?utm_source=venice-api-documentation). In the Model Browser on the left, select one of the **Kling O3 Reference to Video** models:
...
Go to [venice.ai/video](https://venice.ai/video?utm_source=venice-api-documentation). In the Model Browser, select **Grok Imagine R2V**.
