---
title: Venice CLI
description: The official Venice command-line interface brings chat, web search, image generation, TTS, transcription, video, and embeddings to your terminal with optional end-to-end encryption.
...
<Steps>
  ...
  <Step title="Configure your key">
    Store the key in the local config:
