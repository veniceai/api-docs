...
const MODELS = [
  ...
  { id: 'z-ai-glm-5-3-flash', name: 'GLM 5.3 Flash', desc: 'Fast private reasoning' },
...
| Complex tasks | `z-ai-glm-5-3-flash` | Fast private reasoning |
...
| Tool calling | `z-ai-glm-5-3-flash` | Reliable function calling |
