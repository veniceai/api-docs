---
title: Venice Skills
description: Official Venice Agent Skills that load endpoint knowledge into Claude Code, Cursor, Codex, OpenCode, Hermes, and Cline so coding agents call Venice correctly.
