---
title: Codex CLI
description: "Point the OpenAI Codex CLI at Venice models with a config.toml model provider entry, your VENICE_API_KEY, and the OpenAI-compatible base URL."
