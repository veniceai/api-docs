...
description: The official Venice Model Context Protocol server exposes 30 Venice tools for chat, image, video, audio, music, and characters in any MCP host.
...
The [Venice MCP Server](https://github.com/veniceai/venice-mcp-server) is the official [Model Context Protocol](https://modelcontextprotocol.io/) server for Venice. It exposes the full Venice API (chat, image, video, audio, music, embeddings, web augment, and characters) as **30 tools** that any MCP-compatible agent can call.
...
<Steps>
  ...
  <Step title="Restart your MCP host">
    Your agent now has chat, image, video, music, TTS, ASR, and 24 more Venice tools available.
  </Step>
</Steps>
...
**30 tools** spanning every Venice modality, **3 resources** (`venice://models`, `venice://styles`, `venice://voices`), and **3 prompt templates**.
