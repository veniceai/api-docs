...
description: "Drive Venice from Claude Code or Cursor with the Venice Video Harness toolkit for character-consistent videos, storyboards, and narratives."
...
<CardGroup cols={3}>
  ...
  <Card title="Venice API key" icon="key" href="/guides/getting-started/generating-api-key">
    From [venice.ai/settings/api](https://venice.ai/settings/api?utm_source=venice-api-documentation)
  </Card>
</CardGroup>
...
|---|---|---|
| Character shots (1-2 characters) | `seedance-2-0-reference-to-video-basic` | Default R2V with flat `reference_image_urls`, `@Image` tags, up to 15s, native stereo audio |
...
| Establishing / mood / action | `seedance-2-0-image-to-video-basic` | No characters; epic cinematic quality, up to 15s |
