...
|---|---|---|
| Character shots (1-2 characters) | `seedance-2-0-reference-to-video-api` | Default R2V with flat `reference_image_urls`, `@Image` tags, up to 15s, native stereo audio |
...
| Establishing / mood / action | `seedance-2-0-image-to-video-api` | No characters; epic cinematic quality, up to 15s |
