---
title: OpenClaw
description: "Configure Venice as a built-in provider in the OpenClaw gateway for private AI across WhatsApp, Telegram, Discord, iMessage, and Slack."
...
The wizard will walk you through setup. When prompted, select **Venice AI** as your provider from the list, then paste your API key. Get one from [venice.ai/settings/api](https://venice.ai/settings/api?utm_source=venice-api-documentation) if you don't have one yet.
