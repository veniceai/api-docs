---
title: Brave Leo
description: "Connect Brave Leo's Bring Your Own Model settings to Venice's chat completions endpoint for private, browser-native AI chat and page summaries."
...
- Remote Venice requests require an internet connection and consume Venice credits or your available DIEM allowance.

## Troubleshooting

<AccordionGroup>
  <Accordion title="401 or authentication error">
    Confirm that the key comes from [venice.ai/settings/api](https://venice.ai/settings/api?utm_source=venice-api-documentation). Paste the raw key without `Bearer` and remove any leading or trailing spaces.
  </Accordion>
