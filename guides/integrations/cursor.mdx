---
title: Cursor IDE
description: "Configure Cursor IDE to use Venice models like Claude, GPT, and DeepSeek through an OpenAI-compatible base URL with pay-per-token pricing."
...
<Steps>
  <Step title="Get Your API Key">
    Generate a key from [venice.ai/settings/api](https://venice.ai/settings/api?utm_source=venice-api-documentation).
  </Step>
