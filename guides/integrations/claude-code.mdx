---
title: Claude Code
description: "Route Claude Code CLI requests through Venice with claude-code-router for pay-per-token access to Claude Opus, Sonnet, and Fable coding models."
