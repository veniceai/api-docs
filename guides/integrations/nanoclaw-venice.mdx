---
title: NanoClaw
description: "Deploy NanoClaw, a self-hosted AI assistant for WhatsApp and Telegram, on Venice AI for private, uncensored inference with Docker isolation."
...
| **Pricing** | Pay-per-token, no subscription. Or stake [DIEM](https://venice.ai/lp/diem?utm_source=venice-api-documentation) for daily refreshing credits | $20–200/mo subscriptions or pay-per-token API |
