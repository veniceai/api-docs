---
title: Cline
description: "Configure the Cline AI coding assistant in VS Code to use private Venice text models through the OpenAI-compatible /chat/completions endpoint."
...
<Steps>
  ...
  <Step title="Configure Venice">
    ...
    For example, use `z-ai-glm-5-3-flash` as the Model ID.
...
<AccordionGroup>
  <Accordion title="401 or authentication error">
    Confirm that the API key comes from [venice.ai/settings/api](https://venice.ai/settings/api?utm_source=venice-api-documentation). Paste the raw key into Cline without `Bearer` or extra whitespace.
  </Accordion>
...
<CardGroup cols={2}>
  <Card title="Original Venice Cline Guide" icon="book" href="https://venice.ai/blog/how-to-use-the-venice-api-with-cline-in-vscode-a-developers-guide?utm_source=venice-api-documentation">
