...
|-----------|-------------------|-----|
| Complex reasoning / Strategy | `z-ai-glm-5-3-flash` | Fast private reasoning model |
...
3. **Use GLM 5.3 Flash for reasoning**: Use `z-ai-glm-5-3-flash` for agents that need complex reasoning or reliable function calling.
