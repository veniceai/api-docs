---
title: Hermes Agent
description: "Set up Venice as a provider in the Nous Research Hermes Agent for private AI with persistent memory, custom skills, and access to 230+ models."
...
| **Video** | Generation, editing, upscaling, and analysis with video-capable chat models |
...
Get an API key from [venice.ai/settings/api](https://venice.ai/settings/api?utm_source=venice-api-documentation) if you don't have one yet.
