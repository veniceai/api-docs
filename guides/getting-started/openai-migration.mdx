...
description: "Move OpenAI-compatible apps to Venice by swapping the base URL to api.venice.ai and your API key for private, uncensored inference with the same SDK."
