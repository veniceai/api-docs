...
<Info>
Both TEE and E2EE model IDs use the `e2ee-*` prefix. E2EE models include TEE protection plus client-side encryption. TEE models provide enclave security without requiring client-side encryption.
</Info>
