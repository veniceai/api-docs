...
<Info>
For an overview of the privacy modes and help choosing TEE or E2EE, see [Privacy](/overview/privacy). This guide covers protocol and implementation details.
</Info>

<Note>
TEE and E2EE are currently available on text models only.
</Note>
...
<CodeGroup>
```bash cURL
# Generate a random 32-byte nonce (prevents replay attacks)
