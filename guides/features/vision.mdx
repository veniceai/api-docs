...
Each image consumes context tokens. If a request with several images returns `TOO_MANY_TOKENS` (HTTP 400), reduce the number of images, shorten your instructions, or switch to a model with a larger context window.
