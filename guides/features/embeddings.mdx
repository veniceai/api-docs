---
title: "Embeddings"
description: "Generate vector embeddings with the OpenAI-compatible Venice /embeddings endpoint for semantic search, RAG retrieval, clustering, and similarity."
