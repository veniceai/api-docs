---
title: "Build a Cited Research Brief"
sidebarTitle: "Cited Research Brief"
description: "A step-by-step tutorial that combines Venice Web Search, Web Scrape, and chat completions into a script that answers a question with a brief where every claim links back to a source."
"og:title": "Build a Cited Research Brief | Venice API Docs"
"og:description": "Tutorial: chain Venice Web Search and Web Scrape into a chat completion that produces a cited research brief."
---
...
Doing retrieval ourselves, rather than letting the model do it, is what makes the result auditable. We keep the exact list of pages that went into the prompt and can show a reader where each claim came from. If you would rather have Venice handle retrieval inside a single request, set `venice_parameters.enable_web_search` on a chat completion instead. The [Web Retrieval](/guides/tools/web-retrieval) guide compares the two approaches.
...
- Read the brief out loud by piping it into [Build an Article Narrator](/guides/tutorials/narrated-articles).

<CardGroup cols={2}>
  <Card title="Web Retrieval" icon="magnifying-glass" href="/guides/tools/web-retrieval">
    Reference for the Search and Scrape endpoints.
  </Card>
  <Card title="Build an Article Narrator" icon="volume-2" href="/guides/tutorials/narrated-articles">
    Turn the text you just generated into audio.
  </Card>
  <Card title="Embeddings" icon="layers" href="/guides/features/embeddings">
