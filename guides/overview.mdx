---
title: Guides
description: Practical Venice API walkthroughs covering API keys, OpenAI migration, chat features, embeddings, media generation, and agent framework integrations.
---
...
<CardGroup cols={2}>
  ...
  <Card title="API Tools" icon="wrench" href="/guides/tools/document-processing">
    Parse documents, retrieve web content, and access blockchain networks.
  </Card>
...
<CardGroup cols={3}>
  ...
  <Card title="API Tools" icon="wrench" href="/guides/tools/document-processing">
    Document parsing, web search and scraping, and blockchain JSON-RPC access.
  </Card>
