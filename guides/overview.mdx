...
<CardGroup cols={2}>
  ...
  <Card title="Using the Venice API with Rust" icon="code" href="/guides/projects/using-venice-api-with-rust">
    Learn why Rust fits LLM tooling and call Venice through Rig’s OpenAI-compatible client.
  </Card>
</CardGroup>
