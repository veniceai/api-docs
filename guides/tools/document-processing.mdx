...
description: "Extract text and token counts from PDF, DOCX, PPTX, XLSX, and plain text files up to 25 MB with the Venice Text Parser API, no inference needed."
