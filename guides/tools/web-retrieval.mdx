---
title: "Web Retrieval"
description: "Use Venice Web Search to find current sources and Venice Web Scrape to extract selected pages as clean Markdown ready for LLM prompts and RAG pipelines."
