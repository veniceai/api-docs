...
description: "Find current sources with Venice Web Search and extract public pages as model-ready Markdown with Web Scrape before running model inference."
...
<Tip>
Building a search-to-scrape pipeline? [Cited Answers with Web Search](/guides/tools/cited-web-answers) walks through the whole workflow step by step, including source selection, handling pages that fail to extract, and producing an answer where every claim resolves to a URL.
</Tip>
...
- [Cited Answers with Web Search](/guides/tools/cited-web-answers)
