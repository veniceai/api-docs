...
description: "Chain Venice Web Search and Web Scrape into a chat completion that answers questions with a cited brief where every claim links to a source."
...
- Let the model plan several queries before searching, as the [Private Research Agent](/learn/private-research-agent) demo does.
