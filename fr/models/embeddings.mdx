...
description: "Modèles d'embeddings Venice comme BGE-M3 et Qwen3 Embedding : tarifs par token, niveaux de confidentialité et utilisation /embeddings compatible OpenAI."
"og:title": "Modèles d'embeddings | Venice API Docs"
---
...
<Note>
Voir l'[API Embeddings](/fr/api-reference/endpoint/embeddings/generate) pour des exemples d'utilisation.
</Note>
