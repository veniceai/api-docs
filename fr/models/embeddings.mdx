...
description: "Modèles d'embedding Venice comme BGE-M3 et Qwen3 Embedding : tarifs par token, niveaux de confidentialité et usage /embeddings compatible OpenAI."
