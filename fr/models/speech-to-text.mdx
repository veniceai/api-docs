...
description: "Modèles de transcription Venice pour convertir l'audio en texte avec prise en charge multilingue, horodatages et un endpoint /audio/transcriptions compatible OpenAI."
