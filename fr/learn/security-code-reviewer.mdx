...
description: "Créez un agent de sécurité Python sur Venice qui trouve des vulnérabilités atomiques et les enchaîne en chemins d'exploit via carte AST et Pydantic."
...
- Python 3.12+
- Une clé API Venice depuis [venice.ai](https://venice.ai/?utm_source=venice-api-documentation)
