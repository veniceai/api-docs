...
description: "Construisez un agent de terminal en Python qui raisonne avec les chat completions de Venice et scrape le web via les Actors Apify exposés sur MCP."
