...
description: "Créez un agent de recherche Python sur Venice qui planifie les recherches, scrape des sources web, extrait des preuves et rédige des rapports Markdown cités."
