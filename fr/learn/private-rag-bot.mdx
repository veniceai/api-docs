...
description: "Créez un bot RAG privé avec embeddings Venice, recherche vectorielle Qdrant, re-ranking FastEmbed et chat completions qui répondent avec citations."
