...
description: "Payez l'inférence Venice depuis un portefeuille sans clé d'API grâce à x402 : authentification par signature, solde USDC et plafond de dépenses de l'agent."
