...
description: "Payez l'inférence Venice depuis un portefeuille sans clé d'API via x402, en USDC par requête, et plafonnez les dépenses de l'agent avec un budget appliqué."
