---
title: Démarrage
description: "Démarrage rapide pour l'API Venice — générez une clé d'API, envoyez votre première complétion de chat et explorez les endpoints image, vidéo et audio en quelques minutes."
...
<Card title="Voir tous les modèles d'image" icon="image" href="/overview/models#image-models">
