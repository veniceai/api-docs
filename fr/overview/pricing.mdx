...
description: "Tarifs de l'API Venice par million de tokens pour les modèles texte, image, vidéo, audio et embeddings, et crédits pour la recherche web et le RPC."
...
| Seedance 2.0 Enhanced (Beta) | `seedance-2-0-enhanced-text-to-video` | Text to Video | Variable | Anonymized |
| Seedance 2.0 Enhanced R2V (Beta) | `seedance-2-0-enhanced-reference-to-video` | Text to Video | Variable | Anonymized |
...
| Seedance 2.0 Mini | `seedance-2-0-mini-text-to-video` | Text to Video | Variable | Anonymized |
| Seedance 2.0 Mini | `seedance-2-0-mini-image-to-video` | Image to Video | Variable | Anonymized |
| Seedance 2.0 Mini R2V | `seedance-2-0-mini-reference-to-video` | Text to Video | Variable | Anonymized |
