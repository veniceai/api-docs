...
description: "Utilisez Venice AI avec LangChain pour des chaînes, agents et pipelines RAG"
"og:title": "Intégration LangChain | Documentation Venice API"
"og:description": "Construisez des applications LangChain propulsées par les modèles privés et non censurés de Venice AI"
---

Venice AI fonctionne sans accroc avec [LangChain](https://python.langchain.com/) grâce à une compatibilité totale avec le SDK OpenAI. Construisez des chaînes, agents et pipelines RAG avec l'infrastructure orientée confidentialité de Venice.
...
### Chaîne simple avec template de prompt
...
Construisez un pipeline retrieval-augmented generation avec Venice :
...
|----------|-------|-----|
| Chaînes générales | `venice-uncensored` | Rapide, peu coûteux, non censuré |
| Raisonnement complexe | `zai-org-glm-5-1` | Meilleur modèle phare privé |
| Function calling | `zai-org-glm-5-1` | Utilisation d'outils fiable |
...
| Budget / fort volume | `qwen3-5-9b` | 0,10 $/1M d'entrée |

<Card title="Voir tous les modèles" icon="database" href="/fr/models/overview">
  Parcourez tous les modèles Venice avec tarifs et capacités
</Card>
