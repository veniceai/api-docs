...
embeddings = OpenAIEmbeddings(
    ...
    api_key="your-venice-api-key",
    base_url="https://api.venice.ai/api/v1",
    check_embedding_ctx_length=False,  # Requis : envoyer du texte, pas des ID de tokens
)
...
| Raisonnement complexe | `z-ai-glm-5-3-flash` | Modèle de raisonnement privé rapide |
| Function calling | `z-ai-glm-5-3-flash` | Utilisation fiable des outils |
