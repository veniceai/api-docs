...
| Appel d'outils / sortie structurée | `z-ai-glm-5-3-flash` | Modèle privé rapide pour les agents |
| Raisonnement complexe | `z-ai-glm-5-3-flash` | Meilleure planification multi-étapes |
