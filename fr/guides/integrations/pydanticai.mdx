---
title: "PydanticAI"
description: "Créez des agents Python typés avec PydanticAI et les modèles de chat privés compatibles OpenAI de Venice pour outils, sortie structurée et streaming."
