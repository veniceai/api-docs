---
title: "Mastra"
description: "Créez des agents IA, outils et workflows TypeScript avec Mastra en utilisant les modèles de chat privés et compatibles OpenAI de Venice comme fournisseur LLM."
