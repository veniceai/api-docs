...
<Card title="GitHub : veniceai/skills" icon="github" href="https://github.com/veniceai/skills">
  18 skills couvrant l'API Venice complète. Sous licence MIT. Maintenu synchronisé avec le [`swagger.yaml`](/api-reference/api-spec) public.
</Card>

<CardGroup cols={3}>
  <Card title="18 skills" icon="layer-group">
