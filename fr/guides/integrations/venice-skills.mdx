---
title: Venice Skills
description: "Skills d'agent Venice officiels qui chargent la connaissance des endpoints dans Claude Code, Cursor, Codex, OpenCode, Hermes et Cline pour des agents de codage fiables."
...
[Venice Skills](https://github.com/veniceai/skills) est la collection canonique de [Agent Skills](https://platform.claude.com/docs/en/agents-and-tools/agent-skills/overview) pour l'API Venice. Chaque skill est un dossier autonome avec un fichier `SKILL.md` qu'un agent LLM charge à la demande pour fonctionner correctement avec une surface spécifique de l'API.
...
| `venice-video` | Génération `/video/*`, édition, agrandissement et cycle de vie des jobs asynchrones |
...
<CardGroup cols={2}>
  ...
  <Card title="Spec Agent Skills" icon="arrow-up-right-from-square" href="https://platform.claude.com/docs/en/agents-and-tools/agent-skills/overview">
