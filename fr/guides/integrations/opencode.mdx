---
title: OpenCode
description: "Connectez OpenCode à Venice via un fournisseur personnalisé compatible OpenAI : votre agent de codage s'exécute sur des modèles Venice privés."
