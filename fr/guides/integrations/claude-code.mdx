...
<Steps>
  ...
  <Step title="Obtenez votre clé API">
    Générez une clé depuis [venice.ai/settings/api](https://venice.ai/settings/api?utm_source=venice-api-documentation). Vous la collerez directement dans le fichier de configuration à l'étape suivante.
  </Step>
