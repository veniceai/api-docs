---
title: Claude Code
description: "Routez les requêtes du CLI Claude Code via Venice avec claude-code-router : accès en paiement par token aux modèles de code Claude Opus, Sonnet et Fable."
