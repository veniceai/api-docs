---
title: Claude Code
description: "Configurez la CLI Claude Code pour router les requêtes Anthropic Claude Opus et Sonnet via Venice et bénéficier d'une inférence d'agent de codage privée et à l'usage."
