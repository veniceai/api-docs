...
description: "Créez des agents vocaux en temps réel avec LiveKit Agents et Venice, en connectant Venice STT, LLM et TTS via le plugin compatible OpenAI dans un pipeline STT-LLM-TTS."
