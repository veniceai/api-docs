...
[Venice](https://venice.ai/?utm_source=venice-api-documentation) est une plateforme IA orientée confidentialité. Ils [ne stockent ni ne journalisent aucun prompt ou réponse](https://venice.ai/privacy?utm_source=venice-api-documentation) sur leurs serveurs — vos conversations existent uniquement sur votre appareil. Les requêtes sont chiffrées de bout en bout à travers leur proxy vers des fournisseurs GPU décentralisés, sans aucune rétention de données. Cela signifie que les conversations avec votre assistant IA restent privées, même vis-à-vis de Venice elle-même.
...
| **Tarification** | Paiement au token, sans abonnement. Ou stakez du [DIEM](https://venice.ai/lp/diem?utm_source=venice-api-documentation) pour des crédits quotidiens renouvelés | Abonnements à 20-200 \$/mois ou API au token |
...
<CardGroup cols={2}>
  ...
  <Card title="Clé API Venice" icon="key" href="https://venice.ai/settings/api?utm_source=venice-api-documentation">
