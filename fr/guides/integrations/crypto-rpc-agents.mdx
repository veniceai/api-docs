...
description: "Utilisez Venice à la fois comme fournisseur de modèles et comme couche RPC blockchain pour des agents IA autonomes — un seul identifiant, 230+ modèles, 11 chaînes, sans MetaMask."
