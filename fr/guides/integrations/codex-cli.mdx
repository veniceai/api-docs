---
title: Codex CLI
description: "Pointez la CLI OpenAI Codex vers les modèles Venice avec une entrée fournisseur dans config.toml, votre VENICE_API_KEY et l'URL de base OpenAI compatible."
