---
title: Codex CLI
description: "Pointez la CLI OpenAI Codex vers les modèles Venice avec un fichier config.toml local pour que les requêtes d'agent de codage passent par l'API privée et compatible OpenAI de Venice."
