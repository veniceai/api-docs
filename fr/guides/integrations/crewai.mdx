...
smart_llm = LLM(model="openai/z-ai-glm-5-3-flash", api_key="your-key", base_url="https://api.venice.ai/api/v1")
...
|-----------|-------------------|-----|
| Raisonnement complexe / Stratégie | `z-ai-glm-5-3-flash` | Modèle de raisonnement privé rapide |
...
3. **Utilisez GLM 5.3 Flash pour le raisonnement** : utilisez `z-ai-glm-5-3-flash` pour les agents qui ont besoin d'un raisonnement complexe ou d'un appel de fonctions fiable.
