...
|---|---|---|
| Plans de personnage (1-2 personnages) | `seedance-2-0-reference-to-video-api` | R2V par défaut avec `reference_image_urls` plats, tags `@Image`, jusqu'à 15 s, audio stéréo natif |
...
| Plan d'établissement / d'ambiance / d'action | `seedance-2-0-image-to-video-api` | Pas de personnages ; qualité cinématique épique, jusqu'à 15 s |
