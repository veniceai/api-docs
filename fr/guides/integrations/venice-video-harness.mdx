...
description: "Pilotez Venice depuis Claude Code ou Cursor avec un harnais optimisé pour produire vidéos cohérentes, storyboards, bandes-annonces et récits longs."
...
|---|---|---|
| Plans de personnage (1-2 personnages) | `seedance-2-0-reference-to-video-basic` | R2V par défaut avec `reference_image_urls` plats, tags `@Image`, jusqu'à 15 s, audio stéréo natif |
...
| Plan d'établissement / d'ambiance / d'action | `seedance-2-0-image-to-video-basic` | Pas de personnages ; qualité cinématique épique, jusqu'à 15 s |
