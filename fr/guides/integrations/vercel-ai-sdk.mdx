...
const MODELS = [
  ...
  { id: 'z-ai-glm-5-3-flash', name: 'GLM 5.3 Flash', desc: 'Raisonnement privé rapide' },
...
| Tâches complexes | `z-ai-glm-5-3-flash` | Raisonnement privé rapide |
...
| Tool calling | `z-ai-glm-5-3-flash` | Function calling fiable |
