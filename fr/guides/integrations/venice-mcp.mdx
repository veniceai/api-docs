...
description: "Le serveur MCP officiel de Venice expose 31 outils de chat, image, vidéo, audio et embeddings à Claude Desktop, Cursor et tout hôte MCP."
...
| `VENICE_SIWX_TOKEN` | _(aucun)_ | Token d'authentification en mode wallet x402. Voir [x402 ci-dessous](#mode-wallet-x402). |
