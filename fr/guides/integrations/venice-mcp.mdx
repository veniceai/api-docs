...
description: "Le serveur officiel Venice MCP expose 30 outils Venice — chat, images, vidéos, audio, musique, personnages — dans n'importe quel hôte MCP."
...
<CardGroup cols={3}>
  <Card title="30 outils" icon="toolbox">
...
**30 outils** couvrant chaque modalité Venice, **3 ressources** (`venice://models`, `venice://styles`, `venice://voices`) et **3 modèles de prompts**.
