...
description: "Créez un bot RAG privé avec les embeddings Venice, la recherche vectorielle Qdrant, le re-ranking FastEmbed et les complétions de chat Venice pour des réponses sourcées et citables."
