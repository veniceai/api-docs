...
description: "Créez un agent de sécurité Python sur Venice qui détecte des vulnérabilités atomiques et les enchaîne en chemins d'exploitation à l'aide d'une carte AST du dépôt et de garde-fous Pydantic."
