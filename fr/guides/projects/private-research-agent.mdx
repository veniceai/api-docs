...
description: "Créez un agent de recherche Python sur Venice qui planifie, lit des sources web via l'API de scraping, extrait des preuves et rédige en Markdown."
