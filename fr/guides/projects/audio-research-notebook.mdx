...
description: "Transformez vos sources en réponses citées et en aperçu audio à deux voix avec Venice."
...
<CardGroup cols={2}>
  <Card title="Bot RAG privé" icon="database" href="/fr/guides/projects/private-rag-bot">
