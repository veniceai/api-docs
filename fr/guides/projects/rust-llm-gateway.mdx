...
description: "Guide pratique pour construire sur Venice une passerelle LLM en Rust compatible OpenAI avec Axum, Postgres, SQLx, streaming, rate limiting et OpenTelemetry."
