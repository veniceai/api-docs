...
description: "Construisez sur Venice une passerelle LLM en Rust compatible OpenAI avec Axum, Postgres, SQLx, auth bearer-token, streaming, rate limiting et OpenTelemetry."
