...
description: "Migrez vos applications de chat, d'embeddings et d'images compatibles OpenAI vers Venice en quelques minutes en changeant l'URL de base et la clé d'API — même SDK, plus de confidentialité."
