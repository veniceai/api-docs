...
description: "Créez une clé d'API Venice depuis le tableau de bord, stockez le bearer token en toute sécurité et vérifiez son fonctionnement avec une première requête de complétions de chat authentifiée."
