...
description: "Transformez un PDF en enregistrements typés avec /augment/text-parser de Venice et un schéma JSON imposé, et basculez sur un modèle de vision pour les scans."
