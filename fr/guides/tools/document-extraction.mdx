...
description: "Transformez un PDF en enregistrements typés avec le text-parser de Venice et une sortie en schéma JSON, avec repli sur un modèle de vision pour les scans."
