...
description: "Enchaînez Venice Web Search et Web Scrape dans une chat completion qui répond par une synthèse citée où chaque affirmation renvoie à une source."
