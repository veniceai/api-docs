...
description: "Extrayez texte et décomptes de tokens de documents avec l'API Text Parser de Venice, puis réutilisez la sortie dans vos prompts et pipelines."
