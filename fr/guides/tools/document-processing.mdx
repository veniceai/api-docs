...
description: "Extrayez texte et décomptes de tokens de fichiers PDF, DOCX, PPTX, XLSX et texte brut jusqu'à 25 Mo avec l'API Venice Text Parser, sans inférence."
