...
description: "Laissez les modèles de chat Venice appeler vos outils via l'appel de fonctions compatible OpenAI : tableau tools, exécution des appels, retour des résultats."
