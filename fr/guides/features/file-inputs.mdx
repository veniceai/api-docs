...
description: "Joignez des PDF, documents Office, fichiers texte, données et code source aux requêtes Venice chat completions pour synthèse, Q/R et transformation."
