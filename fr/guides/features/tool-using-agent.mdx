---
title: "Construire un agent à outils avec l'appel de fonctions"
sidebarTitle: "Agent avec outils"
description: "Donnez à un modèle trois outils en lecture seule et laissez-le explorer une base SQLite inconnue : boucle d'appel de fonctions et appels parallèles avec Venice."
