...
description: "Donnez à un modèle Venice trois outils en lecture seule et laissez-le explorer une base SQLite inconnue via la boucle complète d'appel de fonctions."
