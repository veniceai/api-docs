...
Pour obtenir plus de sortie visible, augmentez le plafond, abaissez `reasoning_effort`, ou [désactivez le raisonnement](#désactiver-le-raisonnement).
