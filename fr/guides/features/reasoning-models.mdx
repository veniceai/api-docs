...
description: "Utilisation des modèles de raisonnement avec une chaîne de pensée visible dans l'API Venice"
...
Consultez la liste complète des modèles, des tarifs et des limites de contexte sur la [page Modèles](/models/overview). Tous les modèles de raisonnement ne prennent pas en charge le paramètre [`reasoning_effort`](#reasoning-effort). Voir la [prise en charge des modèles](#model-support) pour plus de détails.
