...
<Info>
Pour une présentation des modes de confidentialité et de l'aide pour choisir TEE ou E2EE, consultez [Confidentialité](/overview/privacy). Ce guide couvre les détails du protocole et de l'implémentation.
</Info>
...
<CodeGroup>
```bash cURL
# Générer un nonce aléatoire de 32 octets (empêche les attaques par rejeu)
