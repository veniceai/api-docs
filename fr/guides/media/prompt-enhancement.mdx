...
description: "Réécrivez automatiquement vos prompts d'images avec enhance_prompt de Venice sur /image/generate et /image/edit pour des sorties plus riches et détaillées."
