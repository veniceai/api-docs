...
description: "Transformez un article web en fichier audio narré avec la synthèse vocale de Venice : découpage sous 4096 caractères, /audio/speech et assemblage des segments."
