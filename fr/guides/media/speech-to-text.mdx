...
description: "Transcrivez des fichiers audio en texte avec les modèles speech-to-text de Venice via /audio/transcriptions : formats de réponse, horodatages de segments."
