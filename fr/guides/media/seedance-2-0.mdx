...
description: "Générez, modifiez, prolongez et assemblez des vidéos avec Seedance 2.0 et 2.5 sur Venice - workflows texte/image/référence, API faces-off et limites multimodales par famille."
'og:title': "Guide Seedance 2.0 et 2.5 | Venice API Docs"
'og:description': "Générez, modifiez, prolongez et assemblez des vidéos avec Seedance 2.0 et 2.5 via l'API Venice. Workflows, faces-off, limites, tarifs et exemples."
---
...
<Warning>
**Les visages ne sont pas pris en charge sur l'API Seedance publique.** Venice n'exécute pas le provisioning d'assets de visage ni l'attestation de consentement (`consents.seedance` / `needs_consent`) pour les modèles Seedance publics. Les entrées comportant un visage peuvent être rejetées en amont (politique de contenu / fournisseur). Pour la génération likeness / face assets, utilisez l'app ou Studio Venice.
</Warning>
