...
description: "Générez de l'audio parlé à partir de texte avec les modèles de synthèse vocale Venice via /audio/speech : choix du modèle TTS, de la voix et du format audio."
