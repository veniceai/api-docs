...
description: "Générez des images à partir de prompts textuels avec l'API d'image native de Venice ou l'endpoint d'images compatible OpenAI, avec contrôles de style et sortie binaire ou base64."
