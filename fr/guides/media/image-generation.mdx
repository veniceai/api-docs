...
description: "Générez des images à partir de prompts textuels avec l'endpoint /image/generate de Venice ou l'API compatible OpenAI : styles prédéfinis, sortie base64."
