...
description: "Éditez, retouchez par inpainting et composez des images avec les endpoints /image/edit et /image/multi-edit de Venice, ou détourez en PNG transparent."
