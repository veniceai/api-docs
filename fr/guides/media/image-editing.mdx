...
description: "Éditez, retouchez par inpainting, composez des entrées en couches et supprimez les arrière-plans d'images grâce aux API synchrones de Venice pour l'édition, l'édition multiple et la suppression d'arrière-plan."
