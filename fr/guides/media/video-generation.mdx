...
description: "Générez des vidéos à partir de prompts textuels ou d'images de départ via l'API à file d'attente asynchrone de Venice — soumettez un job, suivez son statut et téléchargez la vidéo finie."
