...
Les travaux de vidéo, de musique et de changeur de voix ne sont pas soumis à une limite de débit. Ils sont facturés par génération sur votre solde de crédits, si bien que la contrainte pratique est le coût plutôt qu'un plafond de requêtes. Estimez d'abord le prix d'une tâche avec [`POST /video/quote`](/fr/api-reference/endpoint/video/quote), [`POST /audio/quote`](/fr/api-reference/endpoint/audio/quote) ou [`POST /audio/voice-changer/quote`](/fr/api-reference/endpoint/audio/voice-changer/quote).
