...
description: "Limites de débit de l'API Venice — quotas de requêtes et de tokens par niveau, limites spécifiques aux modèles, en-têtes exposant la capacité restante, et comment gérer les réponses 429."
