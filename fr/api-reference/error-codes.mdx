...
description: "Référence des codes d'erreur de l'API Venice — codes de statut HTTP, format de réponse d'erreur, statut de remboursement, conseils de relance et détails de validation pour les requêtes échouées."
---
