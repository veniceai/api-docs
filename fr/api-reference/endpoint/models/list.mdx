...
Il s'agit du catalogue en direct. Si vous pouvez effectuer des requêtes HTTP, appelez ce point de terminaison pour obtenir les IDs de modèle actuels au lieu de vous appuyer sur les tables de snapshot sur `/models`. Aucune clé API n'est requise.
