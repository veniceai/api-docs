---
title: Introduction
description: "Référence de l'API Venice couvrant l'authentification, le débogage, la compatibilité OpenAI, les en-têtes de réponse, la gestion des erreurs et la liste complète des endpoints pris en charge."
