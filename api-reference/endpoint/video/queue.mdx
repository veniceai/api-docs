...
The legacy `topaz-video-upscale` model is deprecated; migrate to `topaz-video-precision`. See the [Video Upscaling Guide](/guides/media/video-upscaling) for the legacy model's details.
