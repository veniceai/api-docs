...
```
Too many failed attempts (> 20) resulting in a non-success status code. Please wait ${ERROR_RATE_LIMIT_WINDOW} and try again. See https://docs.venice.ai/api-reference/rate-limiting for more information.
```
