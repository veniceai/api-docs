...
**Explorer:** This is a trial tier designed to allow testing the Venice AI. It is included for PRO users.
**Paid:** This is a paid tier. Users will be debited VCU first, and when VCU is depleted, will be debited USD. If no balance of either VCU or USD is available, requests will default to explorer tier (if PRO user), or fail (if free user).
