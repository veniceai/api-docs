...
<Warning>
The base URL is `https://api.venice.ai/api/v1`, not `https://venice.ai`. Requests sent to the website domain reach the web app instead of the API and fail with errors such as `405 Method Not Allowed`.
</Warning>
